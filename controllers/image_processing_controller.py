...
from models.algorithm_config_model import AlgorithmConfig, AlgorithmType
...
class ImageProcessingController(QObject):
    ...
    def execute_alignment(self, algorithm_name: str, parameters: Dict[str, Any], 
                         image_paths: list, single_process: bool = True) -> Optional[str]:
        """
        ...
        try:
            ...
            result_path = self._run_alignment_algorithm(algorithm_name, parameters, single_process)
            
            if result_path:
                self.processing_completed.emit("alignment", result_path)
                return result_path
            else:
                self.processing_error.emit(algorithm_name, "Algorithm returned no result")
                return None
    ...
    def execute_denoising(self, algorithm_name: str, parameters: Dict[str, Any],
                         image_paths: list, single_process: bool = True) -> Optional[str]:
        """
        ...
        try:
            result_path = self._run_denoising_algorithm(algorithm_name, parameters, single_process)
    ...
    def execute_super_resolution(self, algorithm_name: str, parameters: Dict[str, Any],
                                 image_path: str, single_process: bool = True) -> Optional[str]:
        """
        ...
        """
        self.current_config = AlgorithmConfig(
            AlgorithmType.SUPER_RESOLUTION,
            algorithm_name,
            parameters
        )
        ...
        try:
            result_path = self._run_super_resolution_algorithm(algorithm_name, parameters, single_process)
    ...
    def execute_workflow(self, alignment_config: Optional[AlgorithmConfig],
        ...
        try:
            ...
            if super_res_config and super_res_config.algorithm_name != "No Super Resolution":
    ...
    def _run_alignment_algorithm(self, algorithm_name: str, parameters: Dict, single_process: bool) -> Optional[str]:
        """
    ...
    def _run_denoising_algorithm(self, algorithm_name: str, parameters: Dict, single_process: bool) -> Optional[str]:
    ...
    def _run_super_resolution_algorithm(self, algorithm_name: str, parameters: Dict, single_process: bool) -> Optional[str]:
        ...
        algorithm_map = {
            "Interpolation": running_interpolation
        }
