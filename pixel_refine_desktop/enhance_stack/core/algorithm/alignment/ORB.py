    ...
    def load_orb_config(config_filename=None):
        ...
        try:
            if os.path.exists(config_filename):
                ...
                print(
                    f"Info: ORB config file '{config_filename}' not found. Using defaults."
                )

        except Exception as e:
            print(
                f"Error loading ORB configuration from '{config_filename}': {e}. Using defaults."
            )
    ...
    def calculate_global_motion(
            ...
            while True:
                ...
                try:
                    ...
                    enhanced_gray = prepare_image(
                        image_data, grayscale=True, use_clahe=False
                    )
        ...
        try:
            ...
            good_matches = sorted(good_matches, key=lambda m: m.distance)[
                : orb_config.get("max_keypoints_used", 500)
            ]
            pts_base = np.float32(
