...
def compile_gamma_proxy_aot(arch=ti.vulkan, save_path="gamma_proxy_vulkan.tcm"):
    ...
    builder_rgb.dispatch(
        kernels_mod.gamma_proxy_rgb_kernel,
        src_rgb,
        dst_rgb,
        cmatrix_arg,
        scale,
    ...
    builder_single.dispatch(
        kernels_mod.gamma_proxy_single_kernel,
        src_single,
        dst_single,
        scale,
        gamma_pow,
...
if __name__ == "__main__":
    ...
    assets_dir = os.path.abspath(
        os.path.join(script_dir, "../../../../../../ui/data/aot_assets")
    )
