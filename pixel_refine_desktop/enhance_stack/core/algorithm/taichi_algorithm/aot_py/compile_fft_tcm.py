...
import pixel_refine_desktop.enhance_stack.core.algorithm.taichi_algorithm.fft
fft_module = sys.modules["pixel_refine_desktop.enhance_stack.core.algorithm.taichi_algorithm.fft"]
