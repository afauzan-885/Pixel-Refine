...
import weakref
from pixel_refine_desktop.enhance_stack.components.batch_page.batch_layout import (
    BatchProcessDialog,
    setup_main_panel,
)
from pixel_refine_desktop.enhance_stack.components.batch_page.combined_panel import (
    CombinedPanel,
)
...
from pixel_refine_desktop.enhance_stack.components.batch_page.scrollable_error_dialog import (
...
class BatchPageLayout(QWidget):
    ...
    def _manage_placeholder_and_spacer(self):
        ...
        if has_batches:
            ...
            if not self._placeholder_widget:
                ...
                self.main_panel_container.addWidget(
                    self._placeholder_widget, 0, Qt.AlignmentFlag.AlignCenter
                )
    ...
    def _start_background_delete_process(self, batch_id):
        ...
        deleter_thread = BatchDeleteProcess(
