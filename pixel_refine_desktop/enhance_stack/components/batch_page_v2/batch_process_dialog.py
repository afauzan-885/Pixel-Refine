...
class BatchProcessDialog(QDialog):
    ...
    def populate_table(self):
        ...
        for i, batch in enumerate(self.batches):
            panel = batch  # Keep variable name for compatibility
            # --- Kolom 0: Checkbox ---
            ...
            # Use BatchModel attributes: name and id
            batch = panel  # panel is actually a BatchModel
        ...
        self.table_widget.setVerticalHeaderLabels(
            [str(i + 1) for i in range(len(self.batches))]
        )
    ...
    def open_mass_edit_dialog(self):
        ...
        # Hubungkan sinyal dari dialog anak ke slot refresh di dialog ini
    ...
    def reset_dialog_state(self):
        ...
        # Logika baru untuk menangani baris yang dibatalkan
        for i in range(self.table_widget.rowCount()):
    ...
    def adjust_column_widths(self):
        ...
        # Buat kolom Status pas dengan kontennya
