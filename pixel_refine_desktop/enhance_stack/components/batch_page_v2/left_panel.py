...
class LeftPanel(QWidget):
    ...
    def _on_algorithm_completed(self, data):
        ...
        process_suffix = None
        if denoising in ["Average", "Median", "Similarity", "Similarity Fusion"]:
            process_suffix = "similarity" if denoising == "Similarity Fusion" else denoising.lower()
        ...
        if hasattr(self.display_panel, "check_result_availability"):
            self.display_panel.check_result_availability()
