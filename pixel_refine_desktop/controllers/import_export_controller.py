...
class ImportExportController(QObject):
    ...
    def check_duplicates(self, paths: List[str], existing_paths: List[str]) -> Tuple[List[str], List[str]]:
        """
    ...
    def convert_tiff_to_uncompressed(self, tiff_paths: List[str], output_folder: str) -> List[Tuple[bool, str]]:
        """
    ...
    def start_import_thread(self, image_paths: List[str], database_manager, 
                           batch_size: int = 15, delay_ms: int = 25) -> None:
        """
    ...
    def export_image(self, source_path: str, destination_path: str, 
                    quality: int = 98, optimize: bool = True) -> bool:
        """
        ...
        try:
            import shutil
            import tifffile
            from pixel_refine_desktop.core.algorithm.alignment.alignment_features.global_feature import save_special_jpg_and_png
