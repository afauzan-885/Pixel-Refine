...
import weakref
from UI.enhance_stack.components.batch_page_layout.batch_layout import (
    BatchProcessDialog,
    setup_main_panel,
)
...
from UI.enhance_stack.components.batch_page_layout.scrollable_error_dialog import (
