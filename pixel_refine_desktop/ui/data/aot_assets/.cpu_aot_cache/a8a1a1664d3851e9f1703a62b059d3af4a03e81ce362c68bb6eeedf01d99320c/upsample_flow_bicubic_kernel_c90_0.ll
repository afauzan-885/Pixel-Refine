...
define void @upsample_flow_bicubic_kernel_c90_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.6* %context to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float }**
...
define void @upsample_flow_bicubic_kernel_c90_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.6* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float }**
