...
define void @gamma_proxy_single_kernel_c82_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }**
  %1 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }* %1, i64 0, i32 0, i32 0, i32 0
  ...
  %10 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }** %0, align 8
  %11 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }* %10, i64 0, i32 0, i32 0, i32 1
  ...
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime, %struct.LLVMRuntime* %19, i64 0, i32 14
...
define void @gamma_proxy_single_kernel_c82_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }**
  %21 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }** %20, align 8
  %22 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }* %21, i64 0, i32 2
  %23 = load float, float* %22, align 4
  %24 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }* %21, i64 0, i32 3
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %28 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }* %21, i64 0, i32 0, i32 1
  %29 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }* %21, i64 0, i32 0, i32 0, i32 1
  %30 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }* %21, i64 0, i32 1, i32 1
  %31 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float }* %21, i64 0, i32 1, i32 0, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %65, %for_loop_body ]
  %32 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %3, align 8
  ...
  %51 = fmul reassoc ninf nsz float %50, %23
  %52 = fmul reassoc ninf nsz float %51, %51
  %53 = fadd reassoc ninf nsz float %52, 1.000000e+00
  %54 = tail call reassoc ninf nsz float @llvm.sqrt.f32(float %53)
  %55 = fdiv reassoc ninf nsz float %51, %54
  %56 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %55, float 0.000000e+00)
  %57 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %56, float 1.000000e+00)
  %58 = tail call float @powf(float noundef %57, float noundef %26) #1
