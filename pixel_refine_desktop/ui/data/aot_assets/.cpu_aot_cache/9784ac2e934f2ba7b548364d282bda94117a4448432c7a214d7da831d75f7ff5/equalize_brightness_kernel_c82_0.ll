...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %26 = phi float [ %.pre6, %for_loop_body.lr.ph ], [ %60, %for_loop_body ]
  %27 = phi float [ %.pre, %for_loop_body.lr.ph ], [ %52, %for_loop_body ]
  ...
  %49 = getelementptr float, ptr %43, i64 %47
  %50 = getelementptr float, ptr %49, i64 %48
  %51 = load float, ptr %50, align 4
  %52 = fadd reassoc ninf nsz float %27, %51
  ...
  %58 = getelementptr float, ptr %57, i64 %48
  %59 = load float, ptr %58, align 4
  %60 = fadd reassoc ninf nsz float %26, %59
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %58, %for_loop_body ]
  ...
  %57 = getelementptr float, ptr %56, i64 %45
