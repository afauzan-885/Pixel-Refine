...
define void @normalize_vec3_f32_to_vec3_f32_kernel_c82_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }**
  %1 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }* %1, i64 0, i32 0, i32 0, i32 0
  ...
  %11 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }* %10, i64 0, i32 0, i32 0, i32 1
...
define void @normalize_vec3_f32_to_vec3_f32_kernel_c82_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }**
