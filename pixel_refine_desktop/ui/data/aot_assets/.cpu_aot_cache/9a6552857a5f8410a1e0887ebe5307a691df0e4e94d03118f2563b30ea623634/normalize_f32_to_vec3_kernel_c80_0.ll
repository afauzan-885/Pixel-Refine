...
define void @normalize_f32_to_vec3_kernel_c80_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.6* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }**
...
define void @normalize_f32_to_vec3_kernel_c80_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.6* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %71 = getelementptr float, float* %64, i64 %70
  store float %48, float* %71, align 4
  %72 = add nsw i32 %.04, 1
