...
class PanoramaPage(QMainWindow):
    ...
    def _create_main_content(self):
        ...
        right_panel.project_selection_changed.connect(
            left_panel.update_display_for_project
        )
        ...
        right_panel.project_list_updated.connect(
            left_panel.on_project_existence_changed
        )
