...
SPLASH_STATUS_STARTING = "正在启动应用程序..."
SPLASH_STATUS_CHECKING_APP = "正在检查应用程序..."
SPLASH_STATUS_APP_ACTIVE = "应用程序已就绪"
SPLASH_STATUS_CHECKING_PROJECT = "正在检查项目数据..."
SPLASH_STATUS_PROJECT_READY = "项目数据已就绪"
SPLASH_STATUS_PREPARING_EFFECTS = "正在准备视觉效果..."
SPLASH_STATUS_EFFECTS_READY = "视觉效果已就绪"
SPLASH_STATUS_PREPARING_MODULES = "正在准备处理模块..."
SPLASH_STATUS_MODULES_READY = "模块已就绪"
SPLASH_STATUS_LOADING_WINDOW = "正在加载窗口界面..."
SPLASH_STATUS_ADJUSTING_SCREEN = "正在调整屏幕分辨率..."
SPLASH_STATUS_SCREEN_READY = "屏幕显示已就绪"
SPLASH_STATUS_PREPARING_WORKSPACE = "正在准备工作空间..."
SPLASH_STATUS_WORKSPACE_READY = "工作空间已就绪"
SPLASH_STATUS_LOADING_UI = "正在加载主界面..."
SPLASH_STATUS_PREPARING_PAGE = "正在准备工作页面..."
SPLASH_STATUS_OPENING_MAIN_WORKSPACE = "正在打开主工作区..."
SPLASH_STATUS_MAIN_WORKSPACE_READY = "工作区已就绪，随时可用"
SPLASH_STATUS_LOADING_SETTINGS = "正在加载设置面板..."
SPLASH_STATUS_SETTINGS_READY = "设置已就绪"
SPLASH_STATUS_ASSEMBLING_LAYOUT = "正在构建应用程序布局..."
