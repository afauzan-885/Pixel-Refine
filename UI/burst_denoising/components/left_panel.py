...
class LeftPanel(QWidget):
    def __init__(self):
        ...
        self.global_dropdown.addItems(["None", "EEC", "Farneback Optical Flow", "AKAZE", "ORB"])
        ...
        self.local_dropdown.addItems(["None", "Horn-Schunck"])
        ...
        self.stacking_dropdown.addItems(["None", "Average", "Median weighting", "Weight Stack"])
