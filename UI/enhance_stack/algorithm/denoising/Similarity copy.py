...
from UI.enhance_stack.algorithm.denoising.extra_code.extra_algorithm import call_accumulate_frame_weighted, call_normalize_accumulated
...
class SimilarityAlgorithm:
    ...
    def similarity_mfnr(self, images, tile_size=(12, 12), overlap=0.50,
                        motion_threshold=0.010, update_progress=None, stop_requested=None,
