...
def main(db_path, update_progress=None, stop_requested=None, batch_size=10,
    ...
    try:
        ...
        output_path = os.path.join(output_folder_stack, f"{output_name_base_safe}_similarity.tif")
        ...
        if stop_requested and stop_requested():
             if update_progress and progress_bar: update_progress(progress_bar.value(), "Process Abort.") 
