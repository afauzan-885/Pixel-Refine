...
class TopBar(QWidget):
    ...
    def __init__(self):
        ...
        self.layout.setContentsMargins(0,0,0,0) # Beri margin
        ...
        self.switch_container.setSizePolicy(QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Preferred)

        # === Stack Kiri ===
        self.left_stack = QStackedWidget()
        self.left_stack.setStyleSheet("background-color: transparent;")
        ...
        batch_left_layout_internal.setContentsMargins(0, 0, 0, 0); batch_left_layout_internal.setSpacing(5)
        ...
        batch_right_layout_internal.setContentsMargins(0, 0, 0, 0); batch_right_layout_internal.setSpacing(5)
        ...
        self.layout.addWidget(self.switch_container, 0, 1, Qt.AlignmentFlag.AlignCenter) # Baris 0, Kolom 1
