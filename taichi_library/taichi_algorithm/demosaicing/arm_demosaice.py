"""Adaptive Residual Minimization (ARM) GPU-Accelerated RAW Demosaicing"""
...
def arm_demosaic(
    ...
    """GPU-Accelerated ARM Demosaicing (RAW to sRGB via strict C++ AOT).
