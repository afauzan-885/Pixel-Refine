"""
Compile New Algorithms TCM — Color Convert, Otsu, CLAHE, Canny, Hough, Guided Filter
======================================================================================
AOT compilation script for the 9 new Taichi algorithm modules.
...
Usage:
  python compile_new_algorithms_tcm.py           # Compile all 3 backends
...
def compile_otsu(arch, save_path):
    ...
    # Histogram kernel
    g = ti.graph.GraphBuilder()
    g.dispatch(otsu_mod._compute_histogram_kernel, src_2d, hist_1d, h_arg, w_arg)
...
def compile_clahe(arch, save_path):
    ...
    g = ti.graph.GraphBuilder()
    g.dispatch(clahe_mod._clahe_histogram_kernel, src_2d, hist_2d, h_arg, w_arg, tile_h_arg, tile_w_arg, tiles_x_arg, tiles_y_arg)
    g.dispatch(clahe_mod._clahe_clip_cdf_kernel, hist_2d, lut_2d, total_tiles_arg, num_bins_arg, clip_arg, tile_px_arg)
    g.dispatch(clahe_mod._clahe_interpolate_kernel, src_2d, lut_2d, dst_2d, h_arg, w_arg, tile_h_arg, tile_w_arg, tiles_x_arg, tiles_y_arg)
