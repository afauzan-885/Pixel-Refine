...
define void @_complex_to_real_kernel_c280_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_complex_to_real_kernel_c280_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if3, %for_loop_body.preheader
  ...
  %.047 = phi i32 [ %64, %after_if3 ], [ %16, %for_loop_body.preheader ]
  ...
  %33 = icmp ne i32 %.047, %30
  %34 = and i1 %32, %33
  %.neg6 = sext i1 %34 to i32
  %35 = add i32 %29, %.neg6
  %36 = mul i32 %28, -1
  %37 = mul i32 %36, %35
  %38 = add i32 %.047, %37
  %39 = icmp slt i32 %35, %21
  br i1 %39, label %true_block, label %after_if3
...
true_block:                                       ; preds = %for_loop_body
  ...
  br i1 %43, label %true_block1, label %after_if3
...
true_block1:                                      ; preds = %true_block
  ...
  %53 = getelementptr float, ptr %45, i64 %52
  %54 = load float, ptr %53, align 4
  %55 = getelementptr i8, ptr %40, i64 24
  %56 = load ptr, ptr %55, align 8
  %57 = getelementptr i8, ptr %40, i64 20
  %58 = load i32, ptr %57, align 4
  %59 = sub i32 %58, %28
  %60 = mul i32 %59, %35
  %61 = add i32 %.047, %60
  %62 = sext i32 %61 to i64
  %63 = getelementptr float, ptr %56, i64 %62
  store float %54, ptr %63, align 4
  br label %after_if3
