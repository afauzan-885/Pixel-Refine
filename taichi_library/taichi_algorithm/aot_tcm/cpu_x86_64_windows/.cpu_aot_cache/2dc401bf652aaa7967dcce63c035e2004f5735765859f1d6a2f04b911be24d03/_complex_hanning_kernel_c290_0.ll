...
define void @_complex_hanning_kernel_c290_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_complex_hanning_kernel_c290_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %lsr.iv = phi i32 [ %23, %for_loop_body.lr.ph ], [ %lsr.iv.next, %for_loop_body ]
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %78, %for_loop_body ]
  ...
  %33 = icmp ne i32 %.05, %30
  %34 = and i1 %32, %33
  %.neg4 = sext i1 %34 to i32
  %35 = add i32 %29, %.neg4
  %36 = mul i32 %28, -1
  %37 = mul i32 %36, %35
  %38 = add i32 %.05, %37
  %39 = sitofp i32 %35 to float
  %40 = fmul reassoc ninf nsz float %39, 0x401921FB60000000
  %41 = getelementptr inbounds nuw i8, ptr %26, i64 8
  %42 = load i32, ptr %41, align 4
  %43 = add i32 %42, -1
  %44 = sitofp i32 %43 to float
  %45 = fdiv reassoc ninf nsz float %40, %44
  %46 = tail call noundef float @cosf(float noundef %45) #7
  %47 = fmul reassoc ninf nsz float %46, 5.000000e-01
  %48 = fsub reassoc ninf nsz float 5.000000e-01, %47
  %49 = sitofp i32 %38 to float
  %50 = fmul reassoc ninf nsz float %49, 0x401921FB60000000
  ...
  %58 = fdiv reassoc ninf nsz float %50, %57
  %59 = tail call noundef float @cosf(float noundef %58) #7
  %60 = fmul reassoc ninf nsz float %59, 5.000000e-01
  %61 = fsub reassoc ninf nsz float 5.000000e-01, %60
  ...
  %73 = getelementptr float, ptr %62, i64 %72
  %74 = load float, ptr %73, align 4
  %75 = fmul reassoc ninf nsz float %61, %48
  %76 = fmul reassoc ninf nsz float %70, %75
  %77 = fmul reassoc ninf nsz float %74, %75
