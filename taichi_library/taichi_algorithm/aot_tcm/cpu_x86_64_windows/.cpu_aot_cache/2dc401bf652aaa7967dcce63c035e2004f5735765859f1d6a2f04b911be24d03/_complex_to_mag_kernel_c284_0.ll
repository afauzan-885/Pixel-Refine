...
define void @_complex_to_mag_kernel_c284_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_complex_to_mag_kernel_c284_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %62, %for_loop_body ]
  ...
  %49 = getelementptr float, ptr %38, i64 %48
  %50 = load float, ptr %49, align 4
  %51 = fmul reassoc ninf nsz float %46, %46
  %52 = fmul reassoc ninf nsz float %50, %50
