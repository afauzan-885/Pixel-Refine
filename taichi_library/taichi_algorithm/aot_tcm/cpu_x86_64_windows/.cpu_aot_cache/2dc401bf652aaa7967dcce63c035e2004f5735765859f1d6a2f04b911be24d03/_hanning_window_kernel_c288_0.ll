...
define void @_hanning_window_kernel_c288_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_hanning_window_kernel_c288_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %71, %for_loop_body ]
  ...
  %39 = fmul reassoc ninf nsz float %38, 0x401921FB60000000
  %40 = getelementptr inbounds nuw i8, ptr %25, i64 8
  %41 = load i32, ptr %40, align 4
  %42 = add i32 %41, -1
  %43 = sitofp i32 %42 to float
  %44 = fdiv reassoc ninf nsz float %39, %43
  %45 = tail call noundef float @cosf(float noundef %44) #7
  %46 = fmul reassoc ninf nsz float %45, 5.000000e-01
  %47 = fsub reassoc ninf nsz float 5.000000e-01, %46
  ...
  %57 = fdiv reassoc ninf nsz float %49, %56
  %58 = tail call noundef float @cosf(float noundef %57) #7
  %59 = fmul reassoc ninf nsz float %58, 5.000000e-01
  %60 = fsub reassoc ninf nsz float 5.000000e-01, %59
  ...
  %69 = fmul reassoc ninf nsz float %60, %47
  %70 = fmul reassoc ninf nsz float %69, %68
  store float %70, ptr %67, align 4
  %71 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %18, %71
