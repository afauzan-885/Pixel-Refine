...
define void @fed_diffusion_step_c700_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }**
  ...
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %1, i64 0, i32 3
  ...
  %11 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }** %0, align 8
  %12 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %11, i64 0, i32 4
...
define void @fed_diffusion_step_c700_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }**
  br label %for_loop_body

for_loop_body:                                    ; preds = %after_if9, %for_loop_body.lr.ph
  %.0819 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %153, %after_if9 ]
  ...
  %32 = icmp ne i32 %.0819, 0
  %33 = icmp ne i32 %.0819, %29
  %34 = and i1 %32, %31
  %35 = and i1 %34, %33
  ...
  br i1 %41, label %true_block, label %false_block8
...
true_block4:                                      ; preds = %true_block
  %48 = getelementptr inbounds i8, i8* %24, i64 12
...
true_block7:                                      ; preds = %true_block4
  %53 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }** %21, align 8
  %54 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %53, i64 0, i32 2, i32 1
  %55 = load float*, float** %54, align 8
  %56 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %53, i64 0, i32 2, i32 0, i32 1
  %57 = load i32, i32* %56, align 4
  %58 = sub i32 %57, %27
  %59 = mul i32 %58, %36
  %60 = add i32 %.0819, %59
  %61 = sext i32 %60 to i64
  %62 = getelementptr float, float* %55, i64 %61
  %63 = load float, float* %62, align 4
  %64 = add i32 %60, -1
  %65 = sext i32 %64 to i64
  %66 = getelementptr float, float* %55, i64 %65
  %67 = load float, float* %66, align 4
  %68 = add i32 %60, 1
  %69 = sext i32 %68 to i64
  %70 = getelementptr float, float* %55, i64 %69
  ...
  %77 = getelementptr float, float* %55, i64 %76
  ...
  %84 = getelementptr float, float* %55, i64 %83
  %85 = load float, float* %84, align 4
  %86 = fadd reassoc ninf nsz float %71, %63
  %87 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %53, i64 0, i32 0, i32 1
  %88 = load float*, float** %87, align 8
  %89 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %53, i64 0, i32 0, i32 0, i32 1
  ...
  %99 = getelementptr float, float* %88, i64 %98
  %100 = load float, float* %99, align 4
  %101 = fsub reassoc ninf nsz float %97, %100
  %102 = fmul reassoc ninf nsz float %101, %86
  %103 = fadd reassoc ninf nsz float %67, %63
  %104 = add i32 %93, -1
  %105 = sext i32 %104 to i64
  %106 = getelementptr float, float* %88, i64 %105
  %107 = load float, float* %106, align 4
  %108 = fsub reassoc ninf nsz float %100, %107
  %.neg17 = fmul reassoc ninf nsz float %108, %103
  %109 = fadd reassoc ninf nsz float %85, %63
  %110 = mul i32 %90, %79
  %111 = sub i32 %110, %37
  %112 = add i32 %.0819, %111
  %113 = sext i32 %112 to i64
  %114 = getelementptr float, float* %88, i64 %113
  %115 = load float, float* %114, align 4
  %116 = fsub reassoc ninf nsz float %115, %100
  %117 = fmul reassoc ninf nsz float %116, %109
  %118 = fadd reassoc ninf nsz float %78, %63
  %119 = mul i32 %90, %72
  %120 = sub i32 %119, %37
  %121 = add i32 %.0819, %120
  %122 = sext i32 %121 to i64
  %123 = getelementptr float, float* %88, i64 %122
  %124 = load float, float* %123, align 4
  %125 = fsub reassoc ninf nsz float %100, %124
  %.neg18 = fmul reassoc ninf nsz float %125, %118
  %126 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %53, i64 0, i32 5
  %127 = load float, float* %126, align 4
  %128 = fmul reassoc ninf nsz float %127, 5.000000e-01
  %reass.add = fadd reassoc ninf nsz float %.neg18, %.neg17
  %129 = fadd reassoc ninf nsz float %117, %102
  %130 = fsub reassoc ninf nsz float %129, %reass.add
  %131 = fmul reassoc ninf nsz float %128, %130
  %132 = fadd reassoc ninf nsz float %131, %100
  br label %after_if9

false_block8:                                     ; preds = %true_block4, %true_block, %for_loop_body
  %133 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }** %21, align 8
  %134 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %133, i64 0, i32 0, i32 1
  %135 = load float*, float** %134, align 8
  %136 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %133, i64 0, i32 0, i32 0, i32 1
  %137 = load i32, i32* %136, align 4
  %138 = sub i32 %137, %27
  %139 = mul i32 %138, %36
  %140 = add i32 %.0819, %139
  %141 = sext i32 %140 to i64
  %142 = getelementptr float, float* %135, i64 %141
  %143 = load float, float* %142, align 4
  br label %after_if9

after_if9:                                        ; preds = %false_block8, %true_block7
  %.sink29 = phi { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* [ %133, %false_block8 ], [ %53, %true_block7 ]
  %.sink = phi float [ %143, %false_block8 ], [ %132, %true_block7 ]
  %144 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %.sink29, i64 0, i32 1, i32 1
  %145 = load float*, float** %144, align 8
  %146 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %.sink29, i64 0, i32 1, i32 0, i32 1
  %147 = load i32, i32* %146, align 4
  %148 = sub i32 %147, %27
  %149 = mul i32 %148, %36
  %150 = add i32 %.0819, %149
  %151 = sext i32 %150 to i64
  %152 = getelementptr float, float* %145, i64 %151
  store float %.sink, float* %152, align 4
  %153 = add nsw i32 %.0819, 1
  %exitcond.not = icmp eq i32 %19, %153
