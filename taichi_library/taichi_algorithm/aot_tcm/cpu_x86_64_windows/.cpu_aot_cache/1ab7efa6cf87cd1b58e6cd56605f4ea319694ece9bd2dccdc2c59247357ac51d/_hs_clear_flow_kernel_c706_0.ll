...
define void @_hs_clear_flow_kernel_c706_0_kernel_0_serial(%struct.RuntimeContext.60* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.60* %context to { { { i32, i32, i32 }, float* } }**
  %1 = load { { { i32, i32, i32 }, float* } }*, { { { i32, i32, i32 }, float* } }** %0, align 8
  %2 = getelementptr { { { i32, i32, i32 }, float* } }, { { { i32, i32, i32 }, float* } }* %1, i64 0, i32 0, i32 0, i32 0
  %3 = load i32, i32* %2, align 4
  %4 = getelementptr { { { i32, i32, i32 }, float* } }, { { { i32, i32, i32 }, float* } }* %1, i64 0, i32 0, i32 0, i32 1
...
define void @_hs_clear_flow_kernel_c706_0_kernel_1_range_for(%struct.RuntimeContext.60* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.60* %0 to { { { i32, i32, i32 }, float* } }**
  %22 = load { { { i32, i32, i32 }, float* } }*, { { { i32, i32, i32 }, float* } }** %21, align 8
  %23 = getelementptr { { { i32, i32, i32 }, float* } }, { { { i32, i32, i32 }, float* } }* %22, i64 0, i32 0, i32 1
  %24 = getelementptr { { { i32, i32, i32 }, float* } }, { { { i32, i32, i32 }, float* } }* %22, i64 0, i32 0, i32 0, i32 1
  %25 = getelementptr { { { i32, i32, i32 }, float* } }, { { { i32, i32, i32 }, float* } }* %22, i64 0, i32 0, i32 0, i32 2
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %60, %for_loop_body ]
  %26 = load %struct.LLVMRuntime.59*, %struct.LLVMRuntime.59** %3, align 8
  ...
  %49 = getelementptr float, float* %41, i64 %48
  ...
  %59 = getelementptr float, float* %50, i64 %58
