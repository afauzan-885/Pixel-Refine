...
define void @_hs_copy_flow_kernel_c708_0_kernel_0_serial(%struct.RuntimeContext.72* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.72* %context to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* } }**
  ...
  %4 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* } }* %1, i64 0, i32 0, i32 0, i32 1
...
define void @_hs_copy_flow_kernel_c708_0_kernel_1_range_for(%struct.RuntimeContext.72* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.72* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* } }**
