...
define void @_bg_blur_x_c254_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
  ...
  %23 = getelementptr i8, ptr %19, i64 64
...
define void @_bg_blur_x_c254_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
