...
define void @_bg_clear_grid_c250_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_bg_clear_grid_c250_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %75, %for_loop_body ]
  ...
  %46 = icmp ne i32 %.06, %36
  %47 = icmp ne i32 %39, %43
  %48 = and i1 %46, %45
  %49 = and i1 %47, %48
  %.neg5 = sext i1 %49 to i32
  %50 = add i32 %42, %.neg5
  %51 = mul i32 %50, %41
  ...
  %62 = getelementptr float, ptr %52, i64 %61
