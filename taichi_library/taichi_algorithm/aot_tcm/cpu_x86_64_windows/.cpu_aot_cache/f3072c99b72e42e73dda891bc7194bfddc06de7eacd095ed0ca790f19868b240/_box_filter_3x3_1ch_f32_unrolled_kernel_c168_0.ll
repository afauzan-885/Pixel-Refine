...
define void @_box_filter_3x3_1ch_f32_unrolled_kernel_c168_0_kernel_0_serial(%struct.RuntimeContext.72* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.72* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
define void @_box_filter_3x3_1ch_f32_unrolled_kernel_c168_0_kernel_1_range_for(%struct.RuntimeContext.72* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.72* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %126, %for_loop_body ]
  %27 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %3, align 8
  ...
  %52 = add i32 %44, -1
  %53 = getelementptr inbounds i8, i8* %29, i64 12
  ...
  %66 = tail call i32 @llvm.smax.i32(i32 %44, i32 0)
  %67 = tail call i32 @llvm.smin.i32(i32 %56, i32 %66)
  %68 = add i32 %61, %67
  %69 = sext i32 %68 to i64
  %70 = getelementptr float, float* %59, i64 %69
  %71 = load float, float* %70, align 4
  %72 = fadd reassoc ninf nsz float %71, %65
  %73 = add i32 %44, 1
  %74 = tail call i32 @llvm.smax.i32(i32 %73, i32 0)
  %75 = tail call i32 @llvm.smin.i32(i32 %56, i32 %74)
  %76 = add i32 %75, %61
  %77 = sext i32 %76 to i64
  %78 = getelementptr float, float* %59, i64 %77
  %79 = load float, float* %78, align 4
  %80 = fadd reassoc ninf nsz float %72, %79
  %81 = tail call i32 @llvm.smax.i32(i32 %41, i32 0)
  %82 = tail call i32 @llvm.smin.i32(i32 %49, i32 %81)
  %83 = mul i32 %82, %60
  %84 = add i32 %58, %83
  %85 = sext i32 %84 to i64
  %86 = getelementptr float, float* %59, i64 %85
  %87 = load float, float* %86, align 4
  %88 = fadd reassoc ninf nsz float %80, %87
  %89 = add i32 %67, %83
  %90 = sext i32 %89 to i64
  %91 = getelementptr float, float* %59, i64 %90
  %92 = load float, float* %91, align 4
  %93 = fadd reassoc ninf nsz float %88, %92
  %94 = add i32 %75, %83
  %95 = sext i32 %94 to i64
  %96 = getelementptr float, float* %59, i64 %95
  %97 = load float, float* %96, align 4
  %98 = fadd reassoc ninf nsz float %93, %97
  %99 = add i32 %41, 1
  %100 = tail call i32 @llvm.smax.i32(i32 %99, i32 0)
  %101 = tail call i32 @llvm.smin.i32(i32 %49, i32 %100)
  %102 = mul i32 %101, %60
  %103 = add i32 %58, %102
  %104 = sext i32 %103 to i64
  %105 = getelementptr float, float* %59, i64 %104
  %106 = load float, float* %105, align 4
  %107 = fadd reassoc ninf nsz float %98, %106
  %108 = add i32 %102, %67
  %109 = sext i32 %108 to i64
  %110 = getelementptr float, float* %59, i64 %109
  ...
  %117 = fadd reassoc ninf nsz float %112, %116
  %118 = fmul reassoc ninf nsz float %117, 0x3FBC71C720000000
  ...
  %125 = getelementptr float, float* %119, i64 %124
  store float %118, float* %125, align 4
  %126 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %19, %126
