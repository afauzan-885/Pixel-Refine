...
define void @_bgr_to_gray_f32_scaled_i32_kernel_c718_0_kernel_0_serial(%struct.RuntimeContext.216* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.216* %context to { { { i32, i32 }, i32* }, { { i32, i32 }, float* }, float }**
  ...
  %4 = getelementptr inbounds %struct.RuntimeContext.216, %struct.RuntimeContext.216* %context, i64 0, i32 1
  %5 = load %struct.LLVMRuntime.215*, %struct.LLVMRuntime.215** %4, align 8
  %6 = getelementptr inbounds %struct.LLVMRuntime.215, %struct.LLVMRuntime.215* %5, i64 0, i32 14
  ...
  %13 = load %struct.LLVMRuntime.215*, %struct.LLVMRuntime.215** %4, align 8
  %14 = getelementptr inbounds %struct.LLVMRuntime.215, %struct.LLVMRuntime.215* %13, i64 0, i32 14
  %15 = load i8*, i8** %14, align 8
  %16 = getelementptr inbounds i8, i8* %15, i64 4
  %17 = bitcast i8* %16 to i32*
  store i32 %12, i32* %17, align 4
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.215*, %struct.LLVMRuntime.215** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.215, %struct.LLVMRuntime.215* %19, i64 0, i32 14
...
define void @_bgr_to_gray_f32_scaled_i32_kernel_c718_0_kernel_1_range_for(%struct.RuntimeContext.216* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.216* %0 to { { { i32, i32 }, i32* }, { { i32, i32 }, float* }, float }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %29 = load %struct.LLVMRuntime.215*, %struct.LLVMRuntime.215** %3, align 8
  %30 = getelementptr inbounds %struct.LLVMRuntime.215, %struct.LLVMRuntime.215* %29, i64 0, i32 14
  ...
  %47 = getelementptr i32, i32* %41, i64 %46
  ...
  %57 = getelementptr i32, i32* %41, i64 %56
  %58 = load i32, i32* %57, align 4
  %59 = sitofp i32 %58 to float
  %60 = fmul reassoc ninf nsz float %59, 0x3FD322D0E0000000
  %61 = fmul reassoc ninf nsz float %54, 0x3FE2C8B440000000
  %62 = fmul reassoc ninf nsz float %49, 0x3FBD2F1AA0000000
  %63 = fadd reassoc ninf nsz float %61, %62
  %64 = fadd reassoc ninf nsz float %63, %60
  %65 = fmul reassoc ninf nsz float %64, %23
