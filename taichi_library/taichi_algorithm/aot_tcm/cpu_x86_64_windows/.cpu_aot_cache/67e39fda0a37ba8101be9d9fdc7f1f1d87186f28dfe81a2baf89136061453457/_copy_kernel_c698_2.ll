...
define void @_copy_kernel_c698_2_kernel_0_serial(%struct.RuntimeContext.36* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.36* %context to { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }**
  ...
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %4, align 8
...
define void @_copy_kernel_c698_2_kernel_1_range_for(%struct.RuntimeContext.36* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.36* %0 to { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %78, %for_loop_body ]
  ...
  %61 = getelementptr i32, i32* %55, i64 %60
  ...
  %69 = getelementptr i32, i32* %62, i64 %68
  ...
  %77 = getelementptr i32, i32* %70, i64 %76
  store i32 %54, i32* %77, align 4
  %78 = add nsw i32 %.04, 1
