...
define void @_cvt_color_rgb_to_gray_i32_kernel_c710_0_kernel_0_serial(%struct.RuntimeContext.180* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.180* %context to { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }**
  %1 = load { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }*, { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }, { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }* %1, i64 0, i32 1, i32 0, i32 0
  %3 = load i32, i32* %2, align 4
  %4 = getelementptr inbounds %struct.RuntimeContext.180, %struct.RuntimeContext.180* %context, i64 0, i32 1
  %5 = load %struct.LLVMRuntime.179*, %struct.LLVMRuntime.179** %4, align 8
  %6 = getelementptr inbounds %struct.LLVMRuntime.179, %struct.LLVMRuntime.179* %5, i64 0, i32 14
  %7 = load i8*, i8** %6, align 8
  %8 = getelementptr inbounds i8, i8* %7, i64 8
  %9 = bitcast i8* %8 to i32*
  store i32 %3, i32* %9, align 4
  %10 = load { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }*, { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }** %0, align 8
  %11 = getelementptr { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }, { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }* %10, i64 0, i32 1, i32 0, i32 1
  %12 = load i32, i32* %11, align 4
  %13 = load %struct.LLVMRuntime.179*, %struct.LLVMRuntime.179** %4, align 8
  %14 = getelementptr inbounds %struct.LLVMRuntime.179, %struct.LLVMRuntime.179* %13, i64 0, i32 14
  %15 = load i8*, i8** %14, align 8
  %16 = getelementptr inbounds i8, i8* %15, i64 4
  %17 = bitcast i8* %16 to i32*
  store i32 %12, i32* %17, align 4
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.179*, %struct.LLVMRuntime.179** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.179, %struct.LLVMRuntime.179* %19, i64 0, i32 14
...
define void @_cvt_color_rgb_to_gray_i32_kernel_c710_0_kernel_1_range_for(%struct.RuntimeContext.180* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.180* %0 to { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }**
  %22 = load { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }*, { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }** %21, align 8
  %23 = getelementptr { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }, { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }* %22, i64 0, i32 0, i32 1
  %24 = getelementptr { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }, { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }* %22, i64 0, i32 0, i32 0, i32 1
  %25 = getelementptr { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }, { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }* %22, i64 0, i32 1, i32 1
  %26 = getelementptr { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }, { { { i32, i32 }, i32* }, { { i32, i32 }, i32* } }* %22, i64 0, i32 1, i32 0, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %67, %for_loop_body ]
  %27 = load %struct.LLVMRuntime.179*, %struct.LLVMRuntime.179** %3, align 8
  %28 = getelementptr inbounds %struct.LLVMRuntime.179, %struct.LLVMRuntime.179* %27, i64 0, i32 14
  ...
  %45 = getelementptr i32, i32* %39, i64 %44
  ...
  %53 = getelementptr i32, i32* %39, i64 %52
  ...
  %67 = add nsw i32 %.04, 1
  %exitcond.not = icmp eq i32 %19, %67
