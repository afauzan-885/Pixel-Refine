...
define void @split_kernel_c748_0_kernel_0_serial(%struct.RuntimeContext.120* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.120* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  ...
  %13 = load %struct.LLVMRuntime.119*, %struct.LLVMRuntime.119** %4, align 8
  %14 = getelementptr inbounds %struct.LLVMRuntime.119, %struct.LLVMRuntime.119* %13, i64 0, i32 14
  %15 = load i8*, i8** %14, align 8
  %16 = getelementptr inbounds i8, i8* %15, i64 4
  %17 = bitcast i8* %16 to i32*
  store i32 %12, i32* %17, align 4
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.119*, %struct.LLVMRuntime.119** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.119, %struct.LLVMRuntime.119* %19, i64 0, i32 14
...
define void @split_kernel_c748_0_kernel_1_range_for(%struct.RuntimeContext.120* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.120* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %31 = load %struct.LLVMRuntime.119*, %struct.LLVMRuntime.119** %3, align 8
  %32 = getelementptr inbounds %struct.LLVMRuntime.119, %struct.LLVMRuntime.119* %31, i64 0, i32 14
  ...
  %64 = getelementptr float, float* %57, i64 %63
