...
define void @_cvt_color_rgb_to_gray_kernel_c708_0_kernel_0_serial(%struct.RuntimeContext.168* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.168* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  %1 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* } }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %1, i64 0, i32 1, i32 0, i32 0
  %3 = load i32, i32* %2, align 4
  %4 = getelementptr inbounds %struct.RuntimeContext.168, %struct.RuntimeContext.168* %context, i64 0, i32 1
  %5 = load %struct.LLVMRuntime.167*, %struct.LLVMRuntime.167** %4, align 8
  %6 = getelementptr inbounds %struct.LLVMRuntime.167, %struct.LLVMRuntime.167* %5, i64 0, i32 14
  %7 = load i8*, i8** %6, align 8
  %8 = getelementptr inbounds i8, i8* %7, i64 8
  %9 = bitcast i8* %8 to i32*
  store i32 %3, i32* %9, align 4
  %10 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* } }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }** %0, align 8
  %11 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %10, i64 0, i32 1, i32 0, i32 1
  %12 = load i32, i32* %11, align 4
  %13 = load %struct.LLVMRuntime.167*, %struct.LLVMRuntime.167** %4, align 8
  %14 = getelementptr inbounds %struct.LLVMRuntime.167, %struct.LLVMRuntime.167* %13, i64 0, i32 14
  %15 = load i8*, i8** %14, align 8
  %16 = getelementptr inbounds i8, i8* %15, i64 4
  %17 = bitcast i8* %16 to i32*
  store i32 %12, i32* %17, align 4
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.167*, %struct.LLVMRuntime.167** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.167, %struct.LLVMRuntime.167* %19, i64 0, i32 14
...
define void @_cvt_color_rgb_to_gray_kernel_c708_0_kernel_1_range_for(%struct.RuntimeContext.168* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.168* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %66, %for_loop_body ]
  %27 = load %struct.LLVMRuntime.167*, %struct.LLVMRuntime.167** %3, align 8
  %28 = getelementptr inbounds %struct.LLVMRuntime.167, %struct.LLVMRuntime.167* %27, i64 0, i32 14
  ...
  %49 = getelementptr float, float* %39, i64 %48
  %50 = load float, float* %49, align 4
  %51 = add i32 %43, 2
  %52 = sext i32 %51 to i64
  %53 = getelementptr float, float* %39, i64 %52
  %54 = load float, float* %53, align 4
  %55 = fmul reassoc ninf nsz float %46, 0x3FD322D0E0000000
  %56 = fmul reassoc ninf nsz float %50, 0x3FE2C8B440000000
  %57 = fadd reassoc ninf nsz float %56, %55
  %58 = fmul reassoc ninf nsz float %54, 0x3FBD2F1AA0000000
  %59 = fadd reassoc ninf nsz float %57, %58
  %60 = load float*, float** %25, align 8
