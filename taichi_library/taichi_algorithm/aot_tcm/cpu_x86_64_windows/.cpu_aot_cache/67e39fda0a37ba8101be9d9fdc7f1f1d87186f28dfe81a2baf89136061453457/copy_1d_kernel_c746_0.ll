...
define void @copy_1d_kernel_c746_0_kernel_0_serial(%struct.RuntimeContext.48* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.48* %context to { { { i32 }, float* }, { { i32 }, float* } }**
  %1 = load { { { i32 }, float* }, { { i32 }, float* } }*, { { { i32 }, float* }, { { i32 }, float* } }** %0, align 8
  %2 = getelementptr { { { i32 }, float* }, { { i32 }, float* } }, { { { i32 }, float* }, { { i32 }, float* } }* %1, i64 0, i32 0, i32 0, i32 0
...
define void @copy_1d_kernel_c746_0_kernel_1_range_for(%struct.RuntimeContext.48* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.48* %0 to { { { i32 }, float* }, { { i32 }, float* } }**
  %22 = load { { { i32 }, float* }, { { i32 }, float* } }*, { { { i32 }, float* }, { { i32 }, float* } }** %21, align 8
  %23 = getelementptr { { { i32 }, float* }, { { i32 }, float* } }, { { { i32 }, float* }, { { i32 }, float* } }* %22, i64 0, i32 0, i32 1
  %24 = getelementptr { { { i32 }, float* }, { { i32 }, float* } }, { { { i32 }, float* }, { { i32 }, float* } }* %22, i64 0, i32 1, i32 1
  %25 = sub i32 %19, %17
  %26 = xor i32 %17, -1
  %27 = add i32 %19, %26
...
for_loop_body.prol:                               ; preds = %for_loop_body.prol, %for_loop_body.prol.preheader
  ...
  %33 = getelementptr float, float* %31, i64 %32
  %34 = load float, float* %33, align 4
  %35 = load float*, float** %24, align 8
  %36 = getelementptr float, float* %35, i64 %32
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.preheader
  ...
  %45 = load float*, float** %24, align 8
  %46 = getelementptr float, float* %45, i64 %42
  ...
  %52 = getelementptr float, float* %50, i64 %51
  %53 = load float, float* %52, align 4
  %54 = load float*, float** %24, align 8
  %55 = getelementptr float, float* %54, i64 %51
  ...
  %61 = getelementptr float, float* %59, i64 %60
  %62 = load float, float* %61, align 4
  %63 = load float*, float** %24, align 8
  %64 = getelementptr float, float* %63, i64 %60
  ...
  %70 = getelementptr float, float* %68, i64 %69
  %71 = load float, float* %70, align 4
  %72 = load float*, float** %24, align 8
  %73 = getelementptr float, float* %72, i64 %69
