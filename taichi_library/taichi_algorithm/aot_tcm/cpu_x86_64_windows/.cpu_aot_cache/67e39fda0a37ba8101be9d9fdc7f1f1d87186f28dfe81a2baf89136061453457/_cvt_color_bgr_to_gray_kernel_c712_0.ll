...
define void @_cvt_color_bgr_to_gray_kernel_c712_0_kernel_0_serial(%struct.RuntimeContext.192* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.192* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  ...
  %4 = getelementptr inbounds %struct.RuntimeContext.192, %struct.RuntimeContext.192* %context, i64 0, i32 1
  %5 = load %struct.LLVMRuntime.191*, %struct.LLVMRuntime.191** %4, align 8
  %6 = getelementptr inbounds %struct.LLVMRuntime.191, %struct.LLVMRuntime.191* %5, i64 0, i32 14
  ...
  %13 = load %struct.LLVMRuntime.191*, %struct.LLVMRuntime.191** %4, align 8
  %14 = getelementptr inbounds %struct.LLVMRuntime.191, %struct.LLVMRuntime.191* %13, i64 0, i32 14
  %15 = load i8*, i8** %14, align 8
  %16 = getelementptr inbounds i8, i8* %15, i64 4
  %17 = bitcast i8* %16 to i32*
  store i32 %12, i32* %17, align 4
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.191*, %struct.LLVMRuntime.191** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.191, %struct.LLVMRuntime.191* %19, i64 0, i32 14
...
define void @_cvt_color_bgr_to_gray_kernel_c712_0_kernel_1_range_for(%struct.RuntimeContext.192* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.192* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %27 = load %struct.LLVMRuntime.191*, %struct.LLVMRuntime.191** %3, align 8
  %28 = getelementptr inbounds %struct.LLVMRuntime.191, %struct.LLVMRuntime.191* %27, i64 0, i32 14
  ...
  %55 = fmul reassoc ninf nsz float %54, 0x3FD322D0E0000000
  %56 = fmul reassoc ninf nsz float %50, 0x3FE2C8B440000000
  %57 = fmul reassoc ninf nsz float %46, 0x3FBD2F1AA0000000
  %58 = fadd reassoc ninf nsz float %56, %57
  %59 = fadd reassoc ninf nsz float %58, %55
