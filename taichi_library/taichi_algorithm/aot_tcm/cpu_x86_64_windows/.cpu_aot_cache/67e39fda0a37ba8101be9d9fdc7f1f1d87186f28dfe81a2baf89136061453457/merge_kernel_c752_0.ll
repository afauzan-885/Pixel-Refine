...
define void @merge_kernel_c752_0_kernel_0_serial(%struct.RuntimeContext.144* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.144* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  ...
  %4 = getelementptr inbounds %struct.RuntimeContext.144, %struct.RuntimeContext.144* %context, i64 0, i32 1
  %5 = load %struct.LLVMRuntime.143*, %struct.LLVMRuntime.143** %4, align 8
  %6 = getelementptr inbounds %struct.LLVMRuntime.143, %struct.LLVMRuntime.143* %5, i64 0, i32 14
  ...
  %13 = load %struct.LLVMRuntime.143*, %struct.LLVMRuntime.143** %4, align 8
  %14 = getelementptr inbounds %struct.LLVMRuntime.143, %struct.LLVMRuntime.143* %13, i64 0, i32 14
  %15 = load i8*, i8** %14, align 8
  %16 = getelementptr inbounds i8, i8* %15, i64 4
  %17 = bitcast i8* %16 to i32*
  store i32 %12, i32* %17, align 4
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.143*, %struct.LLVMRuntime.143** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.143, %struct.LLVMRuntime.143* %19, i64 0, i32 14
...
define void @merge_kernel_c752_0_kernel_1_range_for(%struct.RuntimeContext.144* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.144* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %31 = load %struct.LLVMRuntime.143*, %struct.LLVMRuntime.143** %3, align 8
  %32 = getelementptr inbounds %struct.LLVMRuntime.143, %struct.LLVMRuntime.143* %31, i64 0, i32 14
  ...
  store float %49, float* %70, align 4
  ...
  store float %63, float* %86, align 4
  %87 = add nsw i32 %.04, 1
