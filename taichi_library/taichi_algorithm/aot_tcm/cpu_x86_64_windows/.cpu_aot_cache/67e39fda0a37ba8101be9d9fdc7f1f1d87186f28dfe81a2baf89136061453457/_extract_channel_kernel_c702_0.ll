...
define void @_extract_channel_kernel_c702_0_kernel_0_serial(%struct.RuntimeContext.72* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.72* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }**
  %1 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %1, i64 0, i32 1, i32 0, i32 0
  ...
  %11 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %10, i64 0, i32 1, i32 0, i32 1
  %12 = load i32, i32* %11, align 4
  %13 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %4, align 8
  %14 = getelementptr inbounds %struct.LLVMRuntime.71, %struct.LLVMRuntime.71* %13, i64 0, i32 14
  %15 = load i8*, i8** %14, align 8
  %16 = getelementptr inbounds i8, i8* %15, i64 4
  %17 = bitcast i8* %16 to i32*
  store i32 %12, i32* %17, align 4
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.71, %struct.LLVMRuntime.71* %19, i64 0, i32 14
...
define void @_extract_channel_kernel_c702_0_kernel_1_range_for(%struct.RuntimeContext.72* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.72* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %48 = getelementptr float, float* %41, i64 %47
