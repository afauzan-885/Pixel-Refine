...
define void @_mark_filled_kernel_c462_0_kernel_0_serial(%struct.RuntimeContext.48* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.48* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }**
  ...
  %5 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %1, i64 0, i32 3
...
define void @_mark_filled_kernel_c462_0_kernel_1_range_for(%struct.RuntimeContext.48* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.48* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }**
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %25 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %21, i64 0, i32 0, i32 1
  %26 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %21, i64 0, i32 0, i32 0, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %63, %after_if ]
  ...
  %50 = fsub reassoc ninf nsz float %49, %23
  %51 = tail call float @llvm.fabs.f32(float %50)
  %52 = fcmp reassoc ninf nsz olt float %51, 5.000000e-01
...
true_block:                                       ; preds = %for_loop_body
  %53 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }** %20, align 8
  %54 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %53, i64 0, i32 1, i32 1
  %55 = load float*, float** %54, align 8
  %56 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %53, i64 0, i32 1, i32 0, i32 1
