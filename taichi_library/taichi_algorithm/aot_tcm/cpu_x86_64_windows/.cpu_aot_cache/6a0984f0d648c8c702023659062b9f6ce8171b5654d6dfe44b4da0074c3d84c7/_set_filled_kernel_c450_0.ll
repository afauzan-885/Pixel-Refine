...
define void @_set_filled_kernel_c450_0_kernel_0_serial(%struct.RuntimeContext.60* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.60* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
define void @_set_filled_kernel_c450_0_kernel_1_range_for(%struct.RuntimeContext.60* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.60* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.046 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %58, %for_loop_body ]
  %27 = load %struct.LLVMRuntime.59*, %struct.LLVMRuntime.59** %3, align 8
  ...
  %.0 = select i1 %50, float 0.000000e+00, float 1.000000e+00
  ...
  store float %.0, float* %57, align 4
