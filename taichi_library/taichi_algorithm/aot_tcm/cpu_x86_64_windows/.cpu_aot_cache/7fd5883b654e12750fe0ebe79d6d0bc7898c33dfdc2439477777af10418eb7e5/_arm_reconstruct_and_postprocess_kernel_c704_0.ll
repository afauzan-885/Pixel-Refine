...
define void @_arm_reconstruct_and_postprocess_kernel_c704_0_kernel_0_serial(%struct.RuntimeContext.30* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.30* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float, float, float, float, i32, i32 }**
  ...
  %6 = getelementptr inbounds %struct.RuntimeContext.30, %struct.RuntimeContext.30* %context, i64 0, i32 1
  %7 = load %struct.LLVMRuntime.29*, %struct.LLVMRuntime.29** %6, align 8
  %8 = getelementptr inbounds %struct.LLVMRuntime.29, %struct.LLVMRuntime.29* %7, i64 0, i32 14
  ...
  %21 = load %struct.LLVMRuntime.29*, %struct.LLVMRuntime.29** %6, align 8
  %22 = getelementptr inbounds %struct.LLVMRuntime.29, %struct.LLVMRuntime.29* %21, i64 0, i32 14
  ...
  %31 = load %struct.LLVMRuntime.29*, %struct.LLVMRuntime.29** %6, align 8
  %32 = getelementptr inbounds %struct.LLVMRuntime.29, %struct.LLVMRuntime.29* %31, i64 0, i32 14
  ...
  %43 = load %struct.LLVMRuntime.29*, %struct.LLVMRuntime.29** %6, align 8
  %44 = getelementptr inbounds %struct.LLVMRuntime.29, %struct.LLVMRuntime.29* %43, i64 0, i32 14
  %45 = load i8*, i8** %44, align 8
  %46 = getelementptr inbounds i8, i8* %45, i64 4
  %47 = bitcast i8* %46 to i32*
  store i32 %42, i32* %47, align 4
  %48 = mul i32 %42, %39
  %49 = load %struct.LLVMRuntime.29*, %struct.LLVMRuntime.29** %6, align 8
  %50 = getelementptr inbounds %struct.LLVMRuntime.29, %struct.LLVMRuntime.29* %49, i64 0, i32 14
...
define void @_arm_reconstruct_and_postprocess_kernel_c704_0_kernel_1_range_for(%struct.RuntimeContext.30* %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
  ...
  store void (%struct.RuntimeContext.30*, i8*)* null, void (%struct.RuntimeContext.30*, i8*)** %2, align 8
  store i64 1, i64* %3, align 8
  %5 = getelementptr inbounds %0, %0* %0, i64 0, i32 2
  store void (%struct.RuntimeContext.30*, i8*, i32)* @function_body, void (%struct.RuntimeContext.30*, i8*, i32)** %5, align 8
  %6 = getelementptr inbounds %0, %0* %0, i64 0, i32 3
  store void (%struct.RuntimeContext.30*, i8*)* null, void (%struct.RuntimeContext.30*, i8*)** %6, align 8
...
define internal void @function_body(%struct.RuntimeContext.30* nocapture readonly %0, i8* nocapture readnone %1, i32 %2) #3 {
allocs:
  %3 = getelementptr inbounds %struct.RuntimeContext.30, %struct.RuntimeContext.30* %0, i64 0, i32 1
  %4 = load %struct.LLVMRuntime.29*, %struct.LLVMRuntime.29** %3, align 8
  %5 = getelementptr inbounds %struct.LLVMRuntime.29, %struct.LLVMRuntime.29* %4, i64 0, i32 14
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.30* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float, float, float, float, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.010 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %148, %for_loop_body ]
  %32 = load %struct.LLVMRuntime.29*, %struct.LLVMRuntime.29** %3, align 8
  %33 = getelementptr inbounds %struct.LLVMRuntime.29, %struct.LLVMRuntime.29* %32, i64 0, i32 14
  ...
  %89 = fmul reassoc ninf nsz float %86, 0x4006DB6DC0000000
  %90 = fadd reassoc ninf nsz float %89, 0xBFF4924920000000
  ...
  %95 = fmul reassoc ninf nsz float %88, 0x3FFEC4EC60000000
  %96 = fdiv reassoc ninf nsz float %95, %94
  %97 = fsub reassoc ninf nsz float 0x3FF93B13C0000000, %96
  ...
  %105 = fadd reassoc ninf nsz float %63, %54
  %106 = fadd reassoc ninf nsz float %105, %72
  %107 = fmul reassoc ninf nsz float %106, 0x3FD5555560000000
  %108 = fsub reassoc ninf nsz float 1.000000e+00, %104
  %109 = fmul reassoc ninf nsz float %108, %63
  %110 = fmul reassoc ninf nsz float %107, %104
  %111 = fadd reassoc ninf nsz float %109, %110
  %112 = fmul reassoc ninf nsz float %108, %54
  %113 = fadd reassoc ninf nsz float %112, %110
  %114 = fmul reassoc ninf nsz float %108, %72
  %115 = fadd reassoc ninf nsz float %114, %110
  %116 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %111, float 0.000000e+00)
  %117 = load float*, float** %29, align 8
  ...
  %125 = getelementptr float, float* %117, i64 %124
  store float %116, float* %125, align 4
  %126 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %113, float 0.000000e+00)
  %127 = load float*, float** %29, align 8
  ...
  %136 = getelementptr float, float* %127, i64 %135
  store float %126, float* %136, align 4
  %137 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %115, float 0.000000e+00)
  %138 = load float*, float** %29, align 8
  ...
  %148 = add nsw i32 %.010, 1
  %exitcond.not = icmp eq i32 %19, %148
...
6:                                                ; preds = %3
  call void %.sroa.4.0.copyload(%struct.RuntimeContext.30* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %7
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.30* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.02038) #2
...
.lr.ph41:                                         ; preds = %.lr.ph41, %.lr.ph41.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.30* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.0) #2
...
24:                                               ; preds = %.loopexit
  call void %.sroa.7.0.copyload(%struct.RuntimeContext.30* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %25
