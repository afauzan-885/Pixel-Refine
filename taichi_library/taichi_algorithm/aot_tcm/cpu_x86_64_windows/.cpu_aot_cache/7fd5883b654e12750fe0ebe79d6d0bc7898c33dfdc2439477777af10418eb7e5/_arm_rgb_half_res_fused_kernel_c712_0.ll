...
define void @_arm_rgb_half_res_fused_kernel_c712_0_kernel_0_serial(%struct.RuntimeContext.90* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_arm_rgb_half_res_fused_kernel_c712_0_kernel_1_range_for(%struct.RuntimeContext.90* %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
