...
define void @_lk_zero_stats_kernel_c482_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext* %context to { { { i32 }, float* } }**
  %1 = load { { { i32 }, float* } }*, { { { i32 }, float* } }** %0, align 8
  %2 = getelementptr { { { i32 }, float* } }, { { { i32 }, float* } }* %1, i64 0, i32 0, i32 0, i32 0
...
define void @_lk_zero_stats_kernel_c482_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext* %0 to { { { i32 }, float* } }**
  %22 = load { { { i32 }, float* } }*, { { { i32 }, float* } }** %21, align 8
  %23 = getelementptr { { { i32 }, float* } }, { { { i32 }, float* } }* %22, i64 0, i32 0, i32 1
...
for_loop_body.prol.preheader:                     ; preds = %for_loop_body.lr.ph
  %28 = shl nuw nsw i64 %xtraiter, 2
  br label %for_loop_body.prol

for_loop_body.prol:                               ; preds = %for_loop_body.prol, %for_loop_body.prol.preheader
  %lsr.iv = phi i64 [ %28, %for_loop_body.prol.preheader ], [ %lsr.iv.next, %for_loop_body.prol ]
  %indvars.iv.prol = phi i64 [ %indvars.iv.next.prol, %for_loop_body.prol ], [ %24, %for_loop_body.prol.preheader ]
  %29 = load float*, float** %23, align 8
  %scevgep20 = getelementptr float, float* %29, i64 %indvars.iv.prol
...
for_loop_body.prol.loopexit:                      ; preds = %for_loop_body.prol.loopexit.loopexit, %for_loop_body.lr.ph
  %indvars.iv.unr = phi i64 [ %24, %for_loop_body.lr.ph ], [ %indvars.iv.next.prol, %for_loop_body.prol.loopexit.loopexit ]
  %30 = icmp ult i64 %27, 7
  br i1 %30, label %after_for, label %for_loop_body.preheader

for_loop_body.preheader:                          ; preds = %for_loop_body.prol.loopexit
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.preheader
  %indvars.iv = phi i64 [ %indvars.iv.next.7, %for_loop_body ], [ %indvars.iv.unr, %for_loop_body.preheader ]
  %31 = load float*, float** %23, align 8
  %scevgep17 = getelementptr float, float* %31, i64 %indvars.iv
  store float 0.000000e+00, float* %scevgep17, align 4
  %32 = load float*, float** %23, align 8
  %scevgep18 = getelementptr float, float* %32, i64 1
  %scevgep19 = getelementptr float, float* %scevgep18, i64 %indvars.iv
  store float 0.000000e+00, float* %scevgep19, align 4
  %33 = load float*, float** %23, align 8
  %scevgep15 = getelementptr float, float* %33, i64 2
  %scevgep16 = getelementptr float, float* %scevgep15, i64 %indvars.iv
  store float 0.000000e+00, float* %scevgep16, align 4
  %34 = load float*, float** %23, align 8
  %scevgep13 = getelementptr float, float* %34, i64 3
  %scevgep14 = getelementptr float, float* %scevgep13, i64 %indvars.iv
  store float 0.000000e+00, float* %scevgep14, align 4
  %35 = load float*, float** %23, align 8
  %scevgep11 = getelementptr float, float* %35, i64 4
  ...
  %scevgep9 = getelementptr float, float* %36, i64 5
  ...
  %scevgep7 = getelementptr float, float* %37, i64 6
  ...
  %scevgep = getelementptr float, float* %38, i64 7
  %scevgep6 = getelementptr float, float* %scevgep, i64 %indvars.iv
  store float 0.000000e+00, float* %scevgep6, align 4
  %indvars.iv.next.7 = add nsw i64 %indvars.iv, 8
  %exitcond.not.7 = icmp eq i64 %wide.trip.count, %indvars.iv.next.7
  br i1 %exitcond.not.7, label %after_for.loopexit, label %for_loop_body
