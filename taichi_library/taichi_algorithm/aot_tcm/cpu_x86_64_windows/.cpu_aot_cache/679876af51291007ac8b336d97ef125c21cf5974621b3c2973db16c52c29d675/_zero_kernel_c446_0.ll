...
define void @_zero_kernel_c446_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_zero_kernel_c446_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body.prol:                               ; preds = %for_loop_body.lr.ph
  ...
  %31 = and i1 %29, %30
  %.neg4.prol = sext i1 %31 to i32
  %32 = add i32 %26, %.neg4.prol
  %33 = load ptr, ptr %21, align 8
  %34 = load i32, ptr %22, align 4
  %reass.add.prol = sub i32 %34, %25
  %reass.mul.prol = mul i32 %reass.add.prol, %32
  %35 = add i32 %reass.mul.prol, %16
  %36 = sext i32 %35 to i64
  %37 = getelementptr float, ptr %33, i64 %36
  store float 0.000000e+00, ptr %37, align 4
  br label %for_loop_body.prol.loopexit

for_loop_body.prol.loopexit:                      ; preds = %for_loop_body.prol, %for_loop_body.lr.ph
  %.06.unr = phi i32 [ %16, %for_loop_body.lr.ph ], [ %.neg7, %for_loop_body.prol ]
  %38 = icmp eq i32 %18, %.neg7
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.preheader
  %.06 = phi i32 [ %75, %for_loop_body ], [ %.06.unr, %for_loop_body.preheader ]
  ...
  %48 = icmp ne i32 %45, %.06
  %49 = and i1 %47, %48
  %.neg4 = sext i1 %49 to i32
  %50 = add i32 %44, %.neg4
  %51 = load ptr, ptr %21, align 8
  %52 = load i32, ptr %22, align 4
  %reass.add = sub i32 %52, %43
  %reass.mul = mul i32 %reass.add, %50
  %53 = add i32 %.06, %reass.mul
  ...
  %66 = icmp ne i32 %63, %61
  %67 = and i1 %65, %66
  %.neg4.1 = sext i1 %67 to i32
  %68 = add i32 %62, %.neg4.1
  %69 = load ptr, ptr %21, align 8
  %70 = load i32, ptr %22, align 4
  %reass.add.1 = sub i32 %70, %60
  %reass.mul.1 = mul i32 %reass.add.1, %68
  %71 = add i32 %.06, %reass.mul.1
  %72 = add i32 %71, 1
  %73 = sext i32 %72 to i64
  %74 = getelementptr float, ptr %69, i64 %73
  store float 0.000000e+00, ptr %74, align 4
  %75 = add i32 %61, 1
  %exitcond.not.1 = icmp eq i32 %75, %18
  br i1 %exitcond.not.1, label %after_for.loopexit, label %for_loop_body
