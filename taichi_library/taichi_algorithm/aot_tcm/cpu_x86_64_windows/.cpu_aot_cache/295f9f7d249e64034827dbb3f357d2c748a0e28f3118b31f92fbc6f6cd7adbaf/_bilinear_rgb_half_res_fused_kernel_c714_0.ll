...
define void @_bilinear_rgb_half_res_fused_kernel_c714_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_bilinear_rgb_half_res_fused_kernel_c714_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
allocs:
  ...
  %60 = icmp slt i32 %16, %18
  br i1 %60, label %for_loop_body.lr.ph, label %after_for

for_loop_body.lr.ph:                              ; preds = %allocs
  %61 = getelementptr i8, ptr %19, i64 8
  %62 = getelementptr i8, ptr %19, i64 4
  %63 = shl i32 %16, 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %after_if36, %for_loop_body.lr.ph
  %lsr.iv = phi i32 [ %63, %for_loop_body.lr.ph ], [ %lsr.iv.next, %after_if36 ]
  %.01932 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %283, %after_if36 ]
...
true_block34:                                     ; preds = %after_if27
  ...
  %187 = getelementptr i8, ptr %184, i64 36
  %188 = load i32, ptr %187, align 4
  %189 = getelementptr i8, ptr %184, i64 40
  %190 = load i32, ptr %189, align 4
  %191 = sub i32 %188, %68
  %192 = mul i32 %191, %75
  %193 = add i32 %.01932, %192
  %194 = mul i32 %193, %190
  %195 = sext i32 %194 to i64
  %196 = getelementptr float, ptr %186, i64 %195
  store float %183, ptr %196, align 4
  %197 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %173, float 0.000000e+00)
  %198 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %197, float 1.000000e+00)
  %199 = load ptr, ptr %185, align 8
  %200 = load i32, ptr %187, align 4
  %201 = load i32, ptr %189, align 4
  %202 = sub i32 %200, %68
  %203 = mul i32 %202, %75
  %204 = add i32 %.01932, %203
  %205 = mul i32 %204, %201
  %206 = add i32 %205, 1
  %207 = sext i32 %206 to i64
  %208 = getelementptr float, ptr %199, i64 %207
  store float %198, ptr %208, align 4
  %209 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %181, float 0.000000e+00)
  %210 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %209, float 1.000000e+00)
  br label %after_if36

false_block35:                                    ; preds = %after_if27
  %211 = fmul reassoc ninf nsz float %165, %165
  %212 = fadd reassoc ninf nsz float %211, 1.000000e+00
  %213 = tail call reassoc ninf nsz float @llvm.sqrt.f32(float %212)
  %214 = fdiv reassoc ninf nsz float %165, %213
  %215 = fmul reassoc ninf nsz float %173, %173
  %216 = fadd reassoc ninf nsz float %215, 1.000000e+00
  %217 = tail call reassoc ninf nsz float @llvm.sqrt.f32(float %216)
  %218 = fdiv reassoc ninf nsz float %173, %217
  %219 = fmul reassoc ninf nsz float %181, %181
  %220 = fadd reassoc ninf nsz float %219, 1.000000e+00
  %221 = tail call reassoc ninf nsz float @llvm.sqrt.f32(float %220)
  %222 = fdiv reassoc ninf nsz float %181, %221
  %223 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %214, float 0.000000e+00)
  ...
  %236 = getelementptr i8, ptr %233, i64 36
  %237 = load i32, ptr %236, align 4
  %238 = getelementptr i8, ptr %233, i64 40
  %239 = load i32, ptr %238, align 4
  %240 = sub i32 %237, %68
  %241 = mul i32 %240, %75
  %242 = add i32 %.01932, %241
  %243 = mul i32 %242, %239
  %244 = sext i32 %243 to i64
  %245 = getelementptr float, ptr %235, i64 %244
  store float %232, ptr %245, align 4
  %246 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %218, float 0.000000e+00)
  %247 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %246, float 1.000000e+00)
  %248 = tail call reassoc ninf nsz float @llvm.sqrt.f32(float %247)
  %249 = fmul reassoc ninf nsz float %248, 0x3FD3A00620000000
  %250 = fsub reassoc ninf nsz float 0x3FE94CF0E0000000, %249
  %251 = fmul reassoc ninf nsz float %250, %248
  %252 = fadd reassoc ninf nsz float %251, 0xBFE9435AA0000000
  %253 = fmul reassoc ninf nsz float %252, %248
  %254 = fadd reassoc ninf nsz float %253, 0x3FF4E33660000000
  %255 = fmul reassoc ninf nsz float %254, %248
  %256 = load ptr, ptr %234, align 8
  %257 = load i32, ptr %236, align 4
  %258 = load i32, ptr %238, align 4
  %259 = sub i32 %257, %68
  %260 = mul i32 %259, %75
  %261 = add i32 %.01932, %260
  %262 = mul i32 %261, %258
  %263 = add i32 %262, 1
  %264 = sext i32 %263 to i64
  %265 = getelementptr float, ptr %256, i64 %264
  store float %255, ptr %265, align 4
  %266 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %222, float 0.000000e+00)
  %267 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %266, float 1.000000e+00)
  %268 = tail call reassoc ninf nsz float @llvm.sqrt.f32(float %267)
  %269 = fmul reassoc ninf nsz float %268, 0x3FD3A00620000000
  %270 = fsub reassoc ninf nsz float 0x3FE94CF0E0000000, %269
  %271 = fmul reassoc ninf nsz float %270, %268
  %272 = fadd reassoc ninf nsz float %271, 0xBFE9435AA0000000
  %273 = fmul reassoc ninf nsz float %272, %268
  %274 = fadd reassoc ninf nsz float %273, 0x3FF4E33660000000
  %275 = fmul reassoc ninf nsz float %274, %268
  br label %after_if36

after_if36:                                       ; preds = %false_block35, %true_block34
  %.sink41.in = phi ptr [ %236, %false_block35 ], [ %187, %true_block34 ]
  %.sink39.in = phi ptr [ %238, %false_block35 ], [ %189, %true_block34 ]
  %.sink34.in = phi ptr [ %234, %false_block35 ], [ %185, %true_block34 ]
  %.sink = phi float [ %275, %false_block35 ], [ %210, %true_block34 ]
  %.sink34 = load ptr, ptr %.sink34.in, align 8
  %.sink39 = load i32, ptr %.sink39.in, align 4
  %.sink41 = load i32, ptr %.sink41.in, align 4
  %276 = sub i32 %.sink41, %68
  %277 = mul i32 %276, %75
  %278 = add i32 %.01932, %277
  %279 = mul i32 %278, %.sink39
  %280 = add i32 %279, 2
  %281 = sext i32 %280 to i64
  %282 = getelementptr float, ptr %.sink34, i64 %281
  store float %.sink, ptr %282, align 4
  %283 = add nsw i32 %.01932, 1
  %lsr.iv.next = add i32 %lsr.iv, 2
  %exitcond.not = icmp eq i32 %18, %283
