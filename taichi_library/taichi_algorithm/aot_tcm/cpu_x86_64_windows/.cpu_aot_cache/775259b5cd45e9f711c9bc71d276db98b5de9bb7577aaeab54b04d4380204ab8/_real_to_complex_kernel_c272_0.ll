...
define void @_real_to_complex_kernel_c272_0_kernel_0_serial(%struct.RuntimeContext.36* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_real_to_complex_kernel_c272_0_kernel_1_range_for(%struct.RuntimeContext.36* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.36* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %after_if3, %for_loop_body.preheader
  ...
  %.047 = phi i32 [ %78, %after_if3 ], [ %17, %for_loop_body.preheader ]
  ...
  %36 = icmp ne i32 %.047, 0
  %37 = icmp ne i32 %.047, %33
  %38 = and i1 %36, %35
  %39 = and i1 %38, %37
  %.neg6 = sext i1 %39 to i32
  %40 = add i32 %32, %.neg6
  %41 = mul i32 %31, -1
  %42 = mul i32 %41, %40
  %43 = add i32 %.047, %42
  %44 = icmp slt i32 %40, %23
...
true_block:                                       ; preds = %for_loop_body
  %46 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %45, i64 0, i32 3
  %47 = load i32, i32* %46, align 4
  %48 = icmp slt i32 %43, %47
  br i1 %48, label %true_block1, label %after_if3

true_block1:                                      ; preds = %true_block
  %49 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %45, i64 0, i32 0, i32 1
  %50 = load float*, float** %49, align 8
  %51 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %45, i64 0, i32 0, i32 0, i32 1
  %52 = load i32, i32* %51, align 4
  %53 = sub i32 %52, %31
  %54 = mul i32 %53, %40
  %55 = add i32 %.047, %54
  %56 = sext i32 %55 to i64
  %57 = getelementptr float, float* %50, i64 %56
  %58 = load float, float* %57, align 4
  br label %after_if3

after_if3:                                        ; preds = %true_block1, %true_block, %for_loop_body
  %.sink13 = phi float [ %58, %true_block1 ], [ 0.000000e+00, %for_loop_body ], [ 0.000000e+00, %true_block ]
  %59 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %45, i64 0, i32 1, i32 1
  %60 = load float*, float** %59, align 8
  %61 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %45, i64 0, i32 1, i32 0, i32 1
  %62 = load i32, i32* %61, align 4
  %63 = sub i32 %62, %31
  %64 = shl i32 %63, 1
  %65 = mul i32 %64, %40
  %66 = add i32 %lsr.iv, %65
  %67 = sext i32 %66 to i64
  %68 = getelementptr float, float* %60, i64 %67
  store float %.sink13, float* %68, align 4
  %69 = load float*, float** %59, align 8
