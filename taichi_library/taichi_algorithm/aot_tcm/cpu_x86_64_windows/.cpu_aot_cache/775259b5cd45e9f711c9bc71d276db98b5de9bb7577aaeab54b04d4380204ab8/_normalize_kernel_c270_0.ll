...
define void @_normalize_kernel_c270_0_kernel_0_serial(%struct.RuntimeContext.24* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.24* %context to { { { i32, i32 }, float* }, float }**
  %1 = load { { { i32, i32 }, float* }, float }*, { { { i32, i32 }, float* }, float }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, float }, { { { i32, i32 }, float* }, float }* %1, i64 0, i32 0, i32 0, i32 0
  %3 = load i32, i32* %2, align 4
  %4 = tail call i32 @llvm.smax.i32(i32 %3, i32 0)
  %5 = getelementptr { { { i32, i32 }, float* }, float }, { { { i32, i32 }, float* }, float }* %1, i64 0, i32 0, i32 0, i32 1
...
define void @_normalize_kernel_c270_0_kernel_1_range_for(%struct.RuntimeContext.24* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.24* %0 to { { { i32, i32 }, float* }, float }**
  %21 = load { { { i32, i32 }, float* }, float }*, { { { i32, i32 }, float* }, float }** %20, align 8
  %22 = getelementptr { { { i32, i32 }, float* }, float }, { { { i32, i32 }, float* }, float }* %21, i64 0, i32 1
  %23 = load float, float* %22, align 4
  %24 = icmp slt i32 %17, %19
  br i1 %24, label %for_loop_body.lr.ph, label %after_for

for_loop_body.lr.ph:                              ; preds = %allocs
  %25 = getelementptr { { { i32, i32 }, float* }, float }, { { { i32, i32 }, float* }, float }* %21, i64 0, i32 0, i32 1
  %26 = getelementptr { { { i32, i32 }, float* }, float }, { { { i32, i32 }, float* }, float }* %21, i64 0, i32 0, i32 0, i32 1
  %27 = shl i32 %17, 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %lsr.iv = phi i32 [ %27, %for_loop_body.lr.ph ], [ %lsr.iv.next, %for_loop_body ]
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %57, %for_loop_body ]
  %28 = load %struct.LLVMRuntime.23*, %struct.LLVMRuntime.23** %3, align 8
  %29 = getelementptr inbounds %struct.LLVMRuntime.23, %struct.LLVMRuntime.23* %28, i64 0, i32 14
  ...
  %reass.add = sub i32 %44, %33
  %45 = shl i32 %reass.add, 1
  %46 = mul i32 %45, %42
  ...
  %53 = getelementptr float, float* %43, i64 %52
  %54 = load float, float* %53, align 4
  %55 = fmul reassoc ninf nsz float %50, %23
  %56 = fmul reassoc ninf nsz float %54, %23
  store float %55, float* %49, align 4
  store float %56, float* %53, align 4
  %57 = add nsw i32 %.06, 1
  %lsr.iv.next = add i32 %lsr.iv, 2
  %exitcond.not = icmp eq i32 %19, %57
