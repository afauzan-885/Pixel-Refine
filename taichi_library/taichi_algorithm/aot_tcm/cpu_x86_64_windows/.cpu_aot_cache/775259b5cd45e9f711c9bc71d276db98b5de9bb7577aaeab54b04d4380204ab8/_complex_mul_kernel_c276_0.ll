...
define void @_complex_mul_kernel_c276_0_kernel_0_serial(%struct.RuntimeContext.60* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.60* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }**
  %1 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %1, i64 0, i32 0, i32 0, i32 0
  %3 = load i32, i32* %2, align 4
  %4 = tail call i32 @llvm.smax.i32(i32 %3, i32 0)
  %5 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %1, i64 0, i32 0, i32 0, i32 1
...
define void @_complex_mul_kernel_c276_0_kernel_1_range_for(%struct.RuntimeContext.60* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.60* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }**
  %21 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }** %20, align 8
  %22 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %21, i64 0, i32 3
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %26 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %21, i64 0, i32 0, i32 1
  %27 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %21, i64 0, i32 0, i32 0, i32 1
  %28 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %21, i64 0, i32 1, i32 1
  %29 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %21, i64 0, i32 1, i32 0, i32 1
  %30 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %21, i64 0, i32 2, i32 1
  %31 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32 }* %21, i64 0, i32 2, i32 0, i32 1
  %32 = shl i32 %17, 1
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %.046 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %98, %for_loop_body ]
  ...
  %44 = icmp ne i32 %.046, 0
  %45 = icmp ne i32 %.046, %41
  %46 = and i1 %44, %43
  %47 = and i1 %46, %45
  %.neg5 = sext i1 %47 to i32
  %48 = add i32 %40, %.neg5
  %49 = load float*, float** %26, align 8
  %50 = load i32, i32* %27, align 4
  %51 = sub i32 %50, %39
  %52 = shl i32 %51, 1
  %53 = mul i32 %52, %48
  %54 = add i32 %lsr.iv, %53
  %55 = add i32 %54, -1
  %56 = sext i32 %55 to i64
  %57 = getelementptr float, float* %49, i64 %56
  %58 = load float, float* %57, align 4
  %59 = sext i32 %54 to i64
  %60 = getelementptr float, float* %49, i64 %59
  %61 = load float, float* %60, align 4
  %62 = load float*, float** %28, align 8
  %63 = load i32, i32* %29, align 4
  %64 = sub i32 %63, %39
  %65 = shl i32 %64, 1
  %66 = mul i32 %65, %48
  %67 = add i32 %lsr.iv, %66
  %68 = add i32 %67, -1
  %69 = sext i32 %68 to i64
  %70 = getelementptr float, float* %62, i64 %69
  %71 = load float, float* %70, align 4
  %72 = sext i32 %67 to i64
  %73 = getelementptr float, float* %62, i64 %72
  %74 = load float, float* %73, align 4
  %neg = fneg reassoc ninf nsz float %74
  %spec.select = select i1 %24, float %neg, float %74
  %75 = fmul reassoc ninf nsz float %71, %58
  %76 = fmul reassoc ninf nsz float %spec.select, %61
  %77 = fsub reassoc ninf nsz float %75, %76
  %78 = fmul reassoc ninf nsz float %spec.select, %58
  %79 = fmul reassoc ninf nsz float %71, %61
  %80 = fadd reassoc ninf nsz float %78, %79
  %81 = load float*, float** %30, align 8
  %82 = load i32, i32* %31, align 4
  %83 = sub i32 %82, %39
  %84 = shl i32 %83, 1
  %85 = mul i32 %84, %48
  %86 = add i32 %lsr.iv, %85
  %87 = add i32 %86, -1
  %88 = sext i32 %87 to i64
  %89 = getelementptr float, float* %81, i64 %88
  store float %77, float* %89, align 4
  %90 = load float*, float** %30, align 8
