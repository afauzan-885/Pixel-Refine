...
define void @_complex_to_mag_kernel_c278_0_kernel_0_serial(%struct.RuntimeContext.72* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.72* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  ...
  %5 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %1, i64 0, i32 0, i32 0, i32 1
...
define void @_complex_to_mag_kernel_c278_0_kernel_1_range_for(%struct.RuntimeContext.72* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.72* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %67, %for_loop_body ]
  ...
  %50 = getelementptr float, float* %43, i64 %49
  %51 = load float, float* %50, align 4
  %52 = add i32 %48, 1
  %53 = sext i32 %52 to i64
  %54 = getelementptr float, float* %43, i64 %53
  %55 = load float, float* %54, align 4
  %56 = fmul reassoc ninf nsz float %51, %51
  %57 = fmul reassoc ninf nsz float %55, %55
  %58 = fadd reassoc ninf nsz float %57, %56
  %59 = tail call reassoc ninf nsz float @llvm.sqrt.f32(float %58)
