...
define void @_complex_hanning_kernel_c284_0_kernel_0_serial(%struct.RuntimeContext.108* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.108* %context to { { { i32, i32 }, float* }, i32, i32 }**
  %1 = load { { { i32, i32 }, float* }, i32, i32 }*, { { { i32, i32 }, float* }, i32, i32 }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, i32, i32 }* %1, i64 0, i32 1
  ...
  %11 = load { { { i32, i32 }, float* }, i32, i32 }*, { { { i32, i32 }, float* }, i32, i32 }** %0, align 8
  %12 = getelementptr { { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, i32, i32 }* %11, i64 0, i32 2
...
define void @_complex_hanning_kernel_c284_0_kernel_1_range_for(%struct.RuntimeContext.108* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.108* %0 to { { { i32, i32 }, float* }, i32, i32 }**
  %22 = load { { { i32, i32 }, float* }, i32, i32 }*, { { { i32, i32 }, float* }, i32, i32 }** %21, align 8
  %23 = getelementptr { { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, i32, i32 }* %22, i64 0, i32 0, i32 1
  %24 = getelementptr { { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, i32, i32 }* %22, i64 0, i32 0, i32 0, i32 1
  %25 = shl i32 %17, 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %lsr.iv = phi i32 [ %25, %for_loop_body.lr.ph ], [ %lsr.iv.next, %for_loop_body ]
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %85, %for_loop_body ]
  %26 = load %struct.LLVMRuntime.107*, %struct.LLVMRuntime.107** %3, align 8
  %27 = getelementptr inbounds %struct.LLVMRuntime.107, %struct.LLVMRuntime.107* %26, i64 0, i32 14
  ...
  %45 = fmul reassoc ninf nsz float %44, 0x401921FB60000000
  %46 = getelementptr inbounds i8, i8* %28, i64 8
  %47 = bitcast i8* %46 to i32*
  %48 = load i32, i32* %47, align 4
  %49 = add i32 %48, -1
  %50 = sitofp i32 %49 to float
  %51 = fdiv reassoc ninf nsz float %45, %50
  %52 = tail call float @cosf(float noundef %51) #1
  %53 = fmul reassoc ninf nsz float %52, 5.000000e-01
  %54 = fsub reassoc ninf nsz float 5.000000e-01, %53
  %55 = sitofp i32 %43 to float
  %56 = fmul reassoc ninf nsz float %55, 0x401921FB60000000
  %57 = load %struct.LLVMRuntime.107*, %struct.LLVMRuntime.107** %3, align 8
  %58 = getelementptr inbounds %struct.LLVMRuntime.107, %struct.LLVMRuntime.107* %57, i64 0, i32 14
  ...
  %65 = fdiv reassoc ninf nsz float %56, %64
  %66 = tail call float @cosf(float noundef %65) #1
  %67 = fmul reassoc ninf nsz float %66, 5.000000e-01
  %68 = fsub reassoc ninf nsz float 5.000000e-01, %67
  %69 = load float*, float** %23, align 8
  ...
  %82 = fmul reassoc ninf nsz float %68, %54
  %83 = fmul reassoc ninf nsz float %77, %82
  %84 = fmul reassoc ninf nsz float %81, %82
  store float %83, float* %76, align 4
  store float %84, float* %80, align 4
  %85 = add nsw i32 %.05, 1
  %lsr.iv.next = add i32 %lsr.iv, 2
  %exitcond.not = icmp eq i32 %19, %85
