...
define void @_complex_to_real_kernel_c274_0_kernel_0_serial(%struct.RuntimeContext.48* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_complex_to_real_kernel_c274_0_kernel_1_range_for(%struct.RuntimeContext.48* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.48* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %after_if3, %for_loop_body.preheader
  ...
  %.047 = phi i32 [ %69, %after_if3 ], [ %17, %for_loop_body.preheader ]
  %26 = load %struct.LLVMRuntime.47*, %struct.LLVMRuntime.47** %3, align 8
...
true_block1:                                      ; preds = %true_block
  ...
  %54 = shl i32 %53, 1
  %55 = mul i32 %54, %40
  %56 = add i32 %lsr.iv, %55
  %57 = sext i32 %56 to i64
  %58 = getelementptr float, float* %50, i64 %57
  %59 = load float, float* %58, align 4
  %60 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %45, i64 0, i32 1, i32 1
  %61 = load float*, float** %60, align 8
  %62 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %45, i64 0, i32 1, i32 0, i32 1
