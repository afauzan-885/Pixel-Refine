...
define void @_hanning_window_kernel_c282_0_kernel_0_serial(%struct.RuntimeContext.96* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.96* %context to { { { i32, i32 }, float* }, i32, i32 }**
...
define void @_hanning_window_kernel_c282_0_kernel_1_range_for(%struct.RuntimeContext.96* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.96* %0 to { { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %78, %for_loop_body ]
  %25 = load %struct.LLVMRuntime.95*, %struct.LLVMRuntime.95** %3, align 8
  %26 = getelementptr inbounds %struct.LLVMRuntime.95, %struct.LLVMRuntime.95* %25, i64 0, i32 14
  ...
  %44 = fmul reassoc ninf nsz float %43, 0x401921FB60000000
  %45 = getelementptr inbounds i8, i8* %27, i64 8
  %46 = bitcast i8* %45 to i32*
  %47 = load i32, i32* %46, align 4
  %48 = add i32 %47, -1
  %49 = sitofp i32 %48 to float
  %50 = fdiv reassoc ninf nsz float %44, %49
  ...
  %55 = fmul reassoc ninf nsz float %54, 0x401921FB60000000
  %56 = load %struct.LLVMRuntime.95*, %struct.LLVMRuntime.95** %3, align 8
  %57 = getelementptr inbounds %struct.LLVMRuntime.95, %struct.LLVMRuntime.95* %56, i64 0, i32 14
  ...
  %64 = fdiv reassoc ninf nsz float %55, %63
  %65 = tail call float @cosf(float noundef %64) #1
  %66 = fmul reassoc ninf nsz float %65, 5.000000e-01
  %67 = fsub reassoc ninf nsz float 5.000000e-01, %66
  ...
  %76 = fmul reassoc ninf nsz float %67, %53
  %77 = fmul reassoc ninf nsz float %76, %75
  store float %77, float* %74, align 4
  %78 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %19, %78
