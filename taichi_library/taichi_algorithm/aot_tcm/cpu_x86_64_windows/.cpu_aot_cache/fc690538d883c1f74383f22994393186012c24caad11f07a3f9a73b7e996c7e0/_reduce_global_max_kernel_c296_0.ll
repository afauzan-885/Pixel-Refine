...
define void @_reduce_global_max_kernel_c296_0_kernel_0_serial(%struct.RuntimeContext.48* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = getelementptr inbounds %struct.RuntimeContext.48, %struct.RuntimeContext.48* %context, i64 0, i32 1
  %1 = load %struct.LLVMRuntime.47*, %struct.LLVMRuntime.47** %0, align 8
  %2 = getelementptr inbounds %struct.LLVMRuntime.47, %struct.LLVMRuntime.47* %1, i64 0, i32 14
  %3 = load i8*, i8** %2, align 8
  %4 = getelementptr inbounds i8, i8* %3, i64 4
  %5 = bitcast i8* %4 to float*
  store float -1.000000e+10, float* %5, align 4
  %6 = load %struct.LLVMRuntime.47*, %struct.LLVMRuntime.47** %0, align 8
  %7 = getelementptr inbounds %struct.LLVMRuntime.47, %struct.LLVMRuntime.47* %6, i64 0, i32 14
  %8 = load i8*, i8** %7, align 8
  %9 = getelementptr inbounds i8, i8* %8, i64 8
  %10 = bitcast i8* %9 to i32*
  store i32 0, i32* %10, align 4
  %11 = load %struct.LLVMRuntime.47*, %struct.LLVMRuntime.47** %0, align 8
  %12 = getelementptr inbounds %struct.LLVMRuntime.47, %struct.LLVMRuntime.47* %11, i64 0, i32 14
  %13 = load i8*, i8** %12, align 8
  %14 = getelementptr inbounds i8, i8* %13, i64 12
  %15 = bitcast i8* %14 to i32*
  store i32 0, i32* %15, align 4
  %16 = bitcast %struct.RuntimeContext.48* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  %17 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* } }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }** %16, align 8
  %18 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %17, i64 0, i32 0, i32 0, i32 0
  %19 = load i32, i32* %18, align 4
  %20 = load %struct.LLVMRuntime.47*, %struct.LLVMRuntime.47** %0, align 8
...
define void @_reduce_global_max_kernel_c296_0_kernel_1_range_for(%struct.RuntimeContext.48* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.48* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %56, %after_if ]
  %25 = load float*, float** %23, align 8
  %26 = load i32, i32* %24, align 4
  %27 = mul i32 %26, %.05
  %28 = sext i32 %27 to i64
  %29 = getelementptr float, float* %25, i64 %28
  ...
  %37 = fcmp reassoc ninf nsz ogt float %30, %36
  br i1 %37, label %true_block, label %after_if
...
true_block:                                       ; preds = %for_loop_body
  ...
  %51 = load %struct.LLVMRuntime.47*, %struct.LLVMRuntime.47** %3, align 8
  %52 = getelementptr inbounds %struct.LLVMRuntime.47, %struct.LLVMRuntime.47* %51, i64 0, i32 14
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn
define void @_reduce_global_max_kernel_c296_0_kernel_2_serial(%struct.RuntimeContext.48* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = getelementptr inbounds %struct.RuntimeContext.48, %struct.RuntimeContext.48* %context, i64 0, i32 1
  %1 = load %struct.LLVMRuntime.47*, %struct.LLVMRuntime.47** %0, align 8
  %2 = getelementptr inbounds %struct.LLVMRuntime.47, %struct.LLVMRuntime.47* %1, i64 0, i32 14
  ...
  %7 = bitcast %struct.RuntimeContext.48* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  %8 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* } }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }** %7, align 8
  %9 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %8, i64 0, i32 1, i32 1
  ...
  %19 = getelementptr float, float* %18, i64 1
  ...
  %28 = getelementptr float, float* %27, i64 2
