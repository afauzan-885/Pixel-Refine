...
define void @_reduce_row_max_kernel_c294_0_kernel_0_serial(%struct.RuntimeContext.36* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.36* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
define void @_reduce_row_max_kernel_c294_0_kernel_1_range_for(%struct.RuntimeContext.36* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.36* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  %21 = icmp slt i32 %17, %19
  br i1 %21, label %for_loop_body.lr.ph, label %after_for

for_loop_body.lr.ph:                              ; preds = %allocs
  %22 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* } }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }** %20, align 8
...
for_loop_body:                                    ; preds = %after_for3, %for_loop_body.lr.ph
  %.01218 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %79, %after_for3 ]
  %27 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* } }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }** %20, align 8
  %28 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %27, i64 0, i32 0, i32 0, i32 1
  %29 = load i32, i32* %28, align 4
  %30 = icmp sgt i32 %29, 0
  br i1 %30, label %for_loop_body1.lr.ph, label %after_for3
...
for_loop_body1.lr.ph:                             ; preds = %for_loop_body
  ...
  br i1 %34, label %after_for3.loopexit.unr-lcssa, label %for_loop_body1.lr.ph.new
...
for_loop_body1:                                   ; preds = %for_loop_body1, %for_loop_body1.lr.ph.new
  ...
  %37 = add i64 %36, %indvars.iv
  %tmp29 = trunc i64 %37 to i32
  %38 = sext i32 %tmp29 to i64
  %39 = getelementptr float, float* %31, i64 %38
  %40 = load float, float* %39, align 4
  %41 = fcmp reassoc ninf nsz ogt float %40, %.01014
  %.111 = select i1 %41, float %40, float %.01014
  %tmp28 = trunc i64 %indvars.iv to i32
  %.1 = select i1 %41, i32 %tmp28, i32 %.0915
  %42 = add nuw nsw i64 %indvars.iv, 1
  %43 = add i64 %37, 1
  %tmp24 = trunc i64 %43 to i32
  %44 = sext i32 %tmp24 to i64
  %45 = getelementptr float, float* %31, i64 %44
  %46 = load float, float* %45, align 4
  %47 = fcmp reassoc ninf nsz ogt float %46, %.111
  %.111.1 = select i1 %47, float %46, float %.111
  %tmp25 = trunc i64 %42 to i32
  %.1.1 = select i1 %47, i32 %tmp25, i32 %.1
  %48 = add nuw nsw i64 %indvars.iv, 2
  %49 = add i64 %37, 2
  %tmp = trunc i64 %49 to i32
  %50 = sext i32 %tmp to i64
  %51 = getelementptr float, float* %31, i64 %50
  %52 = load float, float* %51, align 4
  %53 = fcmp reassoc ninf nsz ogt float %52, %.111.1
  %.111.2 = select i1 %53, float %52, float %.111.1
  %tmp23 = trunc i64 %48 to i32
  %.1.2 = select i1 %53, i32 %tmp23, i32 %.1.1
  %54 = add nuw nsw i64 %indvars.iv, 3
  %55 = add i64 %37, 3
  %tmp26 = trunc i64 %55 to i32
  %56 = sext i32 %tmp26 to i64
  %57 = getelementptr float, float* %31, i64 %56
  %58 = load float, float* %57, align 4
  %59 = fcmp reassoc ninf nsz ogt float %58, %.111.2
  %.111.3 = select i1 %59, float %58, float %.111.2
  %tmp27 = trunc i64 %54 to i32
  %.1.3 = select i1 %59, i32 %tmp27, i32 %.1.2
...
after_for3.loopexit.unr-lcssa:                    ; preds = %after_for3.loopexit.unr-lcssa.loopexit, %for_loop_body1.lr.ph
  %.111.lcssa.ph = phi float [ undef, %for_loop_body1.lr.ph ], [ %.111.3, %after_for3.loopexit.unr-lcssa.loopexit ]
  %.1.lcssa.ph = phi i32 [ undef, %for_loop_body1.lr.ph ], [ %.1.3, %after_for3.loopexit.unr-lcssa.loopexit ]
...
for_loop_body1.epil.preheader:                    ; preds = %after_for3.loopexit.unr-lcssa
  %60 = trunc i64 %indvars.iv.unr to i32
  %61 = mul i32 %32, %.01218
...
for_loop_body1.epil:                              ; preds = %for_loop_body1.epil, %for_loop_body1.epil.preheader
  ...
  %lsr.iv = phi i32 [ %60, %for_loop_body1.epil.preheader ], [ %lsr.iv.next, %for_loop_body1.epil ]
  ...
  %62 = add i32 %61, %lsr.iv
  %63 = sext i32 %62 to i64
  %64 = getelementptr float, float* %31, i64 %63
  %65 = load float, float* %64, align 4
  %66 = fcmp reassoc ninf nsz ogt float %65, %.01014.epil
  %.111.epil = select i1 %66, float %65, float %.01014.epil
  %.1.epil = select i1 %66, i32 %lsr.iv, i32 %.0915.epil
  %lsr.iv.next = add i32 %lsr.iv, 1
  %lsr.iv.next31 = add nsw i64 %lsr.iv30, -1
  %epil.iter.cmp.not = icmp eq i64 %lsr.iv.next31, 0
  br i1 %epil.iter.cmp.not, label %after_for3.loopexit, label %for_loop_body1.epil, !llvm.loop !9
...
after_for3:                                       ; preds = %after_for3.loopexit, %after_for3.loopexit.unr-lcssa, %for_loop_body
  %.010.lcssa = phi float [ -1.000000e+10, %for_loop_body ], [ %.111.lcssa.ph, %after_for3.loopexit.unr-lcssa ], [ %.111.epil, %after_for3.loopexit ]
  %.09.lcssa = phi i32 [ 0, %for_loop_body ], [ %.1.lcssa.ph, %after_for3.loopexit.unr-lcssa ], [ %.1.epil, %after_for3.loopexit ]
  %67 = load float*, float** %25, align 8
  %68 = load i32, i32* %26, align 4
  %69 = mul i32 %68, %.01218
  %70 = sext i32 %69 to i64
  %71 = getelementptr float, float* %67, i64 %70
  store float %.010.lcssa, float* %71, align 4
  %72 = sitofp i32 %.09.lcssa to float
  ...
  %79 = add nsw i32 %.01218, 1
  %exitcond20.not = icmp eq i32 %79, %19
