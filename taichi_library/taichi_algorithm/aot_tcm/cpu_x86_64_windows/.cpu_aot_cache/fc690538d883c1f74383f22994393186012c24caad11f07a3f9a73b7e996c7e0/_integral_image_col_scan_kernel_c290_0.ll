...
define void @_integral_image_col_scan_kernel_c290_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  ...
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %1, i64 0, i32 5
...
define void @_integral_image_col_scan_kernel_c290_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %21 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }** %20, align 8
  %22 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %21, i64 0, i32 4
...
for_loop_test4.preheader.lr.ph:                   ; preds = %allocs
  ...
  %26 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %21, i64 0, i32 0, i32 1
  %27 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %21, i64 0, i32 0, i32 0, i32 1
  %28 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %21, i64 0, i32 1, i32 1
  %29 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %21, i64 0, i32 1, i32 0, i32 1
  %30 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %21, i64 0, i32 2, i32 1
  %31 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %21, i64 0, i32 2, i32 0, i32 1
  %32 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %21, i64 0, i32 3, i32 1
  %33 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %21, i64 0, i32 3, i32 0, i32 1
...
for_loop_test4.preheader.us:                      ; preds = %for_loop_test4.after_for3_crit_edge.us, %for_loop_test4.preheader.us.preheader
  %.01014.us = phi i32 [ %63, %for_loop_test4.after_for3_crit_edge.us ], [ %17, %for_loop_test4.preheader.us.preheader ]
  br label %for_loop_body1.us

for_loop_body1.us:                                ; preds = %for_loop_body1.us, %for_loop_test4.preheader.us
  %.013.us = phi i32 [ 0, %for_loop_test4.preheader.us ], [ %62, %for_loop_body1.us ]
  %.0812.us = phi float [ 0.000000e+00, %for_loop_test4.preheader.us ], [ %49, %for_loop_body1.us ]
  %.0911.us = phi float [ 0.000000e+00, %for_loop_test4.preheader.us ], [ %41, %for_loop_body1.us ]
  %34 = load float*, float** %26, align 8
  %35 = load i32, i32* %27, align 4
  %36 = mul i32 %35, %.013.us
  %37 = add i32 %36, %.01014.us
  %38 = sext i32 %37 to i64
  %39 = getelementptr float, float* %34, i64 %38
  %40 = load float, float* %39, align 4
  %41 = fadd reassoc ninf nsz float %40, %.0911.us
  %42 = load float*, float** %28, align 8
  %43 = load i32, i32* %29, align 4
  %44 = mul i32 %43, %.013.us
  %45 = add i32 %44, %.01014.us
  %46 = sext i32 %45 to i64
  %47 = getelementptr float, float* %42, i64 %46
  %48 = load float, float* %47, align 4
  %49 = fadd reassoc ninf nsz float %48, %.0812.us
  %50 = load float*, float** %30, align 8
  %51 = load i32, i32* %31, align 4
  %52 = mul i32 %51, %.013.us
  %53 = add i32 %52, %.01014.us
  %54 = sext i32 %53 to i64
  %55 = getelementptr float, float* %50, i64 %54
  store float %41, float* %55, align 4
  %56 = load float*, float** %32, align 8
  %57 = load i32, i32* %33, align 4
  %58 = mul i32 %57, %.013.us
  %59 = add i32 %58, %.01014.us
  %60 = sext i32 %59 to i64
  %61 = getelementptr float, float* %56, i64 %60
  store float %49, float* %61, align 4
  %62 = add nuw nsw i32 %.013.us, 1
  %exitcond.not = icmp eq i32 %23, %62
...
for_loop_test4.after_for3_crit_edge.us:           ; preds = %for_loop_body1.us
  %63 = add nsw i32 %.01014.us, 1
  %exitcond16.not = icmp eq i32 %63, %19
