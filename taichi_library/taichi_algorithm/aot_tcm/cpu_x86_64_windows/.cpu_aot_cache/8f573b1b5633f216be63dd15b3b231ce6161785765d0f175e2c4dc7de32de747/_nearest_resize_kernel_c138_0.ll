...
define void @_nearest_resize_kernel_c138_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_nearest_resize_kernel_c138_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %91, %for_loop_body ]
  %35 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %3, align 8
  ...
  %54 = fadd reassoc ninf nsz float %53, 5.000000e-01
  %55 = getelementptr inbounds i8, i8* %37, i64 8
  %56 = bitcast i8* %55 to i32*
  %57 = load i32, i32* %56, align 4
  %58 = sitofp i32 %57 to float
  %59 = fmul reassoc ninf nsz float %54, %26
  %60 = fdiv reassoc ninf nsz float %59, %58
  %61 = sitofp i32 %52 to float
  %62 = fadd reassoc ninf nsz float %61, 5.000000e-01
  %63 = getelementptr inbounds i8, i8* %37, i64 12
  %64 = bitcast i8* %63 to i32*
  %65 = load i32, i32* %64, align 4
  %66 = sitofp i32 %65 to float
  %67 = fmul reassoc ninf nsz float %62, %27
  %68 = fdiv reassoc ninf nsz float %67, %66
  ...
  %73 = tail call i32 @llvm.smax.i32(i32 %70, i32 0)
  %74 = tail call i32 @llvm.smin.i32(i32 %28, i32 %73)
  %75 = tail call i32 @llvm.smax.i32(i32 %72, i32 0)
  %76 = tail call i32 @llvm.smin.i32(i32 %29, i32 %75)
