...
define void @_canny_finalize_kernel_c398_0_kernel_0_serial(%struct.RuntimeContext.48* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_canny_finalize_kernel_c398_0_kernel_1_range_for(%struct.RuntimeContext.48* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.48* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %50 = fcmp reassoc ninf nsz oeq float %49, 2.550000e+02
  ...
  %. = select i1 %50, float 2.550000e+02, float 0.000000e+00
  store float %., float* %57, align 4
  %58 = add nsw i32 %.05, 1
