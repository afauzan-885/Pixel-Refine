...
define void @_canny_threshold_kernel_c394_0_kernel_0_serial(%struct.RuntimeContext.24* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.24* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }**
  %1 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %1, i64 0, i32 4
  %3 = load i32, i32* %2, align 4
  %4 = tail call i32 @llvm.smax.i32(i32 %3, i32 0)
  %5 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %1, i64 0, i32 5
...
define void @_canny_threshold_kernel_c394_0_kernel_1_range_for(%struct.RuntimeContext.24* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.24* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }**
  %21 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }** %20, align 8
  %22 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %21, i64 0, i32 3
  %23 = load float, float* %22, align 4
  %24 = icmp slt i32 %17, %19
  br i1 %24, label %for_loop_body.lr.ph, label %after_for

for_loop_body.lr.ph:                              ; preds = %allocs
  %25 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %21, i64 0, i32 0, i32 1
  %26 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %21, i64 0, i32 0, i32 0, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %73, %after_if ]
  ...
  %48 = getelementptr float, float* %42, i64 %47
  %49 = load float, float* %48, align 4
  %50 = fcmp reassoc ninf nsz ult float %49, %23
  %51 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }** %20, align 8
  br i1 %50, label %false_block, label %true_block
...
true_block:                                       ; preds = %for_loop_body
  %52 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %51, i64 0, i32 1, i32 1
  %53 = load float*, float** %52, align 8
  %54 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %51, i64 0, i32 1, i32 0, i32 1
  %55 = load i32, i32* %54, align 4
  %56 = sub i32 %55, %32
  %57 = mul i32 %56, %41
  %58 = add i32 %.06, %57
  %59 = sext i32 %58 to i64
  %60 = getelementptr float, float* %53, i64 %59
  store float 2.550000e+02, float* %60, align 4
  br label %after_if

false_block:                                      ; preds = %for_loop_body
  %61 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %51, i64 0, i32 2
  %62 = load float, float* %61, align 4
  %63 = fcmp reassoc ninf nsz ult float %49, %62
  %64 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %51, i64 0, i32 1, i32 1
  %65 = load float*, float** %64, align 8
  %66 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, i32, i32 }* %51, i64 0, i32 1, i32 0, i32 1
  ...
  br i1 %63, label %false_block2, label %true_block1
...
true_block1:                                      ; preds = %false_block
  store float 1.280000e+02, float* %72, align 4
  br label %after_if
