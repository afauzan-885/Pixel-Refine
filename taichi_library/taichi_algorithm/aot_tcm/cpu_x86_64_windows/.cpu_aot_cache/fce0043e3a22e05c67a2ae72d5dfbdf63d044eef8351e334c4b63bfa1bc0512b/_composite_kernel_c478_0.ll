...
define void @_composite_kernel_c478_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_composite_kernel_c478_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %72, %after_if ]
  ...
  %43 = fcmp reassoc ninf nsz ogt float %42, 5.000000e-01
  br i1 %43, label %true_block, label %after_if
...
true_block:                                       ; preds = %for_loop_body
  ...
  %53 = getelementptr float, ptr %46, i64 %52
  %54 = load float, ptr %53, align 4
  %55 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %54, float 0.000000e+00)
  %56 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %55, float 2.550000e+02)
  %57 = getelementptr i8, ptr %44, i64 64
  %58 = load i32, ptr %57, align 4
  %59 = getelementptr i8, ptr %44, i64 32
  %60 = load ptr, ptr %59, align 8
  %61 = getelementptr i8, ptr %44, i64 20
  %62 = load i32, ptr %61, align 4
  %63 = getelementptr i8, ptr %44, i64 24
  ...
  %71 = getelementptr float, ptr %60, i64 %70
  store float %56, ptr %71, align 4
  br label %after_if

after_if:                                         ; preds = %true_block, %for_loop_body
  %72 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %18, %72
