...
define void @_compute_laplacian_c474_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_compute_laplacian_c474_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.07 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %92, %for_loop_body ]
  ...
  %46 = add i32 %45, -1
  %47 = tail call i32 @llvm.smax.i32(i32 %43, i32 0)
  ...
  %66 = getelementptr float, ptr %55, i64 %65
  ...
  %80 = getelementptr float, ptr %68, i64 %79
  %81 = load float, ptr %80, align 4
  %82 = fadd reassoc ninf nsz float %63, %75
  %83 = fadd reassoc ninf nsz float %67, %81
