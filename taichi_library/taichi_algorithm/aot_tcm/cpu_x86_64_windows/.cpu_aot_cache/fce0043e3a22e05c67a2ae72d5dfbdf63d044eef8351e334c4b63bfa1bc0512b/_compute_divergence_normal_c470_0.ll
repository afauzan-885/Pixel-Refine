...
define void @_compute_divergence_normal_c470_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_compute_divergence_normal_c470_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %103, %for_loop_body ]
  ...
  %55 = add i32 %54, -1
  %56 = tail call i32 @llvm.smax.i32(i32 %52, i32 0)
  ...
  %66 = getelementptr float, ptr %58, i64 %65
  ...
  %74 = getelementptr float, ptr %58, i64 %73
  %75 = load float, ptr %74, align 4
  %76 = fsub reassoc ninf nsz float %67, %75
  ...
  %95 = fsub reassoc ninf nsz float %94, %75
