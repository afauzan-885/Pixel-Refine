...
define void @_box_blur_h_vec3_f32_kernel_c170_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_box_blur_h_vec3_f32_kernel_c170_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_for3, %for_loop_body.lr.ph
  %.01523 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %120, %after_for3 ]
...
for_loop_body1.preheader:                         ; preds = %middle.block, %for_loop_body1.lr.ph
  ...
  %53 = sub i32 %26, %.020.ph
  %54 = add i32 %.020.ph, %.01523
  %55 = sub i32 %54, %45
  br label %for_loop_body1

vector.ph:                                        ; preds = %for_loop_body1.lr.ph
  %broadcast.splatinsert = insertelement <8 x i32> poison, i32 %46, i64 0
  ...
  %broadcast.splatinsert35 = insertelement <8 x i32> poison, i32 %52, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %56 = add <8 x i32> %vec.ind, %broadcast.splat
  %57 = tail call <8 x i32> @llvm.smax.v8i32(<8 x i32> %56, <8 x i32> zeroinitializer)
  %58 = tail call <8 x i32> @llvm.smin.v8i32(<8 x i32> %broadcast.splat34, <8 x i32> %57)
  %59 = add <8 x i32> %broadcast.splat36, %58
  ...
  %wide.masked.gather37 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %65, i32 4, <8 x i1> splat (i1 true), <8 x float> poison)
  %66 = add <8 x i32> %60, splat (i32 2)
  %67 = sext <8 x i32> %66 to <8 x i64>
  %68 = getelementptr float, ptr %50, <8 x i64> %67
  %wide.masked.gather38 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %68, i32 4, <8 x i1> splat (i1 true), <8 x float> poison)
  %69 = fadd reassoc ninf nsz <8 x float> %wide.masked.gather, %vec.phi32
  %70 = fadd reassoc ninf nsz <8 x float> %wide.masked.gather37, %vec.phi31
  %71 = fadd reassoc ninf nsz <8 x float> %wide.masked.gather38, %vec.phi
...
for_loop_body1:                                   ; preds = %for_loop_body1, %for_loop_body1.preheader
  %lsr.iv53 = phi i32 [ %55, %for_loop_body1.preheader ], [ %lsr.iv.next54, %for_loop_body1 ]
  %lsr.iv51 = phi i32 [ %53, %for_loop_body1.preheader ], [ %lsr.iv.next52, %for_loop_body1 ]
  %.01219 = phi float [ %93, %for_loop_body1 ], [ %.01219.ph, %for_loop_body1.preheader ]
  %.01318 = phi float [ %92, %for_loop_body1 ], [ %.01318.ph, %for_loop_body1.preheader ]
  %.01417 = phi float [ %91, %for_loop_body1 ], [ %.01417.ph, %for_loop_body1.preheader ]
  %76 = tail call i32 @llvm.smax.i32(i32 %lsr.iv53, i32 0)
  ...
  %85 = getelementptr float, ptr %50, i64 %84
  %86 = load float, ptr %85, align 4
  %87 = add i32 %79, 2
  %88 = sext i32 %87 to i64
  %89 = getelementptr float, ptr %50, i64 %88
  %90 = load float, ptr %89, align 4
  %91 = fadd reassoc ninf nsz float %82, %.01417
  %92 = fadd reassoc ninf nsz float %86, %.01318
  %93 = fadd reassoc ninf nsz float %90, %.01219
  %lsr.iv.next52 = add i32 %lsr.iv51, -1
  %lsr.iv.next54 = add i32 %lsr.iv53, 1
  %exitcond.not = icmp eq i32 %lsr.iv.next52, 0
...
after_for3:                                       ; preds = %after_for3.loopexit, %for_loop_body
  %.014.lcssa = phi float [ 0.000000e+00, %for_loop_body ], [ %91, %after_for3.loopexit ]
  %.013.lcssa = phi float [ 0.000000e+00, %for_loop_body ], [ %92, %after_for3.loopexit ]
  %.012.lcssa = phi float [ 0.000000e+00, %for_loop_body ], [ %93, %after_for3.loopexit ]
  %94 = fdiv reassoc ninf nsz float %.014.lcssa, %24
  %95 = fdiv reassoc ninf nsz float %.013.lcssa, %24
  %96 = fdiv reassoc ninf nsz float %.012.lcssa, %24
  ...
  %119 = getelementptr float, ptr %112, i64 %118
  store float %96, ptr %119, align 4
  %120 = add nsw i32 %.01523, 1
  %exitcond26.not = icmp eq i32 %120, %18
