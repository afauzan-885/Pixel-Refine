...
define void @_remap_with_flow_kernel_c318_1_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_remap_with_flow_kernel_c318_1_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %258, %for_loop_body ]
  ...
  %221 = getelementptr i32, ptr %216, i64 %220
  %222 = load i32, ptr %221, align 4
  %223 = add i32 %218, %207
  %224 = sext i32 %223 to i64
  %225 = getelementptr i32, ptr %216, i64 %224
  %226 = load i32, ptr %225, align 4
  %227 = mul i32 %215, %217
  %228 = add i32 %227, %192
  %229 = sext i32 %228 to i64
  %230 = getelementptr i32, ptr %216, i64 %229
  %231 = load i32, ptr %230, align 4
  %232 = add i32 %227, %207
  %233 = sext i32 %232 to i64
  %234 = getelementptr i32, ptr %216, i64 %233
  %235 = load i32, ptr %234, align 4
  %236 = fsub reassoc ninf nsz float 1.000000e+00, %183
  %237 = sitofp i32 %222 to float
  %238 = fmul reassoc ninf nsz float %236, %237
  %239 = sitofp i32 %226 to float
  %240 = fmul reassoc ninf nsz float %183, %239
  %241 = fadd reassoc ninf nsz float %238, %240
  %242 = sitofp i32 %231 to float
  %243 = fmul reassoc ninf nsz float %236, %242
  %244 = sitofp i32 %235 to float
  %245 = fmul reassoc ninf nsz float %183, %244
  %246 = fadd reassoc ninf nsz float %243, %245
  %247 = fsub reassoc ninf nsz float %246, %241
  %248 = fmul reassoc ninf nsz float %247, %185
  %249 = fadd reassoc ninf nsz float %248, %241
  ...
  %257 = fptosi float %249 to i32
  store i32 %257, ptr %256, align 4
  %258 = add nsw i32 %.06, 1
  %exitcond.not = icmp eq i32 %18, %258
