...
define void @_remap_kernel_c312_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_remap_kernel_c312_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %138, %for_loop_body ]
  ...
  %63 = tail call reassoc ninf nsz float @llvm.floor.f32(float %54)
  %64 = fptosi float %63 to i32
  %65 = tail call reassoc ninf nsz float @llvm.floor.f32(float %62)
  %66 = fptosi float %65 to i32
  %67 = sitofp i32 %64 to float
  %68 = fsub reassoc ninf nsz float %54, %67
  %69 = sitofp i32 %66 to float
  %70 = fsub reassoc ninf nsz float %62, %69
  %71 = tail call i32 @llvm.abs.i32(i32 %64, i1 true)
  %72 = sub i32 %71, %24
  %73 = tail call i32 @llvm.smax.i32(i32 %72, i32 0)
  %74 = shl nuw i32 %73, 1
  %75 = sub i32 %71, %74
  %76 = tail call i32 @llvm.smax.i32(i32 %75, i32 0)
  %77 = tail call i32 @llvm.smin.i32(i32 %24, i32 %76)
  %78 = tail call i32 @llvm.abs.i32(i32 %66, i1 true)
  %79 = sub i32 %78, %25
  %80 = tail call i32 @llvm.smax.i32(i32 %79, i32 0)
  %81 = shl nuw i32 %80, 1
  %82 = sub i32 %78, %81
  %83 = tail call i32 @llvm.smax.i32(i32 %82, i32 0)
  %84 = tail call i32 @llvm.smin.i32(i32 %25, i32 %83)
  %85 = add i32 %64, 1
  ...
  %92 = tail call i32 @llvm.smin.i32(i32 %24, i32 %91)
  %93 = add i32 %66, 1
  ...
  %100 = tail call i32 @llvm.smin.i32(i32 %25, i32 %99)
  ...
  %119 = getelementptr float, ptr %101, i64 %118
  %120 = load float, ptr %119, align 4
  %121 = fsub reassoc ninf nsz float 1.000000e+00, %68
  %122 = fmul reassoc ninf nsz float %107, %121
  %123 = fmul reassoc ninf nsz float %111, %68
  %124 = fadd reassoc ninf nsz float %123, %122
  %125 = fmul reassoc ninf nsz float %116, %121
  %126 = fmul reassoc ninf nsz float %120, %68
  %127 = fsub reassoc ninf nsz float %125, %124
  %128 = fadd reassoc ninf nsz float %127, %126
  %129 = fmul reassoc ninf nsz float %128, %70
  %130 = fadd reassoc ninf nsz float %129, %124
  ...
  %137 = getelementptr float, ptr %131, i64 %136
  store float %130, ptr %137, align 4
  %138 = add nsw i32 %.06, 1
  %exitcond.not = icmp eq i32 %18, %138
