...
define void @_inter_area_1ch_kernel_c678_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  ...
  %16 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %4, align 8
  ...
  %24 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %4, align 8
  ...
  %43 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %4, align 8
  ...
  %51 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %4, align 8
...
define void @_inter_area_1ch_kernel_c678_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.6* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }**
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %92 = add nsw <8 x i32> %vec.ind, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  ...
  %102 = getelementptr float, float* %.pre, <8 x i64> %101
  %wide.masked.gather = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> %102, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
  ...
  %108 = add <8 x i32> %vec.ind, <i32 9, i32 9, i32 9, i32 9, i32 9, i32 9, i32 9, i32 9>
  ...
  %118 = getelementptr float, float* %.pre, <8 x i64> %117
  %wide.masked.gather.1 = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> %118, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  ...
  %124 = add nsw <8 x i32> %vec.ind.unr, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  ...
  %134 = getelementptr float, float* %.pre, <8 x i64> %133
  %wide.masked.gather.epil = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> %134, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
