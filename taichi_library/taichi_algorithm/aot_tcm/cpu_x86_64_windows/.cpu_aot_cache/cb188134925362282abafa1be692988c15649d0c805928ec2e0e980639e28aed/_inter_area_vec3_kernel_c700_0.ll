...
define void @_inter_area_vec3_kernel_c680_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  ...
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }* %1, i64 0, i32 3
  ...
  %16 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %4, align 8
  %17 = getelementptr inbounds %struct.LLVMRuntime, %struct.LLVMRuntime* %16, i64 0, i32 14
  %18 = load i8*, i8** %17, align 8
  %19 = getelementptr inbounds i8, i8* %18, i64 12
  %20 = bitcast i8* %19 to float*
  store float %15, float* %20, align 4
  %21 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }** %0, align 8
  ...
  %24 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %4, align 8
  ...
  %30 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }** %0, align 8
  %31 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }* %30, i64 0, i32 4
  %32 = load i32, i32* %31, align 4
  %33 = sitofp i32 %32 to float
  %34 = fdiv reassoc ninf nsz float %29, %33
  %35 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %4, align 8
  ...
  %40 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }** %0, align 8
  %41 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }* %40, i64 0, i32 1, i32 0, i32 0
  %42 = load i32, i32* %41, align 4
  %43 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %4, align 8
  %44 = getelementptr inbounds %struct.LLVMRuntime, %struct.LLVMRuntime* %43, i64 0, i32 14
  %45 = load i8*, i8** %44, align 8
  %46 = getelementptr inbounds i8, i8* %45, i64 8
  %47 = bitcast i8* %46 to i32*
  store i32 %42, i32* %47, align 4
  %48 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }** %0, align 8
  %49 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }* %48, i64 0, i32 1, i32 0, i32 1
  %50 = load i32, i32* %49, align 4
  %51 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %4, align 8
  %52 = getelementptr inbounds %struct.LLVMRuntime, %struct.LLVMRuntime* %51, i64 0, i32 14
...
define void @_inter_area_vec3_kernel_c680_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }**
  %22 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }** %21, align 8
  %23 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }* %22, i64 0, i32 0, i32 1
  %24 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }* %22, i64 0, i32 0, i32 0, i32 1
  %25 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }* %22, i64 0, i32 1, i32 1
  %26 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, i32, i32 }* %22, i64 0, i32 1, i32 0, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %after_for3, %for_loop_body.lr.ph
  %.02543 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %177, %after_for3 ]
  %27 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %3, align 8
  %28 = getelementptr inbounds %struct.LLVMRuntime, %struct.LLVMRuntime* %27, i64 0, i32 14
  ...
  %63 = getelementptr inbounds i8, i8* %29, i64 20
  %64 = bitcast i8* %63 to i32*
  %65 = load i32, i32* %64, align 4
  %66 = add i32 %65, -1
  %67 = getelementptr inbounds i8, i8* %29, i64 24
...
for_loop_body1.us.preheader:                      ; preds = %for_loop_body
  %.pre = load float*, float** %23, align 8
  %.pre53 = load i32, i32* %24, align 4
  %73 = sub i32 %62, %60
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %90 = add nsw <8 x i32> %vec.ind, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  ...
  %99 = mul <8 x i32> %98, <i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3>
  %100 = sext <8 x i32> %99 to <8 x i64>
  %101 = getelementptr float, float* %.pre, <8 x i64> %100
  %wide.masked.gather = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> %101, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
  %102 = add <8 x i32> %99, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %103 = sext <8 x i32> %102 to <8 x i64>
  %104 = getelementptr float, float* %.pre, <8 x i64> %103
  %wide.masked.gather71 = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> %104, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
  %105 = add <8 x i32> %99, <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
  %106 = sext <8 x i32> %105 to <8 x i64>
  %107 = getelementptr float, float* %.pre, <8 x i64> %106
  %wide.masked.gather72 = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> %107, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
...
for_loop_body5.us:                                ; preds = %for_loop_body5.us, %for_loop_body5.us.preheader
  ...
  %133 = getelementptr float, float* %.pre, i64 %132
  %134 = load float, float* %133, align 4
  %135 = add i32 %131, 1
  %136 = sext i32 %135 to i64
  %137 = getelementptr float, float* %.pre, i64 %136
  %138 = load float, float* %137, align 4
  %139 = add i32 %131, 2
  %140 = sext i32 %139 to i64
  %141 = getelementptr float, float* %.pre, i64 %140
...
after_for3:                                       ; preds = %after_for3.loopexit, %for_loop_body
  ...
  store float %151, float* %160, align 4
  ...
  store float %153, float* %176, align 4
