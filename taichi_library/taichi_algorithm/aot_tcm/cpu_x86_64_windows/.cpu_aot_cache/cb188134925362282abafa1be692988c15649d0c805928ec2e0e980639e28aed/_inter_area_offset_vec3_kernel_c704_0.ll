...
define void @_inter_area_offset_vec3_kernel_c684_0_kernel_0_serial(%struct.RuntimeContext.36* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  ...
  %16 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %4, align 8
  ...
  %24 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %4, align 8
  ...
  %35 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %4, align 8
  ...
  %47 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %4, align 8
  ...
  %52 = mul i32 %46, %43
  %53 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %4, align 8
...
define void @_inter_area_offset_vec3_kernel_c684_0_kernel_1_range_for(%struct.RuntimeContext.36* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %96 = add nsw <8 x i32> %vec.ind, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  ...
  %107 = mul <8 x i32> %106, <i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3, i32 3>
  %108 = sext <8 x i32> %107 to <8 x i64>
  %109 = getelementptr float, float* %.pre, <8 x i64> %108
  %wide.masked.gather = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> %109, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
  %110 = add <8 x i32> %107, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %111 = sext <8 x i32> %110 to <8 x i64>
  %112 = getelementptr float, float* %.pre, <8 x i64> %111
  %wide.masked.gather72 = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> %112, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
  %113 = add <8 x i32> %107, <i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2>
  %114 = sext <8 x i32> %113 to <8 x i64>
  %115 = getelementptr float, float* %.pre, <8 x i64> %114
  %wide.masked.gather73 = call <8 x float> @llvm.masked.gather.v8f32.v8p0f32(<8 x float*> %115, i32 4, <8 x i1> <i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true, i1 true>, <8 x float> undef)
...
for_loop_body5.us:                                ; preds = %for_loop_body5.us, %for_loop_body5.us.preheader
  ...
  %145 = getelementptr float, float* %.pre, i64 %144
  %146 = load float, float* %145, align 4
  %147 = add i32 %139, 2
  %148 = sext i32 %147 to i64
  %149 = getelementptr float, float* %.pre, i64 %148
...
after_for3:                                       ; preds = %after_for3.loopexit, %for_loop_body
  ...
  store float %159, float* %168, align 4
  %169 = load float*, float** %28, align 8
  ...
  store float %160, float* %176, align 4
  ...
  %184 = getelementptr float, float* %177, i64 %183
  store float %161, float* %184, align 4
