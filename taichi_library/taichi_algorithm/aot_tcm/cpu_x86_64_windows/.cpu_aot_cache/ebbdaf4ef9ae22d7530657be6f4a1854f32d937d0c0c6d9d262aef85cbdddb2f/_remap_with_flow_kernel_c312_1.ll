...
define void @_remap_with_flow_kernel_c312_1_kernel_0_serial(%struct.RuntimeContext.108* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.108* %context to { { { i32, i32 }, i32* }, { { i32, i32, i32 }, float* }, { { i32, i32 }, i32* }, i32, i32, i32, i32, i32, i32, float, float }**
...
define void @_remap_with_flow_kernel_c312_1_kernel_1_range_for(%struct.RuntimeContext.108* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.108* %0 to { { { i32, i32 }, i32* }, { { i32, i32, i32 }, float* }, { { i32, i32 }, i32* }, i32, i32, i32, i32, i32, i32, float, float }**
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %35 = getelementptr { { { i32, i32 }, i32* }, { { i32, i32, i32 }, float* }, { { i32, i32 }, i32* }, i32, i32, i32, i32, i32, i32, float, float }, { { { i32, i32 }, i32* }, { { i32, i32, i32 }, float* }, { { i32, i32 }, i32* }, i32, i32, i32, i32, i32, i32, float, float }* %21, i64 0, i32 3
  %36 = load i32, i32* %35, align 4
  %37 = add i32 %36, -1
  %38 = getelementptr { { { i32, i32 }, i32* }, { { i32, i32, i32 }, float* }, { { i32, i32 }, i32* }, i32, i32, i32, i32, i32, i32, float, float }, { { { i32, i32 }, i32* }, { { i32, i32, i32 }, float* }, { { i32, i32 }, i32* }, i32, i32, i32, i32, i32, i32, float, float }* %21, i64 0, i32 4
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.014 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %253, %for_loop_body ]
  %56 = load %struct.LLVMRuntime.107*, %struct.LLVMRuntime.107** %3, align 8
  %57 = getelementptr inbounds %struct.LLVMRuntime.107, %struct.LLVMRuntime.107* %56, i64 0, i32 14
  ...
  %217 = getelementptr i32, i32* %191, i64 %216
  %218 = load i32, i32* %217, align 4
  %219 = extractelement <4 x i32> %214, i64 1
  %220 = sext i32 %219 to i64
  %221 = getelementptr i32, i32* %191, i64 %220
  %222 = load i32, i32* %221, align 4
  %223 = extractelement <4 x i32> %214, i64 2
  %224 = sext i32 %223 to i64
  %225 = getelementptr i32, i32* %191, i64 %224
  %226 = load i32, i32* %225, align 4
  %227 = extractelement <4 x i32> %214, i64 3
  %228 = sext i32 %227 to i64
  %229 = getelementptr i32, i32* %191, i64 %228
  %230 = load i32, i32* %229, align 4
  %231 = fsub reassoc ninf nsz float 1.000000e+00, %186
  %232 = sitofp i32 %218 to float
  %233 = fmul reassoc ninf nsz float %231, %232
  %234 = sitofp i32 %222 to float
  %235 = fmul reassoc ninf nsz float %186, %234
  %236 = fadd reassoc ninf nsz float %233, %235
  %237 = sitofp i32 %226 to float
  %238 = fmul reassoc ninf nsz float %231, %237
  %239 = sitofp i32 %230 to float
  %240 = fmul reassoc ninf nsz float %186, %239
  %241 = fadd reassoc ninf nsz float %238, %240
  %242 = fsub reassoc ninf nsz float %241, %236
  %243 = fmul reassoc ninf nsz float %242, %188
  %244 = fadd reassoc ninf nsz float %243, %236
  %245 = load i32*, i32** %46, align 8
  ...
  %252 = fptosi float %244 to i32
  store i32 %252, i32* %251, align 4
  %253 = add nsw i32 %.014, 1
  %exitcond.not = icmp eq i32 %19, %253
