...
%struct.RuntimeContext.69 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_extract_channel_kernel_c704_5_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_extract_channel_kernel_c704_5_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %52, %for_loop_body ]
  ...
  %44 = getelementptr half, ptr %37, i64 %43
  ...
  store half %45, ptr %51, align 2
  %52 = add nsw i32 %.04, 1
  %exitcond.not = icmp eq i32 %18, %52
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.69, align 8
