...
%struct.RuntimeContext.131 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_pad_constant_kernel_3d_vector_c560_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_pad_constant_kernel_3d_vector_c560_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if9, %for_loop_body.preheader
  %.0815 = phi i32 [ %86, %after_if9 ], [ %16, %for_loop_body.preheader ]
  ...
  br i1 %40, label %true_block, label %false_block8
...
true_block:                                       ; preds = %for_loop_body
  ...
  br i1 %42, label %true_block1, label %false_block8

true_block1:                                      ; preds = %true_block
  %43 = icmp sgt i32 %36, -1
  %44 = icmp slt i32 %36, %39
  %spec.select = select i1 %43, i1 %44, i1 false
...
true_block7:                                      ; preds = %true_block1
  ...
  %54 = getelementptr float, ptr %46, i64 %53
  %55 = add i32 %49, 2
...
false_block8:                                     ; preds = %true_block1, %true_block, %for_loop_body
  %58 = getelementptr i8, ptr %37, i64 40
  %59 = getelementptr i8, ptr %37, i64 44
  %60 = getelementptr i8, ptr %37, i64 48
  br label %after_if9

after_if9:                                        ; preds = %false_block8, %true_block7
  %.sink37.in = phi ptr [ %58, %false_block8 ], [ %51, %true_block7 ]
  %.sink26.in = phi ptr [ %59, %false_block8 ], [ %54, %true_block7 ]
  %.sink.in = phi ptr [ %60, %false_block8 ], [ %57, %true_block7 ]
  %.sink = load float, ptr %.sink.in, align 4
  %.sink26 = load float, ptr %.sink26.in, align 4
  %.sink37 = load float, ptr %.sink37.in, align 4
  %61 = getelementptr i8, ptr %37, i64 24
  %62 = load ptr, ptr %61, align 8
  %63 = getelementptr i8, ptr %37, i64 20
  ...
  store float %.sink37, ptr %69, align 4
  ...
  %77 = getelementptr float, ptr %70, i64 %76
  store float %.sink26, ptr %77, align 4
  ...
  %86 = add nsw i32 %.0815, 1
  %exitcond.not = icmp eq i32 %18, %86
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.131, align 8
