...
define void @_copy_kernel_c698_9_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_copy_kernel_c698_9_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %48, %for_loop_body ]
  ...
  %40 = getelementptr half, ptr %35, i64 %39
  %41 = load half, ptr %40, align 2
  %42 = load ptr, ptr %23, align 8
  %43 = load i32, ptr %24, align 4
  %44 = mul i32 %43, %34
  %45 = add i32 %44, %30
  %46 = sext i32 %45 to i64
  %47 = getelementptr half, ptr %42, i64 %46
  store half %41, ptr %47, align 2
  %48 = add nsw i32 %.04, 1
  %exitcond.not = icmp eq i32 %18, %48
