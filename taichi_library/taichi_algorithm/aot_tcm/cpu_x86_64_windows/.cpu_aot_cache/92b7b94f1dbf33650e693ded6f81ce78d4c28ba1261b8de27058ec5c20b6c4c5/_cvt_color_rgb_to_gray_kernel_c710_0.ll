...
%struct.RuntimeContext.77 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_cvt_color_rgb_to_gray_kernel_c710_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_cvt_color_rgb_to_gray_kernel_c710_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %51 = fmul reassoc ninf nsz float %42, 0x3FD322D0E0000000
  %52 = fmul reassoc ninf nsz float %46, 0x3FE2C8B440000000
  %53 = fadd reassoc ninf nsz float %52, %51
  %54 = fmul reassoc ninf nsz float %50, 0x3FBD2F1AA0000000
  %55 = fadd reassoc ninf nsz float %53, %54
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.77, align 8
