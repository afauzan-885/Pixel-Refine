...
%struct.RuntimeContext.109 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_stitch_tile_f32_kernel_c736_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_stitch_tile_f32_kernel_c736_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %92, %for_loop_body ]
  ...
  %65 = fmul reassoc ninf nsz float %64, %56
  ...
  %74 = fmul reassoc ninf nsz float %73, %65
  ...
  %83 = atomicrmw fadd ptr %82, float %74 seq_cst, align 4
  ...
  %91 = atomicrmw fadd ptr %90, float %65 seq_cst, align 4
  %92 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %18, %92
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.109, align 8
