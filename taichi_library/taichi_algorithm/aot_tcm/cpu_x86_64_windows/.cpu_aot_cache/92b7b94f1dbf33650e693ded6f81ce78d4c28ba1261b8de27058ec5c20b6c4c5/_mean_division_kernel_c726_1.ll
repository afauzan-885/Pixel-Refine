...
%struct.RuntimeContext.99 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_mean_division_kernel_c726_1_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_mean_division_kernel_c726_1_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %106, %after_if ]
...
true_block:                                       ; preds = %for_loop_body
  ...
  %50 = getelementptr float, ptr %43, i64 %49
  ...
  %58 = getelementptr float, ptr %43, i64 %57
  %59 = load float, ptr %58, align 4
  %60 = fdiv reassoc ninf nsz float %51, %39
  %61 = fdiv reassoc ninf nsz float %55, %39
  %62 = fdiv reassoc ninf nsz float %59, %39
  br label %after_if

false_block:                                      ; preds = %for_loop_body
  %63 = getelementptr i8, ptr %41, i64 40
  %64 = load ptr, ptr %63, align 8
  %65 = getelementptr i8, ptr %41, i64 36
  ...
  %79 = getelementptr float, ptr %64, i64 %78
  %80 = load float, ptr %79, align 4
  br label %after_if

after_if:                                         ; preds = %false_block, %true_block
  %.sink27 = phi float [ %72, %false_block ], [ %60, %true_block ]
  %.sink16 = phi float [ %76, %false_block ], [ %61, %true_block ]
  %.sink = phi float [ %80, %false_block ], [ %62, %true_block ]
  %81 = getelementptr i8, ptr %41, i64 56
  %82 = load ptr, ptr %81, align 8
  %83 = getelementptr i8, ptr %41, i64 52
  ...
  store float %.sink27, ptr %89, align 4
  ...
  %97 = getelementptr float, ptr %90, i64 %96
  store float %.sink16, ptr %97, align 4
  ...
  %exitcond.not = icmp eq i32 %18, %106
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.99, align 8
