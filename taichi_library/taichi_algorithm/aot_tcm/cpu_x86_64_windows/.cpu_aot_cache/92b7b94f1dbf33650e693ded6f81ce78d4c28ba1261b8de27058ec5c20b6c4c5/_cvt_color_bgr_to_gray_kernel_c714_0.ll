...
%struct.RuntimeContext.81 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_cvt_color_bgr_to_gray_kernel_c714_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_cvt_color_bgr_to_gray_kernel_c714_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %62, %for_loop_body ]
  ...
  %41 = getelementptr float, ptr %35, i64 %40
  ...
  %49 = getelementptr float, ptr %35, i64 %48
  %50 = load float, ptr %49, align 4
  %51 = fmul reassoc ninf nsz float %50, 0x3FD322D0E0000000
  %52 = fmul reassoc ninf nsz float %46, 0x3FE2C8B440000000
  %53 = fmul reassoc ninf nsz float %42, 0x3FBD2F1AA0000000
  %54 = fadd reassoc ninf nsz float %52, %53
  %55 = fadd reassoc ninf nsz float %54, %51
  %56 = load ptr, ptr %23, align 8
  %57 = load i32, ptr %24, align 4
  %58 = mul i32 %57, %34
  %59 = add i32 %58, %30
  %60 = sext i32 %59 to i64
  %61 = getelementptr float, ptr %56, i64 %60
  store float %55, ptr %61, align 4
  %62 = add nsw i32 %.04, 1
  %exitcond.not = icmp eq i32 %18, %62
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.81, align 8
