...
define void @_rgb_luma_half_c732_0_kernel_0_serial(%struct.RuntimeContext.144* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.144* %context to { { { i32, i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
  ...
  %11 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }* %1, i64 0, i32 3
  ...
  %20 = getelementptr inbounds %struct.RuntimeContext.144, %struct.RuntimeContext.144* %context, i64 0, i32 1
  %21 = load %struct.LLVMRuntime.143*, %struct.LLVMRuntime.143** %20, align 8
  %22 = getelementptr inbounds %struct.LLVMRuntime.143, %struct.LLVMRuntime.143* %21, i64 0, i32 14
  %23 = load i8*, i8** %22, align 8
  %24 = getelementptr inbounds i8, i8* %23, i64 4
  %25 = bitcast i8* %24 to i32*
  store i32 %19, i32* %25, align 4
  %26 = mul i32 %19, %10
  %27 = load %struct.LLVMRuntime.143*, %struct.LLVMRuntime.143** %20, align 8
  %28 = getelementptr inbounds %struct.LLVMRuntime.143, %struct.LLVMRuntime.143* %27, i64 0, i32 14
...
define void @_rgb_luma_half_c732_0_kernel_1_range_for(%struct.RuntimeContext.144* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.144* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %28 = load %struct.LLVMRuntime.143*, %struct.LLVMRuntime.143** %3, align 8
  %29 = getelementptr inbounds %struct.LLVMRuntime.143, %struct.LLVMRuntime.143* %28, i64 0, i32 14
