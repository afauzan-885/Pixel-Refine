...
define void @_dcb_copy_rgb_headroom_c710_0_kernel_0_serial(%struct.RuntimeContext.72* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_dcb_copy_rgb_headroom_c710_0_kernel_1_range_for(%struct.RuntimeContext.72* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %108, %for_loop_body ]
  ...
  store float %54, float* %63, align 4
  ...
  %73 = getelementptr float, float* %64, i64 %72
  %74 = load float, float* %73, align 4
  %75 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %74, float 0.000000e+00)
  ...
  %85 = getelementptr float, float* %76, i64 %84
