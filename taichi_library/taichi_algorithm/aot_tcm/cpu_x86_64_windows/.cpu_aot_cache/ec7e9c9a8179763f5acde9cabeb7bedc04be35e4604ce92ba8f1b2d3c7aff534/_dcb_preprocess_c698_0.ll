...
define void @_dcb_preprocess_c698_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
...
define void @_dcb_preprocess_c698_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
...
for_loop_body:                                    ; preds = %after_if9, %for_loop_body.lr.ph
  %.0918 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %101, %after_if9 ]
...
after_if9:                                        ; preds = %true_block13, %true_block10, %after_if9.fold.split, %for_loop_body
  ...
  %93 = fmul reassoc ninf nsz float %.0, %92
  %94 = load float*, float** %47, align 8
  ...
  store float %93, float* %100, align 4
  %101 = add nsw i32 %.0918, 1
  %exitcond.not = icmp eq i32 %19, %101
