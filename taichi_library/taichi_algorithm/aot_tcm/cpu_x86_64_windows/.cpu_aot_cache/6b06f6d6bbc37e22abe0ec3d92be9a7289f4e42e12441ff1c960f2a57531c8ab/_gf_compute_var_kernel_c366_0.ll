...
define void @_gf_compute_var_kernel_c366_0_kernel_0_serial(%struct.RuntimeContext.24* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_gf_compute_var_kernel_c366_0_kernel_1_range_for(%struct.RuntimeContext.24* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %69, %for_loop_body ]
  ...
  %50 = getelementptr float, float* %44, i64 %49
  ...
  %60 = fmul reassoc ninf nsz float %51, %51
  %61 = fsub reassoc ninf nsz float %59, %60
