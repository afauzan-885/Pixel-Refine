...
define void @_precompute_yuv_c414_0_kernel_0_serial(%struct.RuntimeContext.48* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_precompute_yuv_c414_0_kernel_1_range_for(%struct.RuntimeContext.48* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %96, %for_loop_body ]
  ...
  %62 = fadd reassoc ninf nsz float %57, %53
  %63 = fadd reassoc ninf nsz float %62, %61
  %64 = fmul reassoc ninf nsz float %63, 0x3FD5555560000000
  %65 = load float*, float** %26, align 8
  ...
  %74 = fsub reassoc ninf nsz float %53, %57
  ...
  store float %74, float* %84, align 4
  %85 = fsub reassoc ninf nsz float %61, %57
  ...
  %96 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %19, %96
