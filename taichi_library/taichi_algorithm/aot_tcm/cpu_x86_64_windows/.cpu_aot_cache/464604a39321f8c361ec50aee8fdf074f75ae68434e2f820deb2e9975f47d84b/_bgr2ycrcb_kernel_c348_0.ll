...
define void @_bgr2ycrcb_kernel_c348_0_kernel_0_serial(%struct.RuntimeContext.24* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_bgr2ycrcb_kernel_c348_0_kernel_1_range_for(%struct.RuntimeContext.24* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.24* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.09 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %108, %for_loop_body ]
  %29 = load %struct.LLVMRuntime.23*, %struct.LLVMRuntime.23** %3, align 8
  ...
  %62 = fmul reassoc ninf nsz float %61, 0x3FD322D0E0000000
  %63 = fmul reassoc ninf nsz float %57, 0x3FE2C8B440000000
  %64 = fmul reassoc ninf nsz float %53, 0x3FBD2F1AA0000000
  %65 = fadd reassoc ninf nsz float %63, %64
  %66 = fadd reassoc ninf nsz float %65, %62
  %67 = fmul reassoc ninf nsz float %61, 5.000000e-01
  %.neg5 = fmul reassoc ninf nsz float %53, 0xBFB4D013A0000000
  %.neg6 = fmul reassoc ninf nsz float %57, 0xBFDACBFB20000000
  %.neg7 = fadd reassoc ninf nsz float %.neg5, 1.280000e+02
  %68 = fadd reassoc ninf nsz float %.neg7, %.neg6
  %69 = fadd reassoc ninf nsz float %68, %67
  %70 = fmul reassoc ninf nsz float %61, 0xBFC597F620000000
  %.neg8 = fmul reassoc ninf nsz float %57, 0xBFD53404E0000000
  %71 = fmul reassoc ninf nsz float %53, 5.000000e-01
  %72 = fadd reassoc ninf nsz float %71, 1.280000e+02
  %73 = fadd reassoc ninf nsz float %72, %.neg8
  %74 = fadd reassoc ninf nsz float %73, %70
  %75 = load float*, float** %26, align 8
  ...
  %83 = getelementptr float, float* %75, i64 %82
  store float %66, float* %83, align 4
  %84 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %69, float 0.000000e+00)
  %85 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %84, float 2.550000e+02)
  ...
  %96 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %74, float 0.000000e+00)
  %97 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %96, float 2.550000e+02)
  ...
  %107 = getelementptr float, float* %98, i64 %106
  store float %97, float* %107, align 4
  %108 = add nsw i32 %.09, 1
  %exitcond.not = icmp eq i32 %19, %108
