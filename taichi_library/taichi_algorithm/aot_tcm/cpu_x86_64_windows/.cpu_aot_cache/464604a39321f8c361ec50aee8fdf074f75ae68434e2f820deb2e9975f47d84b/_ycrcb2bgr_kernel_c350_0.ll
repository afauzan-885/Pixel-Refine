...
define void @_ycrcb2bgr_kernel_c350_0_kernel_0_serial(%struct.RuntimeContext.36* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_ycrcb2bgr_kernel_c350_0_kernel_1_range_for(%struct.RuntimeContext.36* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.36* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.08 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %104, %for_loop_body ]
  ...
  %58 = fadd reassoc ninf nsz float %57, -1.280000e+02
  %59 = add i32 %50, 2
  %60 = sext i32 %59 to i64
  %61 = getelementptr float, float* %44, i64 %60
  %62 = load float, float* %61, align 4
  %63 = fadd reassoc ninf nsz float %62, -1.280000e+02
  %64 = fmul reassoc ninf nsz float %58, 0x3FF66E9780000000
  %65 = fadd reassoc ninf nsz float %64, %53
  %.neg5 = fmul reassoc ninf nsz float %58, 0xBFE6D9E840000000
  %.neg6 = fmul reassoc ninf nsz float %63, 0xBFD605BC00000000
  %.neg7 = fadd reassoc ninf nsz float %.neg5, %53
  %66 = fadd reassoc ninf nsz float %.neg7, %.neg6
  %67 = fmul reassoc ninf nsz float %63, 0x3FFC5A1CA0000000
  %68 = fadd reassoc ninf nsz float %67, %53
  %69 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %68, float 0.000000e+00)
  %70 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %69, float 2.550000e+02)
  ...
  %79 = getelementptr float, float* %71, i64 %78
  store float %70, float* %79, align 4
  %80 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %66, float 0.000000e+00)
  %81 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %80, float 2.550000e+02)
  %82 = load float*, float** %26, align 8
  ...
  store float %81, float* %91, align 4
  %92 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %65, float 0.000000e+00)
  %93 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %92, float 2.550000e+02)
  %94 = load float*, float** %26, align 8
