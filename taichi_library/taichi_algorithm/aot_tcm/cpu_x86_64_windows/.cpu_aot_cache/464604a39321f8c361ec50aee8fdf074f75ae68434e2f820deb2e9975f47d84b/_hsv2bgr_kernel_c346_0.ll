...
define void @_hsv2bgr_kernel_c346_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext* %context to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, i32, i32 }**
...
define void @_hsv2bgr_kernel_c346_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.0814 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %107, %after_if ]
  ...
  %58 = fmul reassoc ninf nsz float %57, 0x3F70101020000000
  %59 = add i32 %50, 2
  %60 = sext i32 %59 to i64
  %61 = getelementptr float, float* %44, i64 %60
  %62 = load float, float* %61, align 4
  %63 = fmul reassoc ninf nsz float %58, %62
  %64 = fmul reassoc ninf nsz float %53, 0x3FA1111120000000
  %65 = fmul reassoc ninf nsz float %53, 0x3F91111120000000
  %66 = tail call reassoc ninf nsz float @llvm.floor.f32(float %65)
  %factor = fmul reassoc ninf nsz float %66, -2.000000e+00
  %67 = fadd reassoc ninf nsz float %64, -1.000000e+00
  %68 = fadd reassoc ninf nsz float %67, %factor
  %69 = tail call float @llvm.fabs.f32(float %68)
  %70 = fsub reassoc ninf nsz float 1.000000e+00, %69
  %71 = fmul reassoc ninf nsz float %70, %63
  %72 = fsub reassoc ninf nsz float %62, %63
  %73 = fcmp reassoc ninf nsz olt float %64, 1.000000e+00
  br i1 %73, label %after_if, label %false_block
...
false_block:                                      ; preds = %for_loop_body
  %74 = fcmp reassoc ninf nsz olt float %64, 2.000000e+00
  br i1 %74, label %after_if, label %false_block2

after_if:                                         ; preds = %false_block8, %false_block5, %false_block2, %false_block, %for_loop_body
  %.07 = phi float [ %63, %for_loop_body ], [ %71, %false_block ], [ 0.000000e+00, %false_block2 ], [ 0.000000e+00, %false_block5 ], [ %., %false_block8 ]
  %.06 = phi float [ %71, %for_loop_body ], [ %63, %false_block ], [ %63, %false_block2 ], [ %71, %false_block5 ], [ 0.000000e+00, %false_block8 ]
  %.0 = phi float [ 0.000000e+00, %for_loop_body ], [ 0.000000e+00, %false_block ], [ %71, %false_block2 ], [ %63, %false_block5 ], [ %.11, %false_block8 ]
  %75 = fadd reassoc ninf nsz float %.0, %72
  %76 = load float*, float** %26, align 8
  ...
  %85 = fadd reassoc ninf nsz float %.06, %72
  %86 = load float*, float** %26, align 8
  ...
  %96 = fadd reassoc ninf nsz float %.07, %72
  %97 = load float*, float** %26, align 8
  %98 = load i32, i32* %27, align 4
  %99 = load i32, i32* %28, align 4
  %100 = sub i32 %98, %34
  %101 = mul i32 %100, %43
  %102 = add i32 %.0814, %101
  %103 = mul i32 %102, %99
  %104 = add i32 %103, 2
  %105 = sext i32 %104 to i64
  %106 = getelementptr float, float* %97, i64 %105
  store float %96, float* %106, align 4
  %107 = add nsw i32 %.0814, 1
  %exitcond.not = icmp eq i32 %19, %107
  br i1 %exitcond.not, label %after_for.loopexit, label %for_loop_body

false_block2:                                     ; preds = %false_block
  %108 = fcmp reassoc ninf nsz olt float %64, 3.000000e+00
  br i1 %108, label %after_if, label %false_block5

false_block5:                                     ; preds = %false_block2
  %109 = fcmp reassoc ninf nsz olt float %64, 4.000000e+00
  br i1 %109, label %after_if, label %false_block8

false_block8:                                     ; preds = %false_block5
  %110 = fcmp reassoc ninf nsz olt float %64, 5.000000e+00
  %. = select i1 %110, float %71, float %63
  %.11 = select i1 %110, float %63, float %71
  br label %after_if
}
