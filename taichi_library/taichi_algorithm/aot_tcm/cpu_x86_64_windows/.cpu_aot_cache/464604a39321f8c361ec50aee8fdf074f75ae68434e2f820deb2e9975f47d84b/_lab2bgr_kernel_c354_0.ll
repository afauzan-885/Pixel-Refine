...
define void @_lab2bgr_kernel_c354_0_kernel_0_serial(%struct.RuntimeContext.60* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_lab2bgr_kernel_c354_0_kernel_1_range_for(%struct.RuntimeContext.60* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.010 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %161, %for_loop_body ]
  ...
  %39 = icmp ne i32 %.010, 0
  %40 = icmp ne i32 %.010, %36
  %41 = and i1 %39, %38
  %42 = and i1 %41, %40
  ...
  %53 = insertelement <2 x i32> %52, i32 %50, i64 1
  %54 = sext <2 x i32> %53 to <2 x i64>
  %55 = insertelement <2 x float*> poison, float* %44, i64 0
  %56 = shufflevector <2 x float*> %55, <2 x float*> poison, <2 x i32> zeroinitializer
  %57 = getelementptr float, <2 x float*> %56, <2 x i64> %54
  %58 = call <2 x float> @llvm.masked.gather.v2f32.v2p0f32(<2 x float*> %57, i32 4, <2 x i1> <i1 true, i1 true>, <2 x float> undef)
  %59 = add i32 %50, 2
  %60 = sext i32 %59 to i64
  %61 = getelementptr float, float* %44, i64 %60
  %62 = load float, float* %61, align 4
  %63 = fmul reassoc ninf nsz <2 x float> %58, <float 0x3F60624DE0000000, float 0x3F6BB1C380000000>
  %64 = shufflevector <2 x float> %63, <2 x float> poison, <2 x i32> <i32 1, i32 undef>
  %65 = insertelement <2 x float> %64, float %62, i64 1
  %66 = fadd reassoc ninf nsz <2 x float> %65, <float 0x3FC1A7B960000000, float poison>
  %67 = fmul reassoc ninf nsz <2 x float> %65, <float poison, float 0xBF747AE140000000>
  %68 = shufflevector <2 x float> %66, <2 x float> %67, <2 x i32> <i32 0, i32 3>
  %69 = fadd reassoc ninf nsz <2 x float> %63, <float 0xBFD0624DE0000000, float 0x3FE8E4CFA0000000>
  %70 = fadd reassoc ninf nsz <2 x float> %69, %68
  %71 = extractelement <2 x float> %66, i64 0
  %72 = fmul reassoc ninf nsz <2 x float> %68, %68
  %73 = fmul reassoc ninf nsz <2 x float> %72, %68
  %74 = extractelement <2 x float> %73, i64 0
  %75 = extractelement <2 x float> %58, i64 1
  %76 = fmul reassoc ninf nsz float %75, 0x3F3C73B120000000
  %77 = fcmp reassoc ninf nsz ogt float %71, 0x3FCA7B9620000000
  %78 = select reassoc ninf nsz i1 %77, float %74, float %76
  %79 = fmul reassoc ninf nsz <2 x float> %70, %70
  %80 = fmul reassoc ninf nsz <2 x float> %79, %70
  %81 = fmul reassoc ninf nsz <2 x float> %70, <float 0x3FC0700A00000000, float 0x3FC0700A00000000>
  %82 = fadd reassoc ninf nsz <2 x float> %81, <float 0xBF92235A80000000, float 0xBF92235A80000000>
  %83 = fcmp reassoc ninf nsz ogt <2 x float> %70, <float 0x3FCA7B9620000000, float 0x3FCA7B9620000000>
  %84 = select <2 x i1> %83, <2 x float> %80, <2 x float> %82
  %.neg7 = fmul reassoc ninf nsz float %78, 0xBFF8981E80000000
  %85 = fmul reassoc ninf nsz <2 x float> %84, <float 0x4008A3BF20000000, float 0x3FE15EBF80000000>
  %86 = extractelement <2 x float> %85, i64 1
  %87 = fsub reassoc ninf nsz float %.neg7, %86
  %88 = extractelement <2 x float> %85, i64 0
  %89 = fadd reassoc ninf nsz float %87, %88
  %90 = fmul reassoc ninf nsz float %78, 0x3FFE0423E0000000
  %91 = fmul reassoc ninf nsz <2 x float> %84, <float 0x3FED7AF280000000, float 0x3FA72AAB80000000>
  %92 = extractelement <2 x float> %91, i64 0
  %93 = fsub reassoc ninf nsz float %90, %92
  %94 = extractelement <2 x float> %91, i64 1
  %95 = fadd reassoc ninf nsz float %93, %94
  %96 = fmul reassoc ninf nsz float %78, 0x3FCA1D8540000000
  %97 = fmul reassoc ninf nsz <2 x float> %84, <float 0x3FAB140E00000000, float 0x3FF26B1040000000>
  %98 = extractelement <2 x float> %97, i64 0
  %99 = fsub reassoc ninf nsz float %98, %96
  %100 = extractelement <2 x float> %97, i64 1
  %101 = fadd reassoc ninf nsz float %99, %100
  %102 = fcmp reassoc ninf nsz ogt float %89, 0x3F69A5C380000000
  %103 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %89, float 0x3DDB7CDFE0000000)
  %104 = tail call float @powf(float noundef %103, float noundef 0x3FDAAAAAA0000000) #1
  %105 = fmul reassoc ninf nsz float %104, 0x3FF0E147A0000000
  %106 = fadd reassoc ninf nsz float %105, 0xBFAC28F5C0000000
  %107 = fmul reassoc ninf nsz float %89, 0x4029D70A40000000
  %108 = select reassoc ninf nsz i1 %102, float %106, float %107
  %109 = fcmp reassoc ninf nsz ogt float %95, 0x3F69A5C380000000
  %110 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %95, float 0x3DDB7CDFE0000000)
  %111 = tail call float @powf(float noundef %110, float noundef 0x3FDAAAAAA0000000) #1
  %112 = fmul reassoc ninf nsz float %111, 0x3FF0E147A0000000
  %113 = fadd reassoc ninf nsz float %112, 0xBFAC28F5C0000000
  %114 = fmul reassoc ninf nsz float %95, 0x4029D70A40000000
  %115 = select reassoc ninf nsz i1 %109, float %113, float %114
  %116 = fcmp reassoc ninf nsz ogt float %101, 0x3F69A5C380000000
  %117 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %101, float 0x3DDB7CDFE0000000)
  %118 = tail call float @powf(float noundef %117, float noundef 0x3FDAAAAAA0000000) #1
  %119 = fmul reassoc ninf nsz float %118, 0x3FF0E147A0000000
  %120 = fadd reassoc ninf nsz float %119, 0xBFAC28F5C0000000
  %121 = fmul reassoc ninf nsz float %101, 0x4029D70A40000000
  %122 = select reassoc ninf nsz i1 %116, float %120, float %121
  %123 = fmul reassoc ninf nsz float %122, 2.550000e+02
  ...
  %135 = fmul reassoc ninf nsz float %115, 2.550000e+02
  ...
  %148 = fmul reassoc ninf nsz float %108, 2.550000e+02
