...
define void @_compute_mean_flow_kernel_c210_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_compute_mean_flow_kernel_c210_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if3, %for_loop_body.preheader
  %.047 = phi i32 [ %76, %after_if3 ], [ %18, %for_loop_body.preheader ]
...
true_block1:                                      ; preds = %true_block
  ...
  %58 = getelementptr float, ptr %49, i64 %57
  %59 = load float, ptr %58, align 4
  %60 = load float, ptr %1, align 4
  %61 = fadd reassoc ninf nsz float %60, %59
  ...
  %73 = fadd reassoc ninf nsz float %72, %71
...
after_if3:                                        ; preds = %true_block1, %true_block, %for_loop_body
  %76 = add nsw i32 %.047, 1
  %exitcond.not = icmp eq i32 %20, %76
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_compute_mean_flow_kernel_c210_0_kernel_2_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = getelementptr inbounds nuw i8, ptr %context, i64 8
  %1 = load ptr, ptr %0, align 8
  %2 = getelementptr inbounds nuw i8, ptr %1, i64 32872
