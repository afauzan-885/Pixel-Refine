...
define void @_count_inliers_kernel_c214_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
  ...
  %52 = icmp ne i32 %49, %47
  %53 = and i1 %51, %52
  %.neg1 = sext i1 %53 to i32
  %54 = add i32 %48, %.neg1
...
define void @_count_inliers_kernel_c214_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if3, %for_loop_body.preheader
  %.047 = phi i32 [ %83, %after_if3 ], [ %16, %for_loop_body.preheader ]
  ...
  %29 = icmp ne i32 %.047, %26
  %30 = and i1 %28, %29
  %.neg6 = sext i1 %30 to i32
  %31 = add i32 %25, %.neg6
  %32 = mul i32 %24, -1
  %33 = mul i32 %32, %31
  %34 = add i32 %.047, %33
  ...
  br i1 %41, label %true_block, label %after_if3
...
true_block:                                       ; preds = %for_loop_body
  ...
  br i1 %44, label %true_block1, label %after_if3
...
true_block1:                                      ; preds = %true_block
  ...
  %56 = getelementptr float, ptr %47, i64 %55
  %57 = load float, ptr %56, align 4
  %58 = getelementptr inbounds nuw i8, ptr %22, i64 20
  %59 = load float, ptr %58, align 4
  %60 = fsub reassoc ninf nsz float %57, %59
  %61 = add i32 %54, 1
  %62 = sext i32 %61 to i64
  %63 = getelementptr float, ptr %47, i64 %62
  %64 = load float, ptr %63, align 4
  %65 = getelementptr inbounds nuw i8, ptr %22, i64 24
  %66 = load float, ptr %65, align 4
  %67 = fsub reassoc ninf nsz float %64, %66
  %68 = fmul reassoc ninf nsz float %60, %60
  %69 = fmul reassoc ninf nsz float %67, %67
  %70 = fadd reassoc ninf nsz float %69, %68
  %71 = getelementptr i8, ptr %45, i64 40
  %72 = load float, ptr %71, align 4
  %73 = fmul reassoc ninf nsz float %72, %72
  %74 = fcmp reassoc ninf nsz olt float %70, %73
  %75 = getelementptr i8, ptr %45, i64 56
  %76 = load ptr, ptr %75, align 8
  %77 = getelementptr i8, ptr %45, i64 52
  %78 = load i32, ptr %77, align 4
  %79 = mul i32 %78, %37
  %80 = add i32 %79, %38
  %81 = sext i32 %80 to i64
  %82 = getelementptr i32, ptr %76, i64 %81
  %.sink = zext i1 %74 to i32
  store i32 %.sink, ptr %82, align 4
  br label %after_if3

after_if3:                                        ; preds = %true_block1, %true_block, %for_loop_body
  %83 = add nsw i32 %.047, 1
  %exitcond.not = icmp eq i32 %18, %83
