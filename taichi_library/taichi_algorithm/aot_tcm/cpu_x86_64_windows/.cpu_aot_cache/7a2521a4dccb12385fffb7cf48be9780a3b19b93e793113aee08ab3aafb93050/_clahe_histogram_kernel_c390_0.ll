...
define void @_clahe_histogram_kernel_c390_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_clahe_histogram_kernel_c390_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.07 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %98, %for_loop_body ]
  ...
  %65 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %64, float 0.000000e+00)
  %66 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %21, float %65)
  %67 = fmul reassoc ninf nsz float %66, %32
  %68 = fdiv reassoc ninf nsz float %67, %21
  %69 = fptosi float %68 to i32
  %70 = tail call i32 @llvm.smin.i32(i32 %69, i32 %33)
  %71 = sdiv i32 %52, %25
  %72 = mul i32 %71, %25
  %73 = xor i32 %52, %25
  %74 = icmp slt i32 %73, 0
  %75 = icmp ne i32 %72, %52
  %76 = and i1 %75, %74
  %.neg5 = sext i1 %76 to i32
  %77 = add i32 %71, %.neg5
  %78 = tail call i32 @llvm.smin.i32(i32 %77, i32 %34)
  %79 = sdiv i32 %56, %29
  %80 = mul i32 %79, %29
  %81 = xor i32 %56, %29
  %82 = icmp slt i32 %81, 0
  %83 = icmp ne i32 %.07, %53
  %84 = icmp ne i32 %56, %80
  %85 = and i1 %83, %82
  %86 = and i1 %84, %85
  %.neg6 = sext i1 %86 to i32
  %87 = add i32 %79, %.neg6
  %88 = tail call i32 @llvm.smin.i32(i32 %87, i32 %35)
  %89 = mul i32 %78, %31
  %90 = add i32 %88, %89
  ...
  %97 = atomicrmw add ptr %96, i32 1 seq_cst, align 4
  %98 = add nsw i32 %.07, 1
