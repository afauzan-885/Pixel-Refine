...
define void @_sobel_kernel_c198_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_sobel_kernel_c198_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.022 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %133, %for_loop_body ]
  ...
  %39 = icmp ne i32 %.022, 0
  %40 = icmp ne i32 %.022, %36
  %41 = and i1 %39, %38
  %42 = and i1 %41, %40
  ...
  %51 = add i32 %50, -1
  %52 = getelementptr inbounds i8, i8* %31, i64 12
  %53 = bitcast i8* %52 to i32*
  %54 = load i32, i32* %53, align 4
  %55 = add i32 %54, -1
  %56 = tail call i32 @llvm.smax.i32(i32 %47, i32 0)
  %57 = tail call i32 @llvm.smin.i32(i32 %51, i32 %56)
  ...
  %69 = tail call i32 @llvm.smin.i32(i32 %51, i32 %68)
  %70 = mul i32 %69, %59
  %71 = insertelement <2 x i32> poison, i32 %46, i64 0
  %72 = shufflevector <2 x i32> %71, <2 x i32> poison, <2 x i32> zeroinitializer
  %73 = add <2 x i32> %72, <i32 1, i32 -1>
  %74 = call <2 x i32> @llvm.smax.v2i32(<2 x i32> %73, <2 x i32> zeroinitializer)
  %75 = insertelement <2 x i32> poison, i32 %55, i64 0
  %76 = shufflevector <2 x i32> %75, <2 x i32> poison, <2 x i32> zeroinitializer
  %77 = call <2 x i32> @llvm.smin.v2i32(<2 x i32> %76, <2 x i32> %74)
  %shuffle = shufflevector <2 x i32> %77, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %78 = extractelement <2 x i32> %77, i64 1
  %79 = add i32 %78, %60
  %80 = sext i32 %79 to i64
  %81 = getelementptr float, float* %58, i64 %80
  %82 = load float, float* %81, align 4
  %83 = insertelement <4 x i32> poison, i32 %60, i64 0
  %84 = insertelement <4 x i32> %83, i32 %66, i64 1
  %85 = insertelement <4 x i32> %84, i32 %66, i64 2
  %86 = insertelement <4 x i32> %85, i32 %70, i64 3
  %87 = add <4 x i32> %shuffle, %86
  %88 = sext <4 x i32> %87 to <4 x i64>
  %89 = extractelement <4 x i64> %88, i64 0
  %90 = getelementptr float, float* %58, i64 %89
  %91 = load float, float* %90, align 4
  %92 = extractelement <4 x i64> %88, i64 1
  %93 = getelementptr float, float* %58, i64 %92
  %94 = load float, float* %93, align 4
  %95 = extractelement <4 x i64> %88, i64 2
  %96 = getelementptr float, float* %58, i64 %95
  %97 = load float, float* %96, align 4
  %98 = extractelement <4 x i64> %88, i64 3
  %99 = getelementptr float, float* %58, i64 %98
  %100 = load float, float* %99, align 4
  %101 = add i32 %.022, %70
  %102 = add i32 %101, %45
  %103 = sext i32 %102 to i64
  %104 = getelementptr float, float* %58, i64 %103
  %105 = load float, float* %104, align 4
  %106 = extractelement <2 x i32> %77, i64 0
  %107 = add i32 %106, %70
  %108 = sext i32 %107 to i64
  %109 = getelementptr float, float* %58, i64 %108
  %110 = load float, float* %109, align 4
  %reass.add = fsub reassoc ninf nsz float %97, %94
  %reass.mul = fmul reassoc ninf nsz float %reass.add, 2.000000e+00
  %111 = fadd reassoc ninf nsz float %82, %100
  %112 = fsub reassoc ninf nsz float %91, %111
  %113 = fadd reassoc ninf nsz float %112, %reass.mul
  %114 = fadd reassoc ninf nsz float %113, %110
  %reass.add20 = fsub reassoc ninf nsz float %105, %65
  %reass.mul21 = fmul reassoc ninf nsz float %reass.add20, 2.000000e+00
  %115 = fadd reassoc ninf nsz float %82, %91
  %116 = fsub reassoc ninf nsz float %100, %115
  %117 = fadd reassoc ninf nsz float %116, %110
  %118 = fadd reassoc ninf nsz float %117, %reass.mul21
  ...
  store float %114, float* %125, align 4
  ...
  %132 = getelementptr float, float* %126, i64 %131
  store float %118, float* %132, align 4
  %133 = add nsw i32 %.022, 1
