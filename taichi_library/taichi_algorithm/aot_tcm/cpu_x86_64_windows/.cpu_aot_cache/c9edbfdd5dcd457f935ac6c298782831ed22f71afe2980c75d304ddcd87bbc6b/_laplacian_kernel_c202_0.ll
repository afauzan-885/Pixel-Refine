...
define void @_laplacian_kernel_c202_0_kernel_0_serial(%struct.RuntimeContext.24* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_laplacian_kernel_c202_0_kernel_1_range_for(%struct.RuntimeContext.24* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %109, %for_loop_body ]
  ...
  %52 = getelementptr float, float* %45, i64 %51
  %53 = load float, float* %52, align 4
  %54 = add i32 %41, -1
  %55 = getelementptr inbounds i8, i8* %29, i64 8
  ...
  %65 = getelementptr float, float* %45, i64 %64
  %66 = load float, float* %65, align 4
  %67 = add i32 %41, 1
  %68 = tail call i32 @llvm.smax.i32(i32 %67, i32 0)
  %69 = tail call i32 @llvm.smin.i32(i32 %58, i32 %68)
  %70 = mul i32 %69, %46
  %71 = add i32 %.06, %70
  %72 = add i32 %71, %43
  ...
  %76 = getelementptr inbounds i8, i8* %29, i64 12
  %77 = bitcast i8* %76 to i32*
  %78 = load i32, i32* %77, align 4
  %79 = add i32 %78, -1
  %80 = insertelement <2 x i32> poison, i32 %44, i64 0
  ...
  %84 = insertelement <2 x i32> poison, i32 %79, i64 0
  %85 = shufflevector <2 x i32> %84, <2 x i32> poison, <2 x i32> zeroinitializer
  %86 = call <2 x i32> @llvm.smin.v2i32(<2 x i32> %85, <2 x i32> %83)
  %87 = insertelement <2 x i32> poison, i32 %47, i64 0
  %88 = shufflevector <2 x i32> %87, <2 x i32> poison, <2 x i32> zeroinitializer
  %89 = add <2 x i32> %86, %88
  %90 = extractelement <2 x i32> %89, i64 0
  %91 = sext i32 %90 to i64
  %92 = getelementptr float, float* %45, i64 %91
  %93 = load float, float* %92, align 4
  %94 = extractelement <2 x i32> %89, i64 1
  %95 = sext i32 %94 to i64
  %96 = getelementptr float, float* %45, i64 %95
  %97 = load float, float* %96, align 4
  %.neg5 = fmul reassoc ninf nsz float %53, -4.000000e+00
  %98 = fadd reassoc ninf nsz float %66, %.neg5
  %99 = fadd reassoc ninf nsz float %98, %75
  %100 = fadd reassoc ninf nsz float %99, %93
  %101 = fadd reassoc ninf nsz float %100, %97
  %102 = load float*, float** %25, align 8
