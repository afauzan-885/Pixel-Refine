...
define void @_update_flow_kernel_c512_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_update_flow_kernel_c512_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %97, %for_loop_body ]
  ...
  %59 = getelementptr float, ptr %39, i64 %58
  %60 = load float, ptr %59, align 4
  %61 = add i32 %45, 4
  %62 = sext i32 %61 to i64
  %63 = getelementptr float, ptr %39, i64 %62
  %64 = load float, ptr %63, align 4
  %65 = fmul reassoc ninf nsz float %56, %48
  %66 = fmul reassoc ninf nsz float %52, %52
  %67 = fsub reassoc ninf nsz float 0x3F50624DE0000000, %66
  %68 = fadd reassoc ninf nsz float %67, %65
  %69 = fdiv reassoc ninf nsz float 1.000000e+00, %68
  %70 = fmul reassoc ninf nsz float %64, %48
  %71 = fmul reassoc ninf nsz float %60, %52
  %72 = fsub reassoc ninf nsz float %70, %71
  %73 = fmul reassoc ninf nsz float %72, %69
  ...
  %82 = getelementptr float, ptr %74, i64 %81
  store float %73, ptr %82, align 4
  %83 = fmul reassoc ninf nsz float %60, %56
  %84 = fmul reassoc ninf nsz float %64, %52
  %85 = fsub reassoc ninf nsz float %83, %84
  %86 = fmul reassoc ninf nsz float %85, %69
