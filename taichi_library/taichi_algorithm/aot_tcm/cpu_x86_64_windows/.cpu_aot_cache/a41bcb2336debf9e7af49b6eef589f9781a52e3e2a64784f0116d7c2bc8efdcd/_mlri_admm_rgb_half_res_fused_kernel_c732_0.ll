...
%0 = type { %struct.RuntimeContext.90*, void (%struct.RuntimeContext.90*, i8*)*, void (%struct.RuntimeContext.90*, i8*, i32)*, void (%struct.RuntimeContext.90*, i8*)*, i64, i32, i32, i32, i32 }
%struct.RuntimeContext.90 = type { i8*, %struct.LLVMRuntime.89*, i32, i64* }
%struct.LLVMRuntime.89 = type { %struct.PreallocatedMemoryChunk.85, %struct.PreallocatedMemoryChunk.85, i8* (i8*, i64, i64)*, void (i8*)*, void (i8*, ...)*, i32 (i8*, i64, i8*, i8*)*, i8*, [512 x i8*], [512 x i64], i8*, void (i8*, i32, i32, i8*, void (i8*, i32, i32)*)*, [1024 x %struct.ListManager.86*], [1024 x %struct.NodeManager.87*], [1024 x i8*], i8*, %struct.RandState.88*, i8*, void (i8*, i8*)*, void (i8*)*, [2048 x i8], [32 x i64], i32, i64, i8*, i32, i32, i64 }
%struct.PreallocatedMemoryChunk.85 = type { i8*, i8*, i64 }
%struct.ListManager.86 = type { [131072 x i8*], i64, i64, i32, i32, i32, %struct.LLVMRuntime.89* }
%struct.NodeManager.87 = type { %struct.LLVMRuntime.89*, i32, i32, i32, i32, %struct.ListManager.86*, %struct.ListManager.86*, %struct.ListManager.86*, i32 }
%struct.RandState.88 = type { i32, i32, i32, i32, i32 }

; Function Attrs: mustprogress nofree nosync nounwind willreturn
define void @_mlri_admm_rgb_half_res_fused_kernel_c94_0_kernel_0_serial(%struct.RuntimeContext.90* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.90* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
  ...
  %6 = getelementptr inbounds %struct.RuntimeContext.90, %struct.RuntimeContext.90* %context, i64 0, i32 1
  %7 = load %struct.LLVMRuntime.89*, %struct.LLVMRuntime.89** %6, align 8
  %8 = getelementptr inbounds %struct.LLVMRuntime.89, %struct.LLVMRuntime.89* %7, i64 0, i32 14
  ...
  %15 = load %struct.LLVMRuntime.89*, %struct.LLVMRuntime.89** %6, align 8
  %16 = getelementptr inbounds %struct.LLVMRuntime.89, %struct.LLVMRuntime.89* %15, i64 0, i32 14
  ...
  %39 = load %struct.LLVMRuntime.89*, %struct.LLVMRuntime.89** %6, align 8
  %40 = getelementptr inbounds %struct.LLVMRuntime.89, %struct.LLVMRuntime.89* %39, i64 0, i32 14
  %41 = load i8*, i8** %40, align 8
  %42 = getelementptr inbounds i8, i8* %41, i64 4
  %43 = bitcast i8* %42 to i32*
  store i32 %38, i32* %43, align 4
  %44 = mul i32 %38, %29
  %45 = load %struct.LLVMRuntime.89*, %struct.LLVMRuntime.89** %6, align 8
  %46 = getelementptr inbounds %struct.LLVMRuntime.89, %struct.LLVMRuntime.89* %45, i64 0, i32 14
...
define void @_mlri_admm_rgb_half_res_fused_kernel_c94_0_kernel_1_range_for(%struct.RuntimeContext.90* %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
  ...
  store %struct.RuntimeContext.90* %context, %struct.RuntimeContext.90** %4, align 8
  store void (%struct.RuntimeContext.90*, i8*)* null, void (%struct.RuntimeContext.90*, i8*)** %2, align 8
  store i64 1, i64* %3, align 8
  %5 = getelementptr inbounds %0, %0* %0, i64 0, i32 2
  store void (%struct.RuntimeContext.90*, i8*, i32)* @function_body, void (%struct.RuntimeContext.90*, i8*, i32)** %5, align 8
  %6 = getelementptr inbounds %0, %0* %0, i64 0, i32 3
  store void (%struct.RuntimeContext.90*, i8*)* null, void (%struct.RuntimeContext.90*, i8*)** %6, align 8
  %7 = getelementptr inbounds %0, %0* %0, i64 0, i32 5
  %8 = bitcast i32* %7 to <4 x i32>*
  store <4 x i32> <i32 0, i32 8, i32 1, i32 1>, <4 x i32>* %8, align 8
  %9 = getelementptr inbounds %struct.RuntimeContext.90, %struct.RuntimeContext.90* %context, i64 0, i32 1
  %10 = load %struct.LLVMRuntime.89*, %struct.LLVMRuntime.89** %9, align 8
  %11 = getelementptr inbounds %struct.LLVMRuntime.89, %struct.LLVMRuntime.89* %10, i64 0, i32 10
  %12 = load void (i8*, i32, i32, i8*, void (i8*, i32, i32)*)*, void (i8*, i32, i32, i8*, void (i8*, i32, i32)*)** %11, align 8
  %13 = getelementptr inbounds %struct.LLVMRuntime.89, %struct.LLVMRuntime.89* %10, i64 0, i32 9
...
define internal void @function_body(%struct.RuntimeContext.90* nocapture readonly %0, i8* nocapture readnone %1, i32 %2) #3 {
allocs:
  %3 = getelementptr inbounds %struct.RuntimeContext.90, %struct.RuntimeContext.90* %0, i64 0, i32 1
  %4 = load %struct.LLVMRuntime.89*, %struct.LLVMRuntime.89** %3, align 8
  %5 = getelementptr inbounds %struct.LLVMRuntime.89, %struct.LLVMRuntime.89* %4, i64 0, i32 14
  ...
  %20 = bitcast %struct.RuntimeContext.90* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
...
for_loop_body:                                    ; preds = %after_if27, %for_loop_body.lr.ph
  ...
  %66 = load %struct.LLVMRuntime.89*, %struct.LLVMRuntime.89** %3, align 8
  %67 = getelementptr inbounds %struct.LLVMRuntime.89, %struct.LLVMRuntime.89* %66, i64 0, i32 14
...
define internal void @cpu_parallel_range_for_task(i8* nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #4 {
  %4 = alloca %struct.RuntimeContext.90, align 8
  %.sroa.0.0..sroa_cast = bitcast i8* %0 to %struct.RuntimeContext.90**
  %.sroa.0.0.copyload = load %struct.RuntimeContext.90*, %struct.RuntimeContext.90** %.sroa.0.0..sroa_cast, align 8
  %.sroa.4.0..sroa_idx = getelementptr inbounds i8, i8* %0, i64 8
  %.sroa.4.0..sroa_cast = bitcast i8* %.sroa.4.0..sroa_idx to void (%struct.RuntimeContext.90*, i8*)**
  %.sroa.4.0.copyload = load void (%struct.RuntimeContext.90*, i8*)*, void (%struct.RuntimeContext.90*, i8*)** %.sroa.4.0..sroa_cast, align 8
  %.sroa.5.0..sroa_idx = getelementptr inbounds i8, i8* %0, i64 16
  %.sroa.5.0..sroa_cast = bitcast i8* %.sroa.5.0..sroa_idx to void (%struct.RuntimeContext.90*, i8*, i32)**
  %.sroa.5.0.copyload = load void (%struct.RuntimeContext.90*, i8*, i32)*, void (%struct.RuntimeContext.90*, i8*, i32)** %.sroa.5.0..sroa_cast, align 8
  %.sroa.7.0..sroa_idx = getelementptr inbounds i8, i8* %0, i64 24
  %.sroa.7.0..sroa_cast = bitcast i8* %.sroa.7.0..sroa_idx to void (%struct.RuntimeContext.90*, i8*)**
  %.sroa.7.0.copyload = load void (%struct.RuntimeContext.90*, i8*)*, void (%struct.RuntimeContext.90*, i8*)** %.sroa.7.0..sroa_cast, align 8
  ...
  %.not = icmp eq void (%struct.RuntimeContext.90*, i8*)* %.sroa.4.0.copyload, null
  br i1 %.not, label %7, label %6

6:                                                ; preds = %3
  call void %.sroa.4.0.copyload(%struct.RuntimeContext.90* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %7

7:                                                ; preds = %6, %3
  %8 = bitcast %struct.RuntimeContext.90* %.sroa.0.0.copyload to i8*
  %9 = bitcast %struct.RuntimeContext.90* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(32) %9, i8* noundef nonnull align 8 dereferenceable(32) %8, i64 32, i1 false)
  %10 = getelementptr inbounds %struct.RuntimeContext.90, %struct.RuntimeContext.90* %4, i64 0, i32 2
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.90* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.02038) #2
...
.lr.ph41:                                         ; preds = %.lr.ph41, %.lr.ph41.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.90* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.0) #2
...
.loopexit:                                        ; preds = %.loopexit.loopexit46, %.loopexit.loopexit, %19, %11, %7
  %.not24 = icmp eq void (%struct.RuntimeContext.90*, i8*)* %.sroa.7.0.copyload, null
  br i1 %.not24, label %25, label %24

24:                                               ; preds = %.loopexit
  call void %.sroa.7.0.copyload(%struct.RuntimeContext.90* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %25
