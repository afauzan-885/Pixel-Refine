...
define void @_mlri_admm_green_to_grayscale_1channel_fused_kernel_c90_0_kernel_0_serial(%struct.RuntimeContext.66* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_mlri_admm_green_to_grayscale_1channel_fused_kernel_c90_0_kernel_1_range_for(%struct.RuntimeContext.66* %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.66* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
  %22 = sub i32 0, %17
...
for_loop_body:                                    ; preds = %after_if12, %for_loop_body.lr.ph
  ...
  %23 = load %struct.LLVMRuntime.65*, %struct.LLVMRuntime.65** %3, align 8
  %24 = getelementptr inbounds %struct.LLVMRuntime.65, %struct.LLVMRuntime.65* %23, i64 0, i32 14
  %25 = load i8*, i8** %24, align 8
