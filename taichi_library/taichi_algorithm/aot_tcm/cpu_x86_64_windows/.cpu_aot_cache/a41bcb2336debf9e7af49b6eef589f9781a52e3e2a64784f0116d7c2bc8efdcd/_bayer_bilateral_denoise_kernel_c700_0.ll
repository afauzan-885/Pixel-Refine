...
define void @_bayer_bilateral_denoise_kernel_c82_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_bayer_bilateral_denoise_kernel_c82_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
for_loop_body.us:                                 ; preds = %for_loop_body.us, %for_loop_body.us.preheader
  ...
  %64 = add i32 %45, -2
  %65 = getelementptr inbounds i8, i8* %30, i64 12
  ...
  %74 = getelementptr float, float* %46, i64 %73
  ...
  %87 = load float*, float** %26, align 8
  %88 = load i32, i32* %27, align 4
  %89 = mul i32 %88, %63
  %90 = add i32 %89, %86
  %91 = sext i32 %90 to i64
  %92 = getelementptr float, float* %87, i64 %91
  ...
  %137 = load float*, float** %26, align 8
  ...
  %169 = load float*, float** %26, align 8
  ...
  %216 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }** %20, align 8
  %217 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %216, i64 0, i32 1, i32 1
  %218 = load float*, float** %217, align 8
  %219 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %216, i64 0, i32 1, i32 0, i32 1
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.preheader
  ...
  %227 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %3, align 8
  %228 = getelementptr inbounds %struct.LLVMRuntime.5, %struct.LLVMRuntime.5* %227, i64 0, i32 14
  ...
  %250 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }** %20, align 8
  %251 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %250, i64 0, i32 1, i32 1
  %252 = load float*, float** %251, align 8
  %253 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }, { { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32, float }* %250, i64 0, i32 1, i32 0, i32 1
  %254 = load i32, i32* %253, align 4
  %255 = sub i32 %254, %232
  %256 = mul i32 %255, %241
  %257 = add i32 %.06, %256
  %258 = sext i32 %257 to i64
  %259 = getelementptr float, float* %252, i64 %258
  store float %249, float* %259, align 4
