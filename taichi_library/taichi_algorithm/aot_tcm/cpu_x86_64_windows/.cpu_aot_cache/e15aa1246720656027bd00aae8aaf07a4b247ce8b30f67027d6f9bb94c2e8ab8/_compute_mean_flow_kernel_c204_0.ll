...
define void @_compute_mean_flow_kernel_c204_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  ...
  %16 = bitcast %struct.RuntimeContext.6* %context to { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }**
  %17 = load { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }** %16, align 8
  %18 = getelementptr { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }* %17, i64 0, i32 2
  %19 = load i32, i32* %18, align 4
  %20 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %0, align 8
  ...
  %25 = load { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }** %16, align 8
  %26 = getelementptr { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }* %25, i64 0, i32 4
  %27 = load i32, i32* %26, align 4
  %28 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %0, align 8
  ...
  %45 = load { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }** %16, align 8
  %46 = getelementptr { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }* %45, i64 0, i32 3
  %47 = load i32, i32* %46, align 4
  %48 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %0, align 8
  %49 = getelementptr inbounds %struct.LLVMRuntime.5, %struct.LLVMRuntime.5* %48, i64 0, i32 14
  ...
  %64 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %0, align 8
  %65 = getelementptr inbounds %struct.LLVMRuntime.5, %struct.LLVMRuntime.5* %64, i64 0, i32 14
  %66 = load i8*, i8** %65, align 8
  %67 = getelementptr inbounds i8, i8* %66, i64 4
  %68 = bitcast i8* %67 to i32*
  store i32 %63, i32* %68, align 4
  %69 = mul i32 %63, %44
  %70 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %0, align 8
  %71 = getelementptr inbounds %struct.LLVMRuntime.5, %struct.LLVMRuntime.5* %70, i64 0, i32 14
...
define void @_compute_mean_flow_kernel_c204_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
  ...
  store void (%struct.RuntimeContext.6*, i8*)* @function_body, void (%struct.RuntimeContext.6*, i8*)** %2, align 8
  ...
  store void (%struct.RuntimeContext.6*, i8*)* @function_body.2, void (%struct.RuntimeContext.6*, i8*)** %6, align 8
...
define internal void @function_body(%struct.RuntimeContext.6* nocapture readnone %0, i8* nocapture writeonly %1) #2 {
allocs:
...
define internal void @function_body.1(%struct.RuntimeContext.6* nocapture readonly %0, i8* nocapture %1, i32 %2) #3 {
allocs:
  %3 = getelementptr i8, i8* %1, i64 4
  %4 = bitcast i8* %1 to float*
  %5 = getelementptr inbounds %struct.RuntimeContext.6, %struct.RuntimeContext.6* %0, i64 0, i32 1
  %6 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %5, align 8
  %7 = getelementptr inbounds %struct.LLVMRuntime.5, %struct.LLVMRuntime.5* %6, i64 0, i32 14
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %23 = bitcast %struct.RuntimeContext.6* %0 to { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }**
  %24 = bitcast i8* %3 to <2 x float>*
  br label %for_loop_body

for_loop_body:                                    ; preds = %after_if3, %for_loop_body.lr.ph
  %.047 = phi i32 [ %19, %for_loop_body.lr.ph ], [ %81, %after_if3 ]
  %25 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %5, align 8
...
true_block1:                                      ; preds = %true_block
  %56 = load { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }** %23, align 8
  %57 = getelementptr { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }* %56, i64 0, i32 0, i32 1
  %58 = load float*, float** %57, align 8
  %59 = getelementptr { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }* %56, i64 0, i32 0, i32 0, i32 1
  ...
  %68 = fadd reassoc ninf nsz float %67, %66
  store float %68, float* %4, align 4
  %69 = load float*, float** %57, align 8
  ...
  %76 = getelementptr float, float* %75, i64 1
  %77 = load float, float* %76, align 4
  %78 = load <2 x float>, <2 x float>* %24, align 4
  %79 = insertelement <2 x float> <float poison, float 1.000000e+00>, float %77, i64 0
  %80 = fadd reassoc ninf nsz <2 x float> %78, %79
  store <2 x float> %80, <2 x float>* %24, align 4
  br label %after_if3

after_if3:                                        ; preds = %true_block1, %true_block, %for_loop_body
  %81 = add nsw i32 %.047, 1
  %exitcond.not = icmp eq i32 %21, %81
  br i1 %exitcond.not, label %after_for.loopexit, label %for_loop_body
}

; Function Attrs: mustprogress nofree norecurse nounwind willreturn
define internal void @function_body.2(%struct.RuntimeContext.6* nocapture readonly %0, i8* nocapture readonly %1) #4 {
allocs:
  %2 = bitcast i8* %1 to float*
  %3 = load float, float* %2, align 4
  %4 = getelementptr inbounds %struct.RuntimeContext.6, %struct.RuntimeContext.6* %0, i64 0, i32 1
  ...
  %23 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %4, align 8
...
define void @_compute_mean_flow_kernel_c204_0_kernel_2_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #5 {
entry:
  %0 = getelementptr inbounds %struct.RuntimeContext.6, %struct.RuntimeContext.6* %context, i64 0, i32 1
  %1 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %0, align 8
  %2 = getelementptr inbounds %struct.LLVMRuntime.5, %struct.LLVMRuntime.5* %1, i64 0, i32 14
...
true_block:                                       ; preds = %entry
  ...
  %12 = bitcast %struct.RuntimeContext.6* %context to { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }**
  %13 = load { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }*, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }** %12, align 8
  %14 = getelementptr { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }, { { { i32, i32 }, float* }, { { i32 }, float* }, i32, i32, i32 }* %13, i64 0, i32 1, i32 1
