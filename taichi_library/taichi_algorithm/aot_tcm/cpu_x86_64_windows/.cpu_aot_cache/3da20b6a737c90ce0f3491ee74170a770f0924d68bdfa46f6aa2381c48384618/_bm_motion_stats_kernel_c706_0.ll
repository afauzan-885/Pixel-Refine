...
define void @_bm_motion_stats_kernel_c706_0_kernel_0_serial(%struct.RuntimeContext.36* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.36* %context to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }**
  %1 = load { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }*, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }** %0, align 8
  %2 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }* %1, i64 0, i32 0, i32 0, i32 0
  %3 = load i32, i32* %2, align 4
  %4 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }* %1, i64 0, i32 0, i32 0, i32 1
...
define void @_bm_motion_stats_kernel_c706_0_kernel_1_range_for(%struct.RuntimeContext.36* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.36* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }**
  %21 = icmp slt i32 %17, %19
  br i1 %21, label %for_loop_body.lr.ph, label %after_for

for_loop_body.lr.ph:                              ; preds = %allocs
  %22 = load { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }*, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }** %20, align 8
  %23 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }* %22, i64 0, i32 0, i32 1
  %24 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }* %22, i64 0, i32 0, i32 0, i32 1
  %25 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }* %22, i64 0, i32 0, i32 0, i32 2
  br label %for_loop_body

for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %72, %after_if ]
  %26 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %3, align 8
  ...
  %50 = getelementptr float, float* %41, i64 %49
  %51 = load float, float* %50, align 4
  %52 = fcmp reassoc ninf nsz ogt float %51, 5.000000e-01
  br i1 %52, label %true_block, label %after_if
...
true_block:                                       ; preds = %for_loop_body
  %53 = load { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }*, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }** %20, align 8
  %54 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }* %53, i64 0, i32 1, i32 1
  %55 = load float*, float** %54, align 8
  %56 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }* %53, i64 0, i32 1, i32 0, i32 1
  %57 = load i32, i32* %56, align 4
  %58 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }* %53, i64 0, i32 1, i32 0, i32 2
  ...
  %68 = getelementptr { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }, { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, { { i32 }, float* } }* %53, i64 0, i32 2, i32 1
  %69 = load float*, float** %68, align 8
  %70 = atomicrmw fadd float* %69, float 1.000000e+00 seq_cst, align 4
  %71 = fcmp reassoc ninf nsz olt float %67, 5.000000e-01
  br i1 %71, label %true_block1, label %false_block2
...
true_block1:                                      ; preds = %true_block
  %73 = load float*, float** %68, align 8
  %74 = getelementptr float, float* %73, i64 1
  br label %after_if3

false_block2:                                     ; preds = %true_block
  %75 = fcmp reassoc ninf nsz olt float %67, 1.500000e+00
  %76 = load float*, float** %68, align 8
  br i1 %75, label %true_block4, label %false_block5

after_if3:                                        ; preds = %false_block5, %true_block4, %true_block1
  %.sink = phi float* [ %105, %true_block4 ], [ %106, %false_block5 ], [ %74, %true_block1 ]
  %77 = atomicrmw fadd float* %.sink, float 1.000000e+00 seq_cst, align 4
  %78 = load float*, float** %54, align 8
  ...
  %86 = getelementptr float, float* %78, i64 %85
  %87 = load float, float* %86, align 4
  %88 = load float*, float** %68, align 8
  %89 = getelementptr float, float* %88, i64 4
  %90 = atomicrmw fadd float* %89, float %87 seq_cst, align 4
  %91 = load float*, float** %54, align 8
  ...
  %102 = load float*, float** %68, align 8
  %103 = getelementptr float, float* %102, i64 5
  %104 = atomicrmw fadd float* %103, float %101 seq_cst, align 4
  br label %after_if

true_block4:                                      ; preds = %false_block2
  %105 = getelementptr float, float* %76, i64 2
  br label %after_if3

false_block5:                                     ; preds = %false_block2
  %106 = getelementptr float, float* %76, i64 3
  br label %after_if3
}
