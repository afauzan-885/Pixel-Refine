...
define void @_phase_normalize_kernel_c286_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_phase_normalize_kernel_c286_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.6* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
for_loop_body.lr.ph:                              ; preds = %allocs
  ...
  %23 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %22, i64 0, i32 1, i32 1
  %24 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %22, i64 0, i32 1, i32 0, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %60, %after_if ]
  ...
  %44 = fcmp reassoc ninf nsz ogt float %43, 0x3D71979980000000
  br i1 %44, label %true_block, label %after_if
...
true_block:                                       ; preds = %for_loop_body
  %45 = load { { { i32, i32 }, float* }, { { i32, i32 }, float* } }*, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }** %20, align 8
  %46 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %45, i64 0, i32 0, i32 1
  %47 = load float*, float** %46, align 8
  %48 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, float* } }, { { { i32, i32 }, float* }, { { i32, i32 }, float* } }* %45, i64 0, i32 0, i32 0, i32 1
  ...
  %59 = fdiv reassoc ninf nsz <2 x float> %56, %58
  store <2 x float> %59, <2 x float>* %55, align 4
  br label %after_if
