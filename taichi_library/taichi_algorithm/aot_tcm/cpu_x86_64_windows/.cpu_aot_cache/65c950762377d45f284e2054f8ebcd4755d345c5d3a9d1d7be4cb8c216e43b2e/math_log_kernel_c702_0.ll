...
define void @math_log_kernel_c702_0_kernel_0_serial(%struct.RuntimeContext.24* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.24* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  ...
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.23*, %struct.LLVMRuntime.23** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.23, %struct.LLVMRuntime.23* %19, i64 0, i32 14
...
define void @math_log_kernel_c702_0_kernel_1_range_for(%struct.RuntimeContext.24* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.24* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %54, %for_loop_body ]
  ...
  %46 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %45, float 0x3DDB7CDFE0000000)
  %47 = tail call float @logf(float noundef %46) #1
  ...
  %54 = add nsw i32 %.04, 1
  %exitcond.not = icmp eq i32 %19, %54
...
declare dso_local float @logf(float noundef) local_unnamed_addr #4
