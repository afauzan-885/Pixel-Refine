...
define void @math_power_kernel_c706_0_kernel_0_serial(%struct.RuntimeContext.60* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.60* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }**
  ...
  %13 = load %struct.LLVMRuntime.59*, %struct.LLVMRuntime.59** %4, align 8
  %14 = getelementptr inbounds %struct.LLVMRuntime.59, %struct.LLVMRuntime.59* %13, i64 0, i32 14
  %15 = load i8*, i8** %14, align 8
  %16 = getelementptr inbounds i8, i8* %15, i64 4
  %17 = bitcast i8* %16 to i32*
  store i32 %12, i32* %17, align 4
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.59*, %struct.LLVMRuntime.59** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.59, %struct.LLVMRuntime.59* %19, i64 0, i32 14
...
define void @math_power_kernel_c706_0_kernel_1_range_for(%struct.RuntimeContext.60* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.60* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %48 = tail call float @powf(float noundef %47, float noundef %23) #1
