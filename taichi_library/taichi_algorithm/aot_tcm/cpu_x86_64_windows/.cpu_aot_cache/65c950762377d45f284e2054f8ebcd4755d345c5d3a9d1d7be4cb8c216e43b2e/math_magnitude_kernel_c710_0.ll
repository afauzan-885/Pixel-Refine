...
define void @math_magnitude_kernel_c710_0_kernel_0_serial(%struct.RuntimeContext.72* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @math_magnitude_kernel_c710_0_kernel_1_range_for(%struct.RuntimeContext.72* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %68, %for_loop_body ]
  ...
  %53 = fmul reassoc ninf nsz float %52, %52
  %54 = add i32 %49, 1
  %55 = sext i32 %54 to i64
  %56 = getelementptr float, float* %43, i64 %55
  %57 = load float, float* %56, align 4
  %58 = fmul reassoc ninf nsz float %57, %57
  %59 = fadd reassoc ninf nsz float %58, %53
  %60 = tail call reassoc ninf nsz float @llvm.sqrt.f32(float %59)
  %61 = load float*, float** %26, align 8
  ...
  %68 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %19, %68
