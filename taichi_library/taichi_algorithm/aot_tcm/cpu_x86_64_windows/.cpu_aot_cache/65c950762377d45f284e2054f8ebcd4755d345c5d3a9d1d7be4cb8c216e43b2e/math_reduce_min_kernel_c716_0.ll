...
define void @math_reduce_min_kernel_c716_0_kernel_0_serial(%struct.RuntimeContext.120* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = getelementptr inbounds %struct.RuntimeContext.120, %struct.RuntimeContext.120* %context, i64 0, i32 1
  %1 = load %struct.LLVMRuntime.119*, %struct.LLVMRuntime.119** %0, align 8
  %2 = getelementptr inbounds %struct.LLVMRuntime.119, %struct.LLVMRuntime.119* %1, i64 0, i32 14
  %3 = load i8*, i8** %2, align 8
  %4 = getelementptr inbounds i8, i8* %3, i64 12
  %5 = bitcast i8* %4 to float*
  store float 0x46293E5940000000, float* %5, align 4
  %6 = bitcast %struct.RuntimeContext.120* %context to { { { i32, i32 }, float* }, { { i32 }, float* } }**
  ...
  %10 = load %struct.LLVMRuntime.119*, %struct.LLVMRuntime.119** %0, align 8
  %11 = getelementptr inbounds %struct.LLVMRuntime.119, %struct.LLVMRuntime.119* %10, i64 0, i32 14
  ...
  %18 = load %struct.LLVMRuntime.119*, %struct.LLVMRuntime.119** %0, align 8
  %19 = getelementptr inbounds %struct.LLVMRuntime.119, %struct.LLVMRuntime.119* %18, i64 0, i32 14
  %20 = load i8*, i8** %19, align 8
  %21 = getelementptr inbounds i8, i8* %20, i64 4
  %22 = bitcast i8* %21 to i32*
  store i32 %17, i32* %22, align 4
  %23 = mul i32 %17, %9
  %24 = load %struct.LLVMRuntime.119*, %struct.LLVMRuntime.119** %0, align 8
  %25 = getelementptr inbounds %struct.LLVMRuntime.119, %struct.LLVMRuntime.119* %24, i64 0, i32 14
...
define void @math_reduce_min_kernel_c716_0_kernel_1_range_for(%struct.RuntimeContext.120* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.120* %0 to { { { i32, i32 }, float* }, { { i32 }, float* } }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %25 = load %struct.LLVMRuntime.119*, %struct.LLVMRuntime.119** %3, align 8
  %26 = getelementptr inbounds %struct.LLVMRuntime.119, %struct.LLVMRuntime.119* %25, i64 0, i32 14
  ...
  %47 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %39, float %46)
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn
define void @math_reduce_min_kernel_c716_0_kernel_2_serial(%struct.RuntimeContext.120* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = getelementptr inbounds %struct.RuntimeContext.120, %struct.RuntimeContext.120* %context, i64 0, i32 1
  %1 = load %struct.LLVMRuntime.119*, %struct.LLVMRuntime.119** %0, align 8
  %2 = getelementptr inbounds %struct.LLVMRuntime.119, %struct.LLVMRuntime.119* %1, i64 0, i32 14
  ...
  %7 = bitcast %struct.RuntimeContext.120* %context to { { { i32, i32 }, float* }, { { i32 }, float* } }**
