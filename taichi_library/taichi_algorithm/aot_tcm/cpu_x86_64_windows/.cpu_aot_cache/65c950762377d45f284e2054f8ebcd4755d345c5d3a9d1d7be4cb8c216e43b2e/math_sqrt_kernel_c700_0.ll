...
define void @math_sqrt_kernel_c700_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
define void @math_sqrt_kernel_c700_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %53, %for_loop_body ]
  ...
  %46 = tail call reassoc ninf nsz float @llvm.sqrt.f32(float %45)
  %47 = load float*, float** %25, align 8
  %48 = load i32, i32* %26, align 4
  %49 = mul i32 %48, %38
  %50 = add i32 %49, %33
  %51 = sext i32 %50 to i64
  %52 = getelementptr float, float* %47, i64 %51
  store float %46, float* %52, align 4
  %53 = add nsw i32 %.04, 1
  %exitcond.not = icmp eq i32 %19, %53
