...
define void @math_square_kernel_c708_0_kernel_0_serial(%struct.RuntimeContext.48* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.48* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* } }**
  ...
  %18 = mul i32 %12, %3
  %19 = load %struct.LLVMRuntime.47*, %struct.LLVMRuntime.47** %4, align 8
  %20 = getelementptr inbounds %struct.LLVMRuntime.47, %struct.LLVMRuntime.47* %19, i64 0, i32 14
...
define void @math_square_kernel_c708_0_kernel_1_range_for(%struct.RuntimeContext.48* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %46 = fmul reassoc ninf nsz float %45, %45
