...
%struct.RuntimeContext.151 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_pad_constant_kernel_3d_vector_c560_1_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_pad_constant_kernel_3d_vector_c560_1_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if9, %for_loop_body.preheader
  %.0815 = phi i32 [ %95, %after_if9 ], [ %16, %for_loop_body.preheader ]
...
true_block7:                                      ; preds = %true_block1
  ...
  %59 = getelementptr i32, ptr %46, i64 %58
...
false_block8:                                     ; preds = %true_block1, %true_block, %for_loop_body
  ...
  %63 = getelementptr i8, ptr %37, i64 44
  %64 = load float, ptr %63, align 4
  %65 = getelementptr i8, ptr %37, i64 48
  %66 = load float, ptr %65, align 4
  %67 = fptosi float %62 to i32
  %68 = fptosi float %64 to i32
  %69 = fptosi float %66 to i32
  br label %after_if9

after_if9:                                        ; preds = %false_block8, %true_block7
  %.sink37 = phi i32 [ %67, %false_block8 ], [ %52, %true_block7 ]
  %.sink26 = phi i32 [ %68, %false_block8 ], [ %56, %true_block7 ]
  %.sink = phi i32 [ %69, %false_block8 ], [ %60, %true_block7 ]
  %70 = getelementptr i8, ptr %37, i64 24
  %71 = load ptr, ptr %70, align 8
  %72 = getelementptr i8, ptr %37, i64 20
  %73 = load i32, ptr %72, align 4
  %74 = mul i32 %73, %34
  %75 = add i32 %74, %30
  %76 = mul i32 %75, 3
  %77 = sext i32 %76 to i64
  %78 = getelementptr i32, ptr %71, i64 %77
  store i32 %.sink37, ptr %78, align 4
  ...
  store i32 %.sink26, ptr %86, align 4
  ...
  %94 = getelementptr i32, ptr %87, i64 %93
  store i32 %.sink, ptr %94, align 4
  %95 = add nsw i32 %.0815, 1
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.151, align 8
