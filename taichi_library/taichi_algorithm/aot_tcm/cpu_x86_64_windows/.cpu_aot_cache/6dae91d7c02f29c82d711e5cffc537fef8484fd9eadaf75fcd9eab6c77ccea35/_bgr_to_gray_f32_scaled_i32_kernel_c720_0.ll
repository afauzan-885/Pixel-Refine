...
%struct.RuntimeContext.85 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_bgr_to_gray_f32_scaled_i32_kernel_c720_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_bgr_to_gray_f32_scaled_i32_kernel_c720_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
allocs:
  ...
  %factor.op.fmul = fmul reassoc ninf nsz float %21, 0x3FD322D0E0000000
  %factor.op.fmul4 = fmul reassoc ninf nsz float %21, 0x3FBD2F1AA0000000
  %factor.op.fmul6 = fmul reassoc ninf nsz float %21, 0x3FE2C8B440000000
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.08 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %64, %for_loop_body ]
  ...
  %.reass = fmul reassoc ninf nsz float %factor.op.fmul, %55
  %.reass7 = fmul reassoc ninf nsz float %factor.op.fmul6, %50
  %.reass5 = fmul reassoc ninf nsz float %factor.op.fmul4, %45
  %56 = fadd reassoc ninf nsz float %.reass7, %.reass5
  %57 = fadd reassoc ninf nsz float %56, %.reass
  %58 = load ptr, ptr %25, align 8
  %59 = load i32, ptr %26, align 4
  %60 = mul i32 %59, %36
  %61 = add i32 %60, %32
  %62 = sext i32 %61 to i64
  %63 = getelementptr float, ptr %58, i64 %62
  store float %57, ptr %63, align 4
  %64 = add nsw i32 %.08, 1
  %exitcond.not = icmp eq i32 %18, %64
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.85, align 8
