...
%struct.RuntimeContext.111 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_stitch_tile_vec3_kernel_c738_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_stitch_tile_vec3_kernel_c738_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %125, %for_loop_body ]
  ...
  %78 = getelementptr float, ptr %67, i64 %77
  %79 = load float, ptr %78, align 4
  %80 = add i32 %72, 2
  %81 = sext i32 %80 to i64
  %82 = getelementptr float, ptr %67, i64 %81
  %83 = load float, ptr %82, align 4
  %84 = fmul reassoc ninf nsz float %75, %66
  %85 = fmul reassoc ninf nsz float %79, %66
  %86 = fmul reassoc ninf nsz float %83, %66
  ...
  %95 = getelementptr float, ptr %87, i64 %94
  %96 = atomicrmw fadd ptr %95, float %84 seq_cst, align 4
  ...
  %106 = atomicrmw fadd ptr %105, float %85 seq_cst, align 4
  ...
  %116 = atomicrmw fadd ptr %115, float %86 seq_cst, align 4
  ...
  %124 = atomicrmw fadd ptr %123, float %66 seq_cst, align 4
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.111, align 8
