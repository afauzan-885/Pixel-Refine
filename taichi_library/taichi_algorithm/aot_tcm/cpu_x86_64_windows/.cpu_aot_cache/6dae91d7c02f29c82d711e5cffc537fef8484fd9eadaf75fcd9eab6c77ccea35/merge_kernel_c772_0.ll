...
%struct.RuntimeContext.75 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @merge_kernel_c772_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @merge_kernel_c772_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %44 = getelementptr half, ptr %39, i64 %43
  %45 = load half, ptr %44, align 2
  %46 = load ptr, ptr %23, align 8
  %47 = load i32, ptr %24, align 4
  %48 = mul i32 %47, %38
  %49 = add i32 %48, %34
  %50 = sext i32 %49 to i64
  %51 = getelementptr half, ptr %46, i64 %50
  %52 = load half, ptr %51, align 2
  %53 = load ptr, ptr %25, align 8
  %54 = load i32, ptr %26, align 4
  %55 = mul i32 %54, %38
  %56 = add i32 %55, %34
  %57 = sext i32 %56 to i64
  %58 = getelementptr half, ptr %53, i64 %57
  %59 = load half, ptr %58, align 2
  ...
  %66 = getelementptr half, ptr %60, i64 %65
  store half %45, ptr %66, align 2
  ...
  %74 = getelementptr half, ptr %67, i64 %73
  store half %52, ptr %74, align 2
  ...
  %82 = getelementptr half, ptr %75, i64 %81
  store half %59, ptr %82, align 2
  %83 = add nsw i32 %.04, 1
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.75, align 8
