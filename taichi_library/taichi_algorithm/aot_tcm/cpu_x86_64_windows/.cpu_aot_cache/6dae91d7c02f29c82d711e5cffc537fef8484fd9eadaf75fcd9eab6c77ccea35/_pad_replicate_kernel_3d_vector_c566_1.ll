...
%struct.RuntimeContext.157 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_pad_replicate_kernel_3d_vector_c566_1_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_pad_replicate_kernel_3d_vector_c566_1_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %61 = getelementptr i32, ptr %51, i64 %60
  %62 = load i32, ptr %61, align 4
  %63 = add i32 %55, 2
  %64 = sext i32 %63 to i64
  %65 = getelementptr i32, ptr %51, i64 %64
  ...
  %81 = getelementptr i32, ptr %74, i64 %80
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.157, align 8
