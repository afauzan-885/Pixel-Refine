...
%struct.RuntimeContext.137 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_pad_replicate_kernel_3d_vector_c566_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_pad_replicate_kernel_3d_vector_c566_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %90, %for_loop_body ]
  ...
  %42 = add i32 %41, -1
  %43 = tail call i32 @llvm.smax.i32(i32 %39, i32 0)
  %44 = tail call i32 @llvm.smin.i32(i32 %42, i32 %43)
  %45 = sub i32 %34, %23
  %46 = getelementptr i8, ptr %40, i64 4
  %47 = load i32, ptr %46, align 4
  %48 = add i32 %47, -1
  %49 = tail call i32 @llvm.smax.i32(i32 %45, i32 0)
  ...
  %65 = getelementptr float, ptr %51, i64 %64
  ...
  store float %66, ptr %89, align 4
  %90 = add nsw i32 %.04, 1
  %exitcond.not = icmp eq i32 %18, %90
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.137, align 8
