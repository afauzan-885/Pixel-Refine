...
%struct.RuntimeContext.101 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_normalize_accum_kernel_c728_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_normalize_accum_kernel_c728_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %59, %for_loop_body ]
  ...
  %52 = fdiv reassoc ninf nsz float %51, %44
  ...
  %59 = add nsw i32 %.04, 1
  %exitcond.not = icmp eq i32 %18, %59
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #3 {
  %4 = alloca %struct.RuntimeContext.101, align 8
