...
%struct.RuntimeContext.83 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_rgb_to_gray_f32_scaled_i32_kernel_c718_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_rgb_to_gray_f32_scaled_i32_kernel_c718_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
allocs:
  ...
  %factor.op.fmul = fmul reassoc ninf nsz float %21, 0x3FBD2F1AA0000000
  %factor.op.fmul4 = fmul reassoc ninf nsz float %21, 0x3FD322D0E0000000
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.83, align 8
