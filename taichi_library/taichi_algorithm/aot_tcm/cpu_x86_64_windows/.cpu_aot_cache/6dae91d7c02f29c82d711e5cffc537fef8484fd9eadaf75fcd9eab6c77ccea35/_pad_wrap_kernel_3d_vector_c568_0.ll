...
%struct.RuntimeContext.139 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_pad_wrap_kernel_3d_vector_c568_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_pad_wrap_kernel_3d_vector_c568_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.07 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %104, %for_loop_body ]
  ...
  %46 = icmp ne i32 %38, %21
  %47 = icmp ne i32 %43, %39
  %48 = and i1 %46, %45
  %49 = and i1 %48, %47
  ...
  %60 = icmp ne i32 %34, %23
  %61 = icmp ne i32 %57, %53
  %62 = and i1 %60, %59
  %63 = and i1 %62, %61
  %.neg5.neg = zext i1 %63 to i32
  %.neg8 = sub i32 %.neg5.neg, %56
  %.neg9 = mul i32 %.neg8, %55
  ...
  %95 = getelementptr float, ptr %88, i64 %94
  store float %76, ptr %95, align 4
  ...
  %103 = getelementptr float, ptr %96, i64 %102
  store float %80, ptr %103, align 4
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.139, align 8
