...
%struct.RuntimeContext.107 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_scale_f32_vec3_kernel_c734_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_scale_f32_vec3_kernel_c734_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %79, %for_loop_body ]
  ...
  %53 = fmul reassoc ninf nsz float %44, %21
  %54 = fmul reassoc ninf nsz float %48, %21
  %55 = fmul reassoc ninf nsz float %52, %21
  ...
  %78 = getelementptr float, ptr %71, i64 %77
  store float %55, ptr %78, align 4
  %79 = add nsw i32 %.04, 1
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.107, align 8
