...
define void @copy_1d_kernel_c748_1_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @copy_1d_kernel_c748_1_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.preheader
  ...
  %43 = getelementptr i32, ptr %42, i64 %39
  ...
  %61 = getelementptr i32, ptr %60, i64 %57
