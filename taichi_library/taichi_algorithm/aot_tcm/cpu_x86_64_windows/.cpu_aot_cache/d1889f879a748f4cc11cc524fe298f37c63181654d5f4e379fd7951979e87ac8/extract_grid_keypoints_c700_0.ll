...
define void @extract_grid_keypoints_c700_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, i32, float }**
  ...
  %30 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %4, align 8
  ...
  %51 = mul i32 %45, %44
  %52 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %4, align 8
...
define void @extract_grid_keypoints_c700_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, i32, float }**
