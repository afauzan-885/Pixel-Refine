...
define void @_compute_histogram_kernel_c356_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.6* %context to { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }**
  %1 = load { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }*, { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }, { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }* %1, i64 0, i32 2
  %3 = load i32, i32* %2, align 4
  %4 = tail call i32 @llvm.smax.i32(i32 %3, i32 0)
  %5 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }, { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }* %1, i64 0, i32 3
...
define void @_compute_histogram_kernel_c356_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.6* %0 to { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }**
  %21 = load { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }*, { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }** %20, align 8
  %22 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }, { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }* %21, i64 0, i32 4
  %23 = load float, float* %22, align 4
  %24 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }, { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }* %21, i64 0, i32 5
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %29 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }, { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }* %21, i64 0, i32 0, i32 1
  %30 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }, { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }* %21, i64 0, i32 0, i32 0, i32 1
  %31 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }, { { { i32, i32 }, float* }, { { i32 }, i32* }, i32, i32, float, i32 }* %21, i64 0, i32 1, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %63, %for_loop_body ]
  ...
  %42 = icmp ne i32 %.06, 0
  %43 = icmp ne i32 %.06, %39
  %44 = and i1 %42, %41
  %45 = and i1 %44, %43
  %.neg4 = sext i1 %45 to i32
  %46 = add i32 %38, %.neg4
  %47 = load float*, float** %29, align 8
  %48 = load i32, i32* %30, align 4
  %reass.add = sub i32 %48, %37
  %reass.mul = mul i32 %reass.add, %46
  %49 = add i32 %.06, %reass.mul
  %50 = sext i32 %49 to i64
  %51 = getelementptr float, float* %47, i64 %50
  %52 = load float, float* %51, align 4
  %53 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %52, float 0.000000e+00)
  %54 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %23, float %53)
  %55 = fmul reassoc ninf nsz float %54, %26
  %56 = fdiv reassoc ninf nsz float %55, %23
  %57 = fptosi float %56 to i32
  %58 = tail call i32 @llvm.smin.i32(i32 %57, i32 %27)
  %59 = load i32*, i32** %31, align 8
  %60 = sext i32 %58 to i64
  %61 = getelementptr i32, i32* %59, i64 %60
  %62 = atomicrmw add i32* %61, i32 1 seq_cst, align 4
  %63 = add nsw i32 %.06, 1
