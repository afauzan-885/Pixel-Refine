...
define void @_ha_rgb_half_res_fused_kernel_c716_0_kernel_0_serial(%struct.RuntimeContext.96* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.96* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
  ...
  %6 = getelementptr inbounds %struct.RuntimeContext.96, %struct.RuntimeContext.96* %context, i64 0, i32 1
  %7 = load %struct.LLVMRuntime.95*, %struct.LLVMRuntime.95** %6, align 8
  %8 = getelementptr inbounds %struct.LLVMRuntime.95, %struct.LLVMRuntime.95* %7, i64 0, i32 14
  ...
  %15 = load %struct.LLVMRuntime.95*, %struct.LLVMRuntime.95** %6, align 8
  ...
  %39 = load %struct.LLVMRuntime.95*, %struct.LLVMRuntime.95** %6, align 8
  ...
  %44 = mul i32 %38, %29
  %45 = load %struct.LLVMRuntime.95*, %struct.LLVMRuntime.95** %6, align 8
  %46 = getelementptr inbounds %struct.LLVMRuntime.95, %struct.LLVMRuntime.95* %45, i64 0, i32 14
...
define void @_ha_rgb_half_res_fused_kernel_c716_0_kernel_1_range_for(%struct.RuntimeContext.96* %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
define internal void @function_body(%struct.RuntimeContext.96* nocapture readonly %0, i8* nocapture readnone %1, i32 %2) #3 {
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.96* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
...
for_loop_body:                                    ; preds = %after_if27, %for_loop_body.lr.ph
  ...
  %66 = load %struct.LLVMRuntime.95*, %struct.LLVMRuntime.95** %3, align 8
  %67 = getelementptr inbounds %struct.LLVMRuntime.95, %struct.LLVMRuntime.95* %66, i64 0, i32 14
...
6:                                                ; preds = %3
  call void %.sroa.4.0.copyload(%struct.RuntimeContext.96* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %7
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.96* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.02038) #2
...
.lr.ph41:                                         ; preds = %.lr.ph41, %.lr.ph41.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.96* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.0) #2
...
24:                                               ; preds = %.loopexit
  call void %.sroa.7.0.copyload(%struct.RuntimeContext.96* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %25
