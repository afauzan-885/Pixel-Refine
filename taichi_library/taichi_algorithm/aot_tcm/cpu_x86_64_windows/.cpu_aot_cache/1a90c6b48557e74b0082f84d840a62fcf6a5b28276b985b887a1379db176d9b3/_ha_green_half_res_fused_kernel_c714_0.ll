...
define void @_ha_green_half_res_fused_kernel_c714_0_kernel_0_serial(%struct.RuntimeContext.84* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.84* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
  ...
  %6 = getelementptr inbounds %struct.RuntimeContext.84, %struct.RuntimeContext.84* %context, i64 0, i32 1
  %7 = load %struct.LLVMRuntime.83*, %struct.LLVMRuntime.83** %6, align 8
  %8 = getelementptr inbounds %struct.LLVMRuntime.83, %struct.LLVMRuntime.83* %7, i64 0, i32 14
  ...
  %15 = load %struct.LLVMRuntime.83*, %struct.LLVMRuntime.83** %6, align 8
  ...
  %39 = load %struct.LLVMRuntime.83*, %struct.LLVMRuntime.83** %6, align 8
  ...
  %44 = mul i32 %38, %29
  %45 = load %struct.LLVMRuntime.83*, %struct.LLVMRuntime.83** %6, align 8
  %46 = getelementptr inbounds %struct.LLVMRuntime.83, %struct.LLVMRuntime.83* %45, i64 0, i32 14
...
define void @_ha_green_half_res_fused_kernel_c714_0_kernel_1_range_for(%struct.RuntimeContext.84* %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
define internal void @function_body(%struct.RuntimeContext.84* nocapture readonly %0, i8* nocapture readnone %1, i32 %2) #3 {
allocs:
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.84* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
  %22 = shl i32 %17, 1
...
for_loop_body:                                    ; preds = %after_if72, %for_loop_body.lr.ph
  ...
  %24 = load %struct.LLVMRuntime.83*, %struct.LLVMRuntime.83** %3, align 8
...
6:                                                ; preds = %3
  call void %.sroa.4.0.copyload(%struct.RuntimeContext.84* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %7
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.84* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.02038) #2
...
.lr.ph41:                                         ; preds = %.lr.ph41, %.lr.ph41.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.84* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.0) #2
...
24:                                               ; preds = %.loopexit
  call void %.sroa.7.0.copyload(%struct.RuntimeContext.84* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %25
