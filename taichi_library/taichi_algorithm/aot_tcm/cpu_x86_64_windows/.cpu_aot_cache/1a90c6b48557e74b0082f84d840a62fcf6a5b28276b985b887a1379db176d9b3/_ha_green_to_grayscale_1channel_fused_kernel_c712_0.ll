...
define void @_ha_green_to_grayscale_1channel_fused_kernel_c712_0_kernel_0_serial(%struct.RuntimeContext.72* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.72* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
  ...
  %23 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %6, align 8
  ...
  %38 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %6, align 8
  ...
  %43 = mul i32 %37, %28
  %44 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %6, align 8
  %45 = getelementptr inbounds %struct.LLVMRuntime.71, %struct.LLVMRuntime.71* %44, i64 0, i32 14
...
define void @_ha_green_to_grayscale_1channel_fused_kernel_c712_0_kernel_1_range_for(%struct.RuntimeContext.72* %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
define internal void @function_body(%struct.RuntimeContext.72* nocapture readonly %0, i8* nocapture readnone %1, i32 %2) #3 {
allocs:
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.72* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
  %22 = sub i32 0, %17
...
for_loop_body:                                    ; preds = %after_if12, %for_loop_body.lr.ph
  ...
  %23 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %3, align 8
  %24 = getelementptr inbounds %struct.LLVMRuntime.71, %struct.LLVMRuntime.71* %23, i64 0, i32 14
  %25 = load i8*, i8** %24, align 8
...
6:                                                ; preds = %3
  call void %.sroa.4.0.copyload(%struct.RuntimeContext.72* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %7
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.72* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.02038) #2
...
.lr.ph41:                                         ; preds = %.lr.ph41, %.lr.ph41.preheader
  ...
  call void %.sroa.5.0.copyload(%struct.RuntimeContext.72* noundef nonnull %4, i8* noundef nonnull %5, i32 noundef %.0) #2
...
24:                                               ; preds = %.loopexit
  call void %.sroa.7.0.copyload(%struct.RuntimeContext.72* noundef %.sroa.0.0.copyload, i8* noundef nonnull %5) #2
  br label %25
