...
define void @_zero_kernel_c440_0_kernel_0_serial(%struct.RuntimeContext.48* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.48* %context to { { { i32, i32 }, float* }, i32, i32 }**
  ...
  %5 = getelementptr { { { i32, i32 }, float* }, i32, i32 }, { { { i32, i32 }, float* }, i32, i32 }* %1, i64 0, i32 2
...
define void @_zero_kernel_c440_0_kernel_1_range_for(%struct.RuntimeContext.48* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.48* %0 to { { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %45, %for_loop_body ]
  ...
  %reass.add = sub i32 %41, %30
  %reass.mul = mul i32 %reass.add, %39
  %42 = add i32 %.06, %reass.mul
  %43 = sext i32 %42 to i64
  %44 = getelementptr float, float* %40, i64 %43
  store float 0.000000e+00, float* %44, align 4
  %45 = add nsw i32 %.06, 1
  %exitcond.not = icmp eq i32 %19, %45
