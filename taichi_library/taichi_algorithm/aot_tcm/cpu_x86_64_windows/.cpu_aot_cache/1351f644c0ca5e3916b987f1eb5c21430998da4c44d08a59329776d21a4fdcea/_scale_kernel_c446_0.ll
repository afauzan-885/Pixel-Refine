...
define void @_scale_kernel_c446_0_kernel_0_serial(%struct.RuntimeContext.84* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.84* %context to { { { i32, i32 }, float* }, float, i32, i32 }**
  %1 = load { { { i32, i32 }, float* }, float, i32, i32 }*, { { { i32, i32 }, float* }, float, i32, i32 }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, float, i32, i32 }, { { { i32, i32 }, float* }, float, i32, i32 }* %1, i64 0, i32 2
  %3 = load i32, i32* %2, align 4
  %4 = tail call i32 @llvm.smax.i32(i32 %3, i32 0)
  %5 = getelementptr { { { i32, i32 }, float* }, float, i32, i32 }, { { { i32, i32 }, float* }, float, i32, i32 }* %1, i64 0, i32 3
...
define void @_scale_kernel_c446_0_kernel_1_range_for(%struct.RuntimeContext.84* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.84* %0 to { { { i32, i32 }, float* }, float, i32, i32 }**
  %21 = load { { { i32, i32 }, float* }, float, i32, i32 }*, { { { i32, i32 }, float* }, float, i32, i32 }** %20, align 8
  %22 = getelementptr { { { i32, i32 }, float* }, float, i32, i32 }, { { { i32, i32 }, float* }, float, i32, i32 }* %21, i64 0, i32 1
  %23 = load float, float* %22, align 4
  %24 = icmp slt i32 %17, %19
  br i1 %24, label %for_loop_body.lr.ph, label %after_for

for_loop_body.lr.ph:                              ; preds = %allocs
  %25 = getelementptr { { { i32, i32 }, float* }, float, i32, i32 }, { { { i32, i32 }, float* }, float, i32, i32 }* %21, i64 0, i32 0, i32 1
  %26 = getelementptr { { { i32, i32 }, float* }, float, i32, i32 }, { { { i32, i32 }, float* }, float, i32, i32 }* %21, i64 0, i32 0, i32 0, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %49, %for_loop_body ]
  %27 = load %struct.LLVMRuntime.83*, %struct.LLVMRuntime.83** %3, align 8
