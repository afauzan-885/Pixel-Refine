...
define void @_sobel_kernel_c204_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_sobel_kernel_c204_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.022 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %122, %for_loop_body ]
  ...
  %69 = tail call i32 @llvm.smin.i32(i32 %50, i32 %68)
  %70 = add i32 %69, %57
  %71 = sext i32 %70 to i64
  %72 = getelementptr float, ptr %55, i64 %71
  %73 = load float, ptr %72, align 4
  %74 = mul i32 %38, %56
  %75 = add i32 %54, %74
  %76 = sext i32 %75 to i64
  %77 = getelementptr float, ptr %55, i64 %76
  %78 = load float, ptr %77, align 4
  %79 = add i32 %69, %74
  %80 = sext i32 %79 to i64
  %81 = getelementptr float, ptr %55, i64 %80
  %82 = load float, ptr %81, align 4
  %83 = add i32 %38, 1
  %84 = tail call i32 @llvm.smax.i32(i32 %83, i32 0)
  %85 = tail call i32 @llvm.smin.i32(i32 %43, i32 %84)
  %86 = mul i32 %85, %56
  %87 = add i32 %54, %86
  ...
  %98 = getelementptr float, ptr %55, i64 %97
  %99 = load float, ptr %98, align 4
  %reass.add = fsub reassoc ninf nsz float %82, %78
  %reass.mul = fmul reassoc ninf nsz float %reass.add, 2.000000e+00
  %100 = fadd reassoc ninf nsz float %61, %90
  %101 = fsub reassoc ninf nsz float %73, %100
  %102 = fadd reassoc ninf nsz float %101, %reass.mul
  %103 = fadd reassoc ninf nsz float %102, %99
  %reass.add20 = fsub reassoc ninf nsz float %95, %66
  %reass.mul21 = fmul reassoc ninf nsz float %reass.add20, 2.000000e+00
  %104 = fadd reassoc ninf nsz float %61, %73
  %105 = fsub reassoc ninf nsz float %90, %104
  %106 = fadd reassoc ninf nsz float %105, %99
  %107 = fadd reassoc ninf nsz float %106, %reass.mul21
  ...
  store float %103, ptr %114, align 4
  ...
  store float %107, ptr %121, align 4
  %122 = add nsw i32 %.022, 1
  %exitcond.not = icmp eq i32 %18, %122
