...
define void @_compute_bitmaps_c336_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext* %context to { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }**
  %1 = load { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %1, i64 0, i32 0, i32 0, i32 0
  %3 = load i32, i32* %2, align 4
  %4 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %1, i64 0, i32 0, i32 0, i32 1
...
define void @_compute_bitmaps_c336_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }**
  %21 = load { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }*, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }** %20, align 8
  %22 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %21, i64 0, i32 3
  %23 = load float, float* %22, align 4
  %24 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %21, i64 0, i32 4
  %25 = load float, float* %24, align 4
  %26 = icmp slt i32 %17, %19
  br i1 %26, label %for_loop_body.lr.ph, label %after_for

for_loop_body.lr.ph:                              ; preds = %allocs
  %27 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %21, i64 0, i32 0, i32 1
  %28 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %21, i64 0, i32 0, i32 0, i32 1
  %29 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %21, i64 0, i32 1, i32 1
  %30 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %21, i64 0, i32 1, i32 0, i32 1
  %31 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %21, i64 0, i32 2, i32 1
  %32 = getelementptr { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }, { { { i32, i32 }, float* }, { { i32, i32 }, i32* }, { { i32, i32 }, i32* }, float, float }* %21, i64 0, i32 2, i32 0, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %74, %for_loop_body ]
  %33 = load %struct.LLVMRuntime*, %struct.LLVMRuntime** %3, align 8
  %34 = getelementptr inbounds %struct.LLVMRuntime, %struct.LLVMRuntime* %33, i64 0, i32 14
  ...
  %47 = add i32 %39, %.neg4
  %48 = load float*, float** %27, align 8
  %49 = load i32, i32* %28, align 4
  %50 = sub i32 %49, %38
  %51 = mul i32 %50, %47
  %52 = add i32 %.06, %51
  %53 = sext i32 %52 to i64
  %54 = getelementptr float, float* %48, i64 %53
  %55 = load float, float* %54, align 4
  %56 = fcmp reassoc ninf nsz ogt float %55, %23
  ...
  %63 = getelementptr i32, i32* %57, i64 %62
  %. = zext i1 %56 to i32
  store i32 %., i32* %63, align 4
  %64 = fsub reassoc ninf nsz float %55, %23
  %65 = tail call float @llvm.fabs.f32(float %64)
  %66 = fcmp reassoc ninf nsz ogt float %65, %25
  ...
  %73 = getelementptr i32, i32* %67, i64 %72
  %storemerge5 = zext i1 %66 to i32
  store i32 %storemerge5, i32* %73, align 4
  %74 = add nsw i32 %.06, 1
