...
define void @_compute_histogram_c334_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.6* %context to { { { i32, i32 }, float* }, { { i32 }, i32* } }**
  %1 = load { { { i32, i32 }, float* }, { { i32 }, i32* } }*, { { { i32, i32 }, float* }, { { i32 }, i32* } }** %0, align 8
  %2 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* } }, { { { i32, i32 }, float* }, { { i32 }, i32* } }* %1, i64 0, i32 0, i32 0, i32 0
  %3 = load i32, i32* %2, align 4
  %4 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* } }, { { { i32, i32 }, float* }, { { i32 }, i32* } }* %1, i64 0, i32 0, i32 0, i32 1
...
define void @_compute_histogram_c334_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.6* %0 to { { { i32, i32 }, float* }, { { i32 }, i32* } }**
  ...
  %25 = getelementptr { { { i32, i32 }, float* }, { { i32 }, i32* } }, { { { i32, i32 }, float* }, { { i32 }, i32* } }* %22, i64 0, i32 1, i32 1
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %55, %for_loop_body ]
