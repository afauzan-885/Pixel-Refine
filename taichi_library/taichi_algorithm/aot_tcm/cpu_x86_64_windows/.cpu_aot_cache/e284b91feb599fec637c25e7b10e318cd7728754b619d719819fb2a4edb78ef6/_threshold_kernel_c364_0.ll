...
define void @_threshold_kernel_c364_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_threshold_kernel_c364_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body.us:                                 ; preds = %after_if3.us, %for_loop_body.us.preheader
  %.057.us = phi i32 [ %60, %after_if3.us ], [ %16, %for_loop_body.us.preheader ]
  %28 = load ptr, ptr %3, align 8
  %29 = getelementptr inbounds nuw i8, ptr %28, i64 32872
  %30 = load ptr, ptr %29, align 8
  %31 = getelementptr inbounds nuw i8, ptr %30, i64 4
  %32 = load i32, ptr %31, align 4
  %33 = sdiv i32 %.057.us, %32
  %34 = mul i32 %33, %32
  %35 = xor i32 %32, %.057.us
  %36 = icmp slt i32 %35, 0
  %37 = icmp ne i32 %.057.us, %34
  %38 = and i1 %36, %37
  %.neg6.us = sext i1 %38 to i32
  %39 = add i32 %33, %.neg6.us
  %40 = load ptr, ptr %26, align 8
  %41 = load i32, ptr %27, align 4
  %42 = sub i32 %41, %32
  %43 = mul i32 %42, %39
  %44 = add i32 %.057.us, %43
  %45 = sext i32 %44 to i64
  %46 = getelementptr float, ptr %40, i64 %45
  %47 = load float, ptr %46, align 4
  %48 = fcmp reassoc ninf nsz ogt float %47, %21
  %.pre10 = load ptr, ptr %0, align 8
  br i1 %48, label %true_block1.us, label %after_if3.us

true_block1.us:                                   ; preds = %for_loop_body.us
  %49 = getelementptr i8, ptr %.pre10, i64 36
  %50 = load float, ptr %49, align 4
  br label %after_if3.us

after_if3.us:                                     ; preds = %true_block1.us, %for_loop_body.us
  %.0.us = phi float [ %50, %true_block1.us ], [ 0.000000e+00, %for_loop_body.us ]
  %51 = getelementptr i8, ptr %.pre10, i64 24
  %52 = load ptr, ptr %51, align 8
  %53 = getelementptr i8, ptr %.pre10, i64 20
  %54 = load i32, ptr %53, align 4
  %55 = sub i32 %54, %32
  %56 = mul i32 %55, %39
  %57 = add i32 %.057.us, %56
  %58 = sext i32 %57 to i64
  %59 = getelementptr float, ptr %52, i64 %58
  store float %.0.us, ptr %59, align 4
  %60 = add nsw i32 %.057.us, 1
  %exitcond9.not = icmp eq i32 %18, %60
  br i1 %exitcond9.not, label %after_for.loopexit, label %for_loop_body.us

for_loop_body:                                    ; preds = %after_if6, %for_loop_body.preheader
  %.057 = phi i32 [ %93, %after_if6 ], [ %16, %for_loop_body.preheader ]
  %61 = load ptr, ptr %3, align 8
  %62 = getelementptr inbounds nuw i8, ptr %61, i64 32872
  ...
  %70 = icmp ne i32 %.057, %67
  %71 = and i1 %69, %70
  %.neg6 = sext i1 %71 to i32
  %72 = add i32 %66, %.neg6
  ...
  %79 = getelementptr float, ptr %73, i64 %78
  %80 = load float, ptr %79, align 4
  %81 = fcmp reassoc ninf nsz ogt float %80, %21
  %.pre = load ptr, ptr %0, align 8
  br i1 %81, label %after_if6, label %false_block5
...
false_block5:                                     ; preds = %for_loop_body
  %82 = getelementptr i8, ptr %.pre, i64 36
  %83 = load float, ptr %82, align 4
  br label %after_if6

after_if6:                                        ; preds = %false_block5, %for_loop_body
  %.1 = phi float [ 0.000000e+00, %for_loop_body ], [ %83, %false_block5 ]
  %84 = getelementptr i8, ptr %.pre, i64 24
  %85 = load ptr, ptr %84, align 8
  %86 = getelementptr i8, ptr %.pre, i64 20
  ...
  store float %.1, ptr %92, align 4
  %93 = add nsw i32 %.057, 1
  %exitcond.not = icmp eq i32 %18, %93
  br i1 %exitcond.not, label %after_for.loopexit14, label %for_loop_body
}
