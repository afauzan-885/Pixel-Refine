...
%struct.RuntimeContext.90 = type { ptr, ptr, i32, ptr }
%struct.LLVMRuntime.89 = type { %struct.PreallocatedMemoryChunk.85, %struct.PreallocatedMemoryChunk.85, ptr, ptr, ptr, ptr, ptr, [512 x ptr], [512 x i64], ptr, ptr, [1024 x ptr], [1024 x ptr], [1024 x ptr], ptr, ptr, ptr, ptr, ptr, [2048 x i8], [32 x i64], i32, i64, ptr, i32, i32, i64 }
%struct.PreallocatedMemoryChunk.85 = type { ptr, ptr, i64 }

; Function Attrs: mustprogress nofree nosync nounwind willreturn
define void @_mlri_admm_rgb_half_res_fused_kernel_c94_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast ptr %context to ptr
  %1 = load ptr, ptr %0, align 8
  %2 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %1, i64 0, i32 8
  %3 = load float, ptr %2, align 4
  %4 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %1, i64 0, i32 7
  %5 = load float, ptr %4, align 4
  %6 = getelementptr inbounds %struct.RuntimeContext.90, ptr %context, i64 0, i32 1
  %7 = load ptr, ptr %6, align 8
  %8 = getelementptr inbounds %struct.LLVMRuntime.89, ptr %7, i64 0, i32 14
  ...
  %16 = getelementptr inbounds %struct.LLVMRuntime.89, ptr %15, i64 0, i32 14
  %17 = load ptr, ptr %16, align 8
  %18 = getelementptr inbounds i8, ptr %17, i64 12
  %19 = bitcast ptr %18 to ptr
  store float %14, ptr %19, align 4
  %20 = load ptr, ptr %0, align 8
  %21 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %20, i64 0, i32 9
  ...
  %30 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %20, i64 0, i32 10
  ...
  %40 = getelementptr inbounds %struct.LLVMRuntime.89, ptr %39, i64 0, i32 14
  ...
  %46 = getelementptr inbounds %struct.LLVMRuntime.89, ptr %45, i64 0, i32 14
...
define void @_mlri_admm_rgb_half_res_fused_kernel_c94_0_kernel_1_range_for(ptr %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  ...
  %9 = getelementptr inbounds %struct.RuntimeContext.90, ptr %context, i64 0, i32 1
  %10 = load ptr, ptr %9, align 8
  %11 = getelementptr inbounds %struct.LLVMRuntime.89, ptr %10, i64 0, i32 10
  %12 = load ptr, ptr %11, align 8
  %13 = getelementptr inbounds %struct.LLVMRuntime.89, ptr %10, i64 0, i32 9
...
allocs:
  %3 = getelementptr inbounds %struct.RuntimeContext.90, ptr %0, i64 0, i32 1
  %4 = load ptr, ptr %3, align 8
  %5 = getelementptr inbounds %struct.LLVMRuntime.89, ptr %4, i64 0, i32 14
  ...
  %22 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 11
  %23 = load i32, ptr %22, align 4
  %24 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 12
  %25 = load i32, ptr %24, align 4
  %26 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 13
  %27 = load i32, ptr %26, align 4
  %28 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 14
  %29 = load i32, ptr %28, align 4
  %30 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 3
  %31 = load float, ptr %30, align 4
  %32 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 4
  %33 = load float, ptr %32, align 4
  %34 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 6
  %35 = load float, ptr %34, align 4
  %36 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 5
  %37 = load float, ptr %36, align 4
  %38 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 1, i32 1
  %39 = load ptr, ptr %38, align 8
  %40 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 1, i32 0, i32 1
  %41 = load i32, ptr %40, align 4
  %42 = getelementptr float, ptr %39, i64 1
  %43 = getelementptr float, ptr %39, i64 2
  %44 = sext i32 %41 to i64
  %45 = getelementptr float, ptr %39, i64 %44
  %46 = add i32 %41, 1
  %47 = sext i32 %46 to i64
  %48 = getelementptr float, ptr %39, i64 %47
  %49 = add i32 %41, 2
  %50 = sext i32 %49 to i64
  %51 = getelementptr float, ptr %39, i64 %50
  %52 = shl i32 %41, 1
  %53 = sext i32 %52 to i64
  %54 = getelementptr float, ptr %39, i64 %53
  %55 = getelementptr float, ptr %54, i64 1
  %56 = add i32 %52, 2
  %57 = sext i32 %56 to i64
  %58 = getelementptr float, ptr %39, i64 %57
  %59 = icmp slt i32 %17, %19
  br i1 %59, label %for_loop_body.lr.ph, label %after_for

for_loop_body.lr.ph:                              ; preds = %allocs
  %60 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 0, i32 1
  %61 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 0, i32 0, i32 1
  %62 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 2, i32 1
  %63 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 2, i32 0, i32 1
  %64 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, { { i32, i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %21, i64 0, i32 2, i32 0, i32 2
  %65 = shl i32 %17, 1
...
for_loop_body:                                    ; preds = %after_if27, %for_loop_body.lr.ph
  ...
  %67 = getelementptr inbounds %struct.LLVMRuntime.89, ptr %66, i64 0, i32 14
  ...
  %104 = getelementptr float, ptr %82, i64 %103
  ...
  %116 = getelementptr float, ptr %82, i64 %115
  ...
  %124 = getelementptr float, ptr %82, i64 %123
...
after_if27:                                       ; preds = %false_block32, %true_block31, %true_block28, %after_if18
  ...
  %222 = getelementptr float, ptr %214, i64 %221
  store float %213, ptr %222, align 4
  ...
  %242 = getelementptr float, ptr %233, i64 %241
  ...
  %262 = getelementptr float, ptr %253, i64 %261
...
7:                                                ; preds = %6, %3
  ...
  %10 = getelementptr inbounds %struct.RuntimeContext.90, ptr %4, i64 0, i32 2
