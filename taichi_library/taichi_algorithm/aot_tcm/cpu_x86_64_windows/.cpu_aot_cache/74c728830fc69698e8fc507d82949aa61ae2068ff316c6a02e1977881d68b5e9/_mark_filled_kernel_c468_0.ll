...
define void @_mark_filled_kernel_c468_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_mark_filled_kernel_c468_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %58, %after_if ]
  ...
  %45 = fsub reassoc ninf nsz float %44, %21
  %46 = tail call noundef float @llvm.fabs.f32(float %45)
  %47 = fcmp reassoc ninf nsz olt float %46, 5.000000e-01
...
true_block:                                       ; preds = %for_loop_body
  ...
  %57 = getelementptr float, ptr %50, i64 %56
