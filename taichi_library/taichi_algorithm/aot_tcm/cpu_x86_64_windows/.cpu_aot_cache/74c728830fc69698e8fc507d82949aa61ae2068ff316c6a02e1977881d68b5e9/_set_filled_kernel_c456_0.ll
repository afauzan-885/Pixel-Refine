...
define void @_set_filled_kernel_c456_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_set_filled_kernel_c456_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.046 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %53, %for_loop_body ]
  ...
  %45 = fcmp reassoc ninf nsz ogt float %44, 5.000000e-01
  %.0 = select i1 %45, float 0.000000e+00, float 1.000000e+00
