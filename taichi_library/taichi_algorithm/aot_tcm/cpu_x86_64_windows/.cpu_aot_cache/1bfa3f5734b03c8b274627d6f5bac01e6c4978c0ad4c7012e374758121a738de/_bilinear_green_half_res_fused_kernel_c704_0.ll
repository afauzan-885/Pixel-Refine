...
define void @_bilinear_green_half_res_fused_kernel_c704_0_kernel_0_serial(%struct.RuntimeContext.36* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.36* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
  ...
  %15 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %6, align 8
  ...
  %39 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %6, align 8
  %40 = getelementptr inbounds %struct.LLVMRuntime.35, %struct.LLVMRuntime.35* %39, i64 0, i32 14
  %41 = load i8*, i8** %40, align 8
  %42 = getelementptr inbounds i8, i8* %41, i64 4
  %43 = bitcast i8* %42 to i32*
  store i32 %38, i32* %43, align 4
  %44 = mul i32 %38, %29
  %45 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %6, align 8
  %46 = getelementptr inbounds %struct.LLVMRuntime.35, %struct.LLVMRuntime.35* %45, i64 0, i32 14
...
define void @_bilinear_green_half_res_fused_kernel_c704_0_kernel_1_range_for(%struct.RuntimeContext.36* %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.36* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }**
  %22 = shl i32 %17, 1
...
for_loop_body:                                    ; preds = %after_if72, %for_loop_body.lr.ph
  ...
  %24 = load %struct.LLVMRuntime.35*, %struct.LLVMRuntime.35** %3, align 8
