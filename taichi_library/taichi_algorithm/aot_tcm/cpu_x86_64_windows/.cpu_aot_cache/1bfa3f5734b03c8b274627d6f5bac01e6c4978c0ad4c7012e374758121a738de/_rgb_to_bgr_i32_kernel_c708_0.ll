...
define void @_rgb_to_bgr_i32_kernel_c708_0_kernel_0_serial(%struct.RuntimeContext.60* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.60* %context to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, i32* }, i32, i32 }**
...
define void @_rgb_to_bgr_i32_kernel_c708_0_kernel_1_range_for(%struct.RuntimeContext.60* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.60* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, i32* }, i32, i32 }**
