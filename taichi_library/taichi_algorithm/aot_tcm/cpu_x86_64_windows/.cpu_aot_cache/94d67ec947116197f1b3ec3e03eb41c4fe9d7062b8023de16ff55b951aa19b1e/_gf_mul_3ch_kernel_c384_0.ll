...
define void @_gf_mul_3ch_kernel_c384_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_gf_mul_3ch_kernel_c384_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body.lr.ph:                              ; preds = %allocs
  ...
  %26 = getelementptr i8, ptr %20, i64 48
  %27 = getelementptr i8, ptr %20, i64 44
  %28 = getelementptr i8, ptr %20, i64 64
  %29 = getelementptr i8, ptr %20, i64 60
  %30 = getelementptr i8, ptr %20, i64 80
  %31 = getelementptr i8, ptr %20, i64 76
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %108, %for_loop_body ]
  ...
  %60 = getelementptr float, ptr %52, i64 %59
  %61 = load float, ptr %60, align 4
  %62 = fmul reassoc ninf nsz float %61, %51
  ...
  %81 = fmul reassoc ninf nsz float %80, %51
  ...
  %88 = getelementptr float, ptr %82, i64 %87
  ...
  %100 = fmul reassoc ninf nsz float %99, %51
  ...
  %exitcond.not = icmp eq i32 %18, %108
