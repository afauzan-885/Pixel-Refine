...
define void @_gf_compute_a_kernel_c378_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_gf_compute_a_kernel_c378_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %66, %for_loop_body ]
  ...
  %57 = fadd reassoc ninf nsz float %56, %21
  %58 = fdiv reassoc ninf nsz float %48, %57
  ...
  store float %58, ptr %65, align 4
  %66 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %18, %66
