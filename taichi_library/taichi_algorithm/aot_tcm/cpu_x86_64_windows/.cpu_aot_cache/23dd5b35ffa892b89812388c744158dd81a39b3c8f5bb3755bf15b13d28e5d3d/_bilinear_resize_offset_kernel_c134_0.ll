...
define void @_bilinear_resize_offset_kernel_c134_0_kernel_0_serial(%struct.RuntimeContext.24* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_bilinear_resize_offset_kernel_c134_0_kernel_1_range_for(%struct.RuntimeContext.24* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  ...
  %47 = insertelement <2 x i32> poison, i32 %39, i64 0
  %48 = shufflevector <2 x i32> %47, <2 x i32> poison, <2 x i32> zeroinitializer
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %136, %for_loop_body ]
  %49 = load %struct.LLVMRuntime.23*, %struct.LLVMRuntime.23** %3, align 8
  %50 = getelementptr inbounds %struct.LLVMRuntime.23, %struct.LLVMRuntime.23* %49, i64 0, i32 14
  ...
  %59 = icmp ne i32 %.06, 0
  %60 = icmp ne i32 %.06, %56
  %61 = and i1 %59, %58
  %62 = and i1 %61, %60
  %.neg4 = sext i1 %62 to i32
  %63 = add i32 %55, %.neg4
  %64 = add i32 %63, %23
  %65 = mul i32 %54, -1
  %66 = mul i32 %65, %63
  ...
  %72 = fdiv reassoc ninf nsz float %71, %35
  %73 = fadd reassoc ninf nsz float %72, -5.000000e-01
  %74 = sitofp i32 %68 to float
  %75 = fadd reassoc ninf nsz float %74, 5.000000e-01
  %76 = fmul reassoc ninf nsz float %75, %36
  %77 = fdiv reassoc ninf nsz float %76, %37
  %78 = fadd reassoc ninf nsz float %77, -5.000000e-01
  %79 = tail call reassoc ninf nsz float @llvm.floor.f32(float %73)
  %80 = fptosi float %79 to i32
  %81 = tail call reassoc ninf nsz float @llvm.floor.f32(float %78)
  %82 = fptosi float %81 to i32
  %83 = sitofp i32 %80 to float
  %84 = fsub reassoc ninf nsz float %73, %83
  %85 = sitofp i32 %82 to float
  %86 = fsub reassoc ninf nsz float %78, %85
  %87 = add i32 %80, 1
  %88 = add i32 %82, 1
  %89 = load float*, float** %41, align 8
  %90 = load i32, i32* %42, align 4
  %91 = insertelement <2 x i32> poison, i32 %80, i64 0
  %92 = insertelement <2 x i32> %91, i32 %87, i64 1
  %93 = call <2 x i32> @llvm.smax.v2i32(<2 x i32> %92, <2 x i32> zeroinitializer)
  %94 = call <2 x i32> @llvm.smin.v2i32(<2 x i32> %46, <2 x i32> %93)
  %95 = insertelement <2 x i32> poison, i32 %82, i64 0
  %96 = insertelement <2 x i32> %95, i32 %88, i64 1
  %97 = call <2 x i32> @llvm.smax.v2i32(<2 x i32> %96, <2 x i32> zeroinitializer)
  %98 = call <2 x i32> @llvm.smin.v2i32(<2 x i32> %48, <2 x i32> %97)
  %shuffle7 = shufflevector <2 x i32> %98, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %99 = insertelement <2 x i32> poison, i32 %90, i64 0
  %100 = shufflevector <2 x i32> %99, <2 x i32> poison, <2 x i32> zeroinitializer
  %101 = mul <2 x i32> %94, %100
  %shuffle = shufflevector <2 x i32> %101, <2 x i32> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
  %102 = add <4 x i32> %shuffle, %shuffle7
  %103 = extractelement <4 x i32> %102, i64 0
  %104 = sext i32 %103 to i64
  %105 = getelementptr float, float* %89, i64 %104
  %106 = load float, float* %105, align 4
  %107 = extractelement <4 x i32> %102, i64 1
  %108 = sext i32 %107 to i64
  %109 = getelementptr float, float* %89, i64 %108
  %110 = load float, float* %109, align 4
  %111 = extractelement <4 x i32> %102, i64 2
  %112 = sext i32 %111 to i64
  %113 = getelementptr float, float* %89, i64 %112
  %114 = load float, float* %113, align 4
  %115 = extractelement <4 x i32> %102, i64 3
  %116 = sext i32 %115 to i64
  %117 = getelementptr float, float* %89, i64 %116
  %118 = load float, float* %117, align 4
  %119 = fsub reassoc ninf nsz float 1.000000e+00, %86
  %120 = fmul reassoc ninf nsz float %119, %106
  %121 = fmul reassoc ninf nsz float %86, %110
  %122 = fadd reassoc ninf nsz float %120, %121
  %123 = fmul reassoc ninf nsz float %119, %114
  %124 = fmul reassoc ninf nsz float %86, %118
  %125 = fadd reassoc ninf nsz float %123, %124
  %126 = fsub reassoc ninf nsz float %125, %122
  %127 = fmul reassoc ninf nsz float %126, %84
  %128 = fadd reassoc ninf nsz float %127, %122
  %129 = load float*, float** %43, align 8
