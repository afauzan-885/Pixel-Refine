...
define void @_bilinear_resize_kernel_c128_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_bilinear_resize_kernel_c128_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %132, %for_loop_body ]
  %39 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %3, align 8
  %40 = getelementptr inbounds %struct.LLVMRuntime.5, %struct.LLVMRuntime.5* %39, i64 0, i32 14
  ...
  %59 = getelementptr inbounds i8, i8* %41, i64 8
  %60 = bitcast i8* %59 to i32*
  %61 = load i32, i32* %60, align 4
  %62 = sitofp i32 %61 to float
  %63 = fmul reassoc ninf nsz float %58, %26
  %64 = fdiv reassoc ninf nsz float %63, %62
  %65 = fadd reassoc ninf nsz float %64, -5.000000e-01
  %66 = sitofp i32 %56 to float
  %67 = fadd reassoc ninf nsz float %66, 5.000000e-01
  %68 = getelementptr inbounds i8, i8* %41, i64 12
  %69 = bitcast i8* %68 to i32*
  %70 = load i32, i32* %69, align 4
  %71 = sitofp i32 %70 to float
  %72 = fmul reassoc ninf nsz float %67, %27
  %73 = fdiv reassoc ninf nsz float %72, %71
  %74 = fadd reassoc ninf nsz float %73, -5.000000e-01
  %75 = tail call reassoc ninf nsz float @llvm.floor.f32(float %65)
  ...
  %82 = fsub reassoc ninf nsz float %65, %81
  %83 = sitofp i32 %78 to float
  %84 = fsub reassoc ninf nsz float %74, %83
  %85 = load float*, float** %31, align 8
  %86 = load i32, i32* %32, align 4
  %87 = insertelement <2 x i32> poison, i32 %76, i64 0
  %88 = insertelement <2 x i32> %87, i32 %79, i64 1
  %89 = call <2 x i32> @llvm.smax.v2i32(<2 x i32> %88, <2 x i32> zeroinitializer)
  %90 = call <2 x i32> @llvm.smin.v2i32(<2 x i32> %36, <2 x i32> %89)
  %91 = insertelement <2 x i32> poison, i32 %78, i64 0
  %92 = insertelement <2 x i32> %91, i32 %80, i64 1
  %93 = call <2 x i32> @llvm.smax.v2i32(<2 x i32> %92, <2 x i32> zeroinitializer)
  %94 = call <2 x i32> @llvm.smin.v2i32(<2 x i32> %38, <2 x i32> %93)
  %shuffle7 = shufflevector <2 x i32> %94, <2 x i32> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %95 = insertelement <2 x i32> poison, i32 %86, i64 0
  %96 = shufflevector <2 x i32> %95, <2 x i32> poison, <2 x i32> zeroinitializer
  %97 = mul <2 x i32> %90, %96
  %shuffle = shufflevector <2 x i32> %97, <2 x i32> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
  %98 = add <4 x i32> %shuffle, %shuffle7
  %99 = extractelement <4 x i32> %98, i64 0
  %100 = sext i32 %99 to i64
  %101 = getelementptr float, float* %85, i64 %100
  %102 = load float, float* %101, align 4
  %103 = extractelement <4 x i32> %98, i64 1
  %104 = sext i32 %103 to i64
  %105 = getelementptr float, float* %85, i64 %104
  %106 = load float, float* %105, align 4
  %107 = extractelement <4 x i32> %98, i64 2
  %108 = sext i32 %107 to i64
  %109 = getelementptr float, float* %85, i64 %108
  %110 = load float, float* %109, align 4
  %111 = extractelement <4 x i32> %98, i64 3
  %112 = sext i32 %111 to i64
  %113 = getelementptr float, float* %85, i64 %112
  %114 = load float, float* %113, align 4
  %115 = fsub reassoc ninf nsz float 1.000000e+00, %84
  %116 = fmul reassoc ninf nsz float %115, %102
  %117 = fmul reassoc ninf nsz float %84, %106
  %118 = fadd reassoc ninf nsz float %116, %117
  %119 = fmul reassoc ninf nsz float %115, %110
  %120 = fmul reassoc ninf nsz float %84, %114
  %121 = fadd reassoc ninf nsz float %119, %120
  %122 = fsub reassoc ninf nsz float %121, %118
  %123 = fmul reassoc ninf nsz float %122, %82
  %124 = fadd reassoc ninf nsz float %123, %118
  %125 = load float*, float** %33, align 8
  ...
  %exitcond.not = icmp eq i32 %19, %132
