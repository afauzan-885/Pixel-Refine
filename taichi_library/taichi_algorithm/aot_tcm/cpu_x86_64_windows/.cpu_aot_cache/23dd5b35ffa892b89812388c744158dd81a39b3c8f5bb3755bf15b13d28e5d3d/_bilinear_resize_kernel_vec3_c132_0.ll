...
define void @_bilinear_resize_kernel_vec3_c132_0_kernel_0_serial(%struct.RuntimeContext* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_bilinear_resize_kernel_vec3_c132_0_kernel_1_range_for(%struct.RuntimeContext* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %.05 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %201, %for_loop_body ]
  ...
  %72 = tail call reassoc ninf nsz float @llvm.floor.f32(float %62)
  %73 = fptosi float %72 to i32
  %74 = tail call reassoc ninf nsz float @llvm.floor.f32(float %71)
  %75 = fptosi float %74 to i32
  %76 = tail call i32 @llvm.smax.i32(i32 %73, i32 0)
  %77 = tail call i32 @llvm.smin.i32(i32 %28, i32 %76)
  %78 = tail call i32 @llvm.smax.i32(i32 %75, i32 0)
  %79 = tail call i32 @llvm.smin.i32(i32 %29, i32 %78)
  %80 = add i32 %73, 1
  %81 = tail call i32 @llvm.smax.i32(i32 %80, i32 0)
  %82 = tail call i32 @llvm.smin.i32(i32 %28, i32 %81)
  %83 = add i32 %75, 1
  %84 = tail call i32 @llvm.smax.i32(i32 %83, i32 0)
  %85 = tail call i32 @llvm.smin.i32(i32 %29, i32 %84)
  %86 = sitofp i32 %73 to float
  %87 = fsub reassoc ninf nsz float %62, %86
  %88 = sitofp i32 %75 to float
  %89 = fsub reassoc ninf nsz float %71, %88
  ...
  %109 = getelementptr float, float* %90, i64 %108
  %110 = load float, float* %109, align 4
  %111 = add i32 %107, 1
  %112 = sext i32 %111 to i64
  %113 = getelementptr float, float* %90, i64 %112
  %114 = load float, float* %113, align 4
  %115 = add i32 %107, 2
  %116 = sext i32 %115 to i64
  %117 = getelementptr float, float* %90, i64 %116
  %118 = load float, float* %117, align 4
  %119 = mul i32 %82, %91
  %120 = add i32 %119, %79
  %121 = mul i32 %120, 3
  %122 = sext i32 %121 to i64
  %123 = getelementptr float, float* %90, i64 %122
  %124 = load float, float* %123, align 4
  %125 = add i32 %121, 1
  %126 = sext i32 %125 to i64
  %127 = getelementptr float, float* %90, i64 %126
  %128 = load float, float* %127, align 4
  %129 = add i32 %121, 2
  %130 = sext i32 %129 to i64
  %131 = getelementptr float, float* %90, i64 %130
  %132 = load float, float* %131, align 4
  %133 = add i32 %85, %119
  %134 = mul i32 %133, 3
  %135 = sext i32 %134 to i64
  %136 = getelementptr float, float* %90, i64 %135
  %137 = load float, float* %136, align 4
  %138 = add i32 %134, 1
  %139 = sext i32 %138 to i64
  %140 = getelementptr float, float* %90, i64 %139
  %141 = load float, float* %140, align 4
  %142 = add i32 %134, 2
  %143 = sext i32 %142 to i64
  %144 = getelementptr float, float* %90, i64 %143
  %145 = load float, float* %144, align 4
  %146 = fsub reassoc ninf nsz float 1.000000e+00, %89
  %147 = fmul reassoc ninf nsz float %146, %97
  %148 = fmul reassoc ninf nsz float %146, %101
  %149 = fmul reassoc ninf nsz float %146, %105
  %150 = fmul reassoc ninf nsz float %89, %110
  %151 = fmul reassoc ninf nsz float %89, %114
  %152 = fmul reassoc ninf nsz float %89, %118
  %153 = fadd reassoc ninf nsz float %147, %150
  %154 = fadd reassoc ninf nsz float %148, %151
  %155 = fadd reassoc ninf nsz float %149, %152
  %156 = fmul reassoc ninf nsz float %146, %124
  %157 = fmul reassoc ninf nsz float %146, %128
  %158 = fmul reassoc ninf nsz float %146, %132
  %159 = fmul reassoc ninf nsz float %89, %137
  %160 = fmul reassoc ninf nsz float %89, %141
  %161 = fmul reassoc ninf nsz float %145, %89
  %162 = fadd reassoc ninf nsz float %156, %159
  %163 = fadd reassoc ninf nsz float %157, %160
  %164 = fadd reassoc ninf nsz float %158, %161
  %165 = fsub reassoc ninf nsz float 1.000000e+00, %87
  %166 = fmul reassoc ninf nsz float %153, %165
  %167 = fmul reassoc ninf nsz float %154, %165
  %168 = fmul reassoc ninf nsz float %155, %165
  %169 = fmul reassoc ninf nsz float %162, %87
  %170 = fmul reassoc ninf nsz float %163, %87
  %171 = fmul reassoc ninf nsz float %164, %87
  %172 = fadd reassoc ninf nsz float %166, %169
  %173 = fadd reassoc ninf nsz float %167, %170
  %174 = fadd reassoc ninf nsz float %168, %171
  %175 = load float*, float** %33, align 8
  %176 = load i32, i32* %34, align 4
  %177 = sub i32 %176, %41
  %178 = mul i32 %177, 3
  %179 = mul i32 %178, %50
  %180 = add i32 %lsr.iv, %179
  %181 = sext i32 %180 to i64
  %182 = getelementptr float, float* %175, i64 %181
  store float %172, float* %182, align 4
  %183 = load float*, float** %33, align 8
  %184 = load i32, i32* %34, align 4
  %185 = sub i32 %184, %41
  %186 = mul i32 %185, 3
  %187 = mul i32 %186, %50
  %188 = add i32 %lsr.iv, %187
  %189 = add i32 %188, 1
  %190 = sext i32 %189 to i64
  %191 = getelementptr float, float* %183, i64 %190
  store float %173, float* %191, align 4
  %192 = load float*, float** %33, align 8
  %193 = load i32, i32* %34, align 4
  %194 = sub i32 %193, %41
  %195 = mul i32 %194, 3
  %196 = mul i32 %195, %50
  %197 = add i32 %lsr.iv, %196
  %198 = add i32 %197, 2
  %199 = sext i32 %198 to i64
  %200 = getelementptr float, float* %192, i64 %199
  store float %174, float* %200, align 4
  %201 = add nsw i32 %.05, 1
  %lsr.iv.next = add i32 %lsr.iv, 3
  %exitcond.not = icmp eq i32 %19, %201
