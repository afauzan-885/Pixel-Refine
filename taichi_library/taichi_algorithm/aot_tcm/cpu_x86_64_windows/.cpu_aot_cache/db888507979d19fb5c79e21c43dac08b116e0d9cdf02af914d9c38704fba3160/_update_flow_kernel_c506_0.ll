...
define void @_update_flow_kernel_c506_0_kernel_0_serial(%struct.RuntimeContext.60* nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_update_flow_kernel_c506_0_kernel_1_range_for(%struct.RuntimeContext.60* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %102, %for_loop_body ]
  ...
  %70 = fmul reassoc ninf nsz float %61, %53
  %71 = fmul reassoc ninf nsz float %57, %57
  %72 = fsub reassoc ninf nsz float 0x3F50624DE0000000, %71
  %73 = fadd reassoc ninf nsz float %72, %70
  %74 = fdiv reassoc ninf nsz float 1.000000e+00, %73
  %75 = fmul reassoc ninf nsz float %69, %53
  %76 = fmul reassoc ninf nsz float %65, %57
  %77 = fsub reassoc ninf nsz float %75, %76
  %78 = fmul reassoc ninf nsz float %77, %74
  %79 = load float*, float** %26, align 8
  ...
  %87 = getelementptr float, float* %79, i64 %86
  store float %78, float* %87, align 4
  %88 = fmul reassoc ninf nsz float %65, %61
  %89 = fmul reassoc ninf nsz float %69, %57
  %90 = fsub reassoc ninf nsz float %88, %89
  %91 = fmul reassoc ninf nsz float %90, %74
  ...
  %101 = getelementptr float, float* %92, i64 %100
  store float %91, float* %101, align 4
