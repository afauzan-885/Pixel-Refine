...
define void @_upsample_flow_kernel_c264_0_kernel_0_serial(%struct.RuntimeContext.72* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.72* %context to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float }**
  ...
  %21 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %4, align 8
  %22 = getelementptr inbounds %struct.LLVMRuntime.71, %struct.LLVMRuntime.71* %21, i64 0, i32 14
  ...
  %29 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %4, align 8
  ...
  %36 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %4, align 8
  %37 = getelementptr inbounds %struct.LLVMRuntime.71, %struct.LLVMRuntime.71* %36, i64 0, i32 14
  %38 = load i8*, i8** %37, align 8
  %39 = getelementptr inbounds i8, i8* %38, i64 4
  %40 = bitcast i8* %39 to i32*
  store i32 %35, i32* %40, align 4
  %41 = mul i32 %35, %34
  %42 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %4, align 8
  %43 = getelementptr inbounds %struct.LLVMRuntime.71, %struct.LLVMRuntime.71* %42, i64 0, i32 14
...
define void @_upsample_flow_kernel_c264_0_kernel_1_range_for(%struct.RuntimeContext.72* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.72* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32, i32 }, float* }, float }**
