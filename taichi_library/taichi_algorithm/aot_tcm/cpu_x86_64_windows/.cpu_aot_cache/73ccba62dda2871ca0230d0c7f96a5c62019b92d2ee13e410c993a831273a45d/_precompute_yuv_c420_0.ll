...
define void @_precompute_yuv_c420_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_precompute_yuv_c420_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %91, %for_loop_body ]
  ...
  %57 = fadd reassoc ninf nsz float %52, %48
  %58 = fadd reassoc ninf nsz float %57, %56
  %59 = fmul reassoc ninf nsz float %58, 0x3FD5555560000000
  ...
  store float %59, ptr %68, align 4
  %69 = fsub reassoc ninf nsz float %48, %52
  ...
  %80 = fsub reassoc ninf nsz float %56, %52
  ...
  %91 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %18, %91
