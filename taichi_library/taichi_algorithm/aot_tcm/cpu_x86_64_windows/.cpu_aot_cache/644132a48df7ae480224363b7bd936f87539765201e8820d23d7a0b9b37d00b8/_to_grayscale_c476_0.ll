...
define void @_to_grayscale_c476_0_kernel_0_serial(%struct.RuntimeContext.72* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.72* %context to { { { i32, i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
define void @_to_grayscale_c476_0_kernel_1_range_for(%struct.RuntimeContext.72* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.72* %0 to { { { i32, i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %28 = load %struct.LLVMRuntime.71*, %struct.LLVMRuntime.71** %3, align 8
  ...
  %52 = getelementptr float, float* %43, i64 %51
  %53 = load float, float* %52, align 4
  %54 = fmul reassoc ninf nsz float %53, 0x3FD322D0E0000000
  %55 = add i32 %49, 1
  %56 = sext i32 %55 to i64
  %57 = getelementptr float, float* %43, i64 %56
  %58 = load float, float* %57, align 4
  %59 = fmul reassoc ninf nsz float %58, 0x3FE2C8B440000000
  %60 = fadd reassoc ninf nsz float %59, %54
  %61 = sext i32 %49 to i64
  %62 = getelementptr float, float* %43, i64 %61
  %63 = load float, float* %62, align 4
  %64 = fmul reassoc ninf nsz float %63, 0x3FBD2F1AA0000000
  %65 = fadd reassoc ninf nsz float %60, %64
