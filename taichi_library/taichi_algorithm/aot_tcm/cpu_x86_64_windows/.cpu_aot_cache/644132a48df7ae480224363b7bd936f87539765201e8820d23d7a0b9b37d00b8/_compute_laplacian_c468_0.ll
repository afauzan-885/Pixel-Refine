...
define void @_compute_laplacian_c468_0_kernel_0_serial(%struct.RuntimeContext.24* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.24* %context to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
define void @_compute_laplacian_c468_0_kernel_1_range_for(%struct.RuntimeContext.24* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.24* %0 to { { { i32, i32 }, float* }, { { i32, i32 }, float* }, { { i32, i32 }, float* }, i32, i32 }**
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.07 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %99, %for_loop_body ]
  ...
  %52 = add i32 %51, -1
  %53 = tail call i32 @llvm.smax.i32(i32 %48, i32 0)
  %54 = tail call i32 @llvm.smin.i32(i32 %52, i32 %53)
  %55 = add i32 %43, -1
  %56 = getelementptr inbounds i8, i8* %31, i64 12
  ...
  %87 = getelementptr float, float* %75, i64 %86
  %88 = load float, float* %87, align 4
  %89 = fadd reassoc ninf nsz float %70, %82
  %90 = fadd reassoc ninf nsz float %74, %88
  %91 = fsub reassoc ninf nsz float %89, %90
  ...
  %98 = getelementptr float, float* %92, i64 %97
  store float %91, float* %98, align 4
  %99 = add nsw i32 %.07, 1
  %exitcond.not = icmp eq i32 %19, %99
