...
define void @_bg_clear_grid_c242_0_kernel_0_serial(%struct.RuntimeContext.6* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.6* %context to { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }**
  %1 = load { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }*, { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }** %0, align 8
  %2 = getelementptr { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }, { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }* %1, i64 0, i32 1
  %3 = load i32, i32* %2, align 4
  %4 = tail call i32 @llvm.smax.i32(i32 %3, i32 0)
  %5 = getelementptr { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }, { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }* %1, i64 0, i32 2
  %6 = load i32, i32* %5, align 4
  %7 = tail call i32 @llvm.smax.i32(i32 %6, i32 0)
  %8 = getelementptr { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }, { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }* %1, i64 0, i32 3
  %9 = load i32, i32* %8, align 4
  %10 = tail call i32 @llvm.smax.i32(i32 %9, i32 0)
  %11 = getelementptr inbounds %struct.RuntimeContext.6, %struct.RuntimeContext.6* %context, i64 0, i32 1
  %12 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %11, align 8
  %13 = getelementptr inbounds %struct.LLVMRuntime.5, %struct.LLVMRuntime.5* %12, i64 0, i32 14
  %14 = load i8*, i8** %13, align 8
  %15 = getelementptr inbounds i8, i8* %14, i64 8
  %16 = bitcast i8* %15 to i32*
  store i32 %10, i32* %16, align 4
  %17 = mul i32 %10, %7
  %18 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %11, align 8
  %19 = getelementptr inbounds %struct.LLVMRuntime.5, %struct.LLVMRuntime.5* %18, i64 0, i32 14
  %20 = load i8*, i8** %19, align 8
  %21 = getelementptr inbounds i8, i8* %20, i64 4
  %22 = bitcast i8* %21 to i32*
  store i32 %17, i32* %22, align 4
  %23 = mul i32 %17, %4
  %24 = load %struct.LLVMRuntime.5*, %struct.LLVMRuntime.5** %11, align 8
...
define void @_bg_clear_grid_c242_0_kernel_1_range_for(%struct.RuntimeContext.6* %context) local_unnamed_addr #1 {
entry:
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %21 = bitcast %struct.RuntimeContext.6* %0 to { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }**
  %22 = load { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }*, { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }** %21, align 8
  %23 = getelementptr { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }, { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }* %22, i64 0, i32 0, i32 1
  %24 = getelementptr { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }, { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }* %22, i64 0, i32 0, i32 0, i32 1
  %25 = getelementptr { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }, { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }* %22, i64 0, i32 0, i32 0, i32 2
  %26 = getelementptr { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }, { { { i32, i32, i32, i32 }, float* }, i32, i32, i32 }* %22, i64 0, i32 0, i32 0, i32 3
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %17, %for_loop_body.lr.ph ], [ %84, %for_loop_body ]
  ...
  %53 = icmp ne i32 %.06, %42
  %54 = icmp ne i32 %45, %50
  %55 = and i1 %53, %52
  %56 = and i1 %54, %55
  ...
  %83 = getelementptr float, float* %71, i64 %82
