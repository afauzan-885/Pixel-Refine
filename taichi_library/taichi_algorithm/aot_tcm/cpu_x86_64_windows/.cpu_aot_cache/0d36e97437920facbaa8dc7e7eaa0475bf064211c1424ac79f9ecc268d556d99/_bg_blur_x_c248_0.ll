...
define void @_bg_blur_x_c246_0_kernel_0_serial(%struct.RuntimeContext.24* nocapture readonly %context) local_unnamed_addr #0 {
entry:
  %0 = bitcast %struct.RuntimeContext.24* %context to { { { i32, i32, i32, i32 }, float* }, { { i32, i32, i32, i32 }, float* }, i32, float, i32, i32, i32 }**
  ...
  %16 = load %struct.LLVMRuntime.23*, %struct.LLVMRuntime.23** %7, align 8
  ...
  %22 = load { { { i32, i32, i32, i32 }, float* }, { { i32, i32, i32, i32 }, float* }, i32, float, i32, i32, i32 }*, { { { i32, i32, i32, i32 }, float* }, { { i32, i32, i32, i32 }, float* }, i32, float, i32, i32, i32 }** %0, align 8
  %23 = getelementptr { { { i32, i32, i32, i32 }, float* }, { { i32, i32, i32, i32 }, float* }, i32, float, i32, i32, i32 }, { { { i32, i32, i32, i32 }, float* }, { { i32, i32, i32, i32 }, float* }, i32, float, i32, i32, i32 }* %22, i64 0, i32 5
  %24 = load i32, i32* %23, align 4
  %25 = tail call i32 @llvm.smax.i32(i32 %24, i32 0)
  %26 = getelementptr { { { i32, i32, i32, i32 }, float* }, { { i32, i32, i32, i32 }, float* }, i32, float, i32, i32, i32 }, { { { i32, i32, i32, i32 }, float* }, { { i32, i32, i32, i32 }, float* }, i32, float, i32, i32, i32 }* %22, i64 0, i32 6
  %27 = load i32, i32* %26, align 4
  %28 = tail call i32 @llvm.smax.i32(i32 %27, i32 0)
  %29 = load %struct.LLVMRuntime.23*, %struct.LLVMRuntime.23** %7, align 8
  ...
  %34 = mul i32 %28, %25
  %35 = load %struct.LLVMRuntime.23*, %struct.LLVMRuntime.23** %7, align 8
  ...
  %40 = mul i32 %34, %21
  %41 = load %struct.LLVMRuntime.23*, %struct.LLVMRuntime.23** %7, align 8
...
define void @_bg_blur_x_c246_0_kernel_1_range_for(%struct.RuntimeContext.24* %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
  %1 = bitcast %0* %0 to i8*
...
allocs:
  ...
  %20 = bitcast %struct.RuntimeContext.24* %0 to { { { i32, i32, i32, i32 }, float* }, { { i32, i32, i32, i32 }, float* }, i32, float, i32, i32, i32 }**
...
for_loop_body1:                                   ; preds = %for_loop_body1, %for_loop_body1.preheader
  ...
  %77 = load %struct.LLVMRuntime.23*, %struct.LLVMRuntime.23** %3, align 8
  %78 = getelementptr inbounds %struct.LLVMRuntime.23, %struct.LLVMRuntime.23* %77, i64 0, i32 14
