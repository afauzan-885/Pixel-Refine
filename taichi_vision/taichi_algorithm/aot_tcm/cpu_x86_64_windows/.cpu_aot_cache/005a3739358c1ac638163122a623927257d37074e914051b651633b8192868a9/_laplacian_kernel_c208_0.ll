...
define void @_laplacian_kernel_c208_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_laplacian_kernel_c208_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %99, %for_loop_body ]
  ...
  %57 = getelementptr float, ptr %38, i64 %56
  %58 = load float, ptr %57, align 4
  %59 = add i32 %36, 1
  %60 = tail call i32 @llvm.smax.i32(i32 %59, i32 0)
  %61 = tail call i32 @llvm.smin.i32(i32 %50, i32 %60)
  %62 = mul i32 %61, %39
  %63 = sub i32 %62, %37
  %64 = add i32 %.06, %63
  %65 = sext i32 %64 to i64
  %66 = getelementptr float, ptr %38, i64 %65
  ...
  %83 = tail call i32 @llvm.smin.i32(i32 %74, i32 %82)
  %84 = add i32 %83, %40
  %85 = sext i32 %84 to i64
  %86 = getelementptr float, ptr %38, i64 %85
  %87 = load float, ptr %86, align 4
  %.neg5 = fmul reassoc ninf nsz float %46, -4.000000e+00
  %88 = fadd reassoc ninf nsz float %58, %.neg5
  %89 = fadd reassoc ninf nsz float %88, %67
  %90 = fadd reassoc ninf nsz float %89, %80
  %91 = fadd reassoc ninf nsz float %90, %87
