...
%struct.LLVMRuntime.65 = type { %struct.PreallocatedMemoryChunk.61, %struct.PreallocatedMemoryChunk.61, ptr, ptr, ptr, ptr, ptr, [512 x ptr], [512 x i64], ptr, ptr, [1024 x ptr], [1024 x ptr], [1024 x ptr], ptr, ptr, ptr, ptr, ptr, [2048 x i8], [32 x i64], i32, i64, ptr, i32, i32, i64 }
%struct.PreallocatedMemoryChunk.61 = type { ptr, ptr, i64 }

; Function Attrs: mustprogress nofree nosync nounwind willreturn
define void @_mlri_admm_green_to_grayscale_1channel_fused_kernel_c90_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
  ...
  %6 = getelementptr inbounds %struct.RuntimeContext.66, ptr %context, i64 0, i32 1
  %7 = load ptr, ptr %6, align 8
  %8 = getelementptr inbounds %struct.LLVMRuntime.65, ptr %7, i64 0, i32 14
  ...
  %16 = getelementptr inbounds %struct.LLVMRuntime.65, ptr %15, i64 0, i32 14
  ...
  %24 = getelementptr inbounds %struct.LLVMRuntime.65, ptr %23, i64 0, i32 14
  ...
  %30 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %29, i64 0, i32 9
  %31 = load i32, ptr %30, align 4
  %32 = load ptr, ptr %6, align 8
  %33 = getelementptr inbounds %struct.LLVMRuntime.65, ptr %32, i64 0, i32 14
  ...
  %39 = getelementptr inbounds %struct.LLVMRuntime.65, ptr %38, i64 0, i32 14
  ...
  %45 = getelementptr inbounds %struct.LLVMRuntime.65, ptr %44, i64 0, i32 14
...
define void @_mlri_admm_green_to_grayscale_1channel_fused_kernel_c90_0_kernel_1_range_for(ptr %context) local_unnamed_addr #2 {
entry:
  %0 = alloca %0, align 8
  ...
  %9 = getelementptr inbounds %struct.RuntimeContext.66, ptr %context, i64 0, i32 1
  %10 = load ptr, ptr %9, align 8
  %11 = getelementptr inbounds %struct.LLVMRuntime.65, ptr %10, i64 0, i32 10
  %12 = load ptr, ptr %11, align 8
  %13 = getelementptr inbounds %struct.LLVMRuntime.65, ptr %10, i64 0, i32 9
...
allocs:
  %3 = getelementptr inbounds %struct.RuntimeContext.66, ptr %0, i64 0, i32 1
  %4 = load ptr, ptr %3, align 8
  %5 = getelementptr inbounds %struct.LLVMRuntime.65, ptr %4, i64 0, i32 14
...
after_if:                                         ; preds = %false_block5, %true_block4, %false_block2, %true_block1
  %.044.in = phi ptr [ %56, %true_block1 ], [ %57, %false_block2 ], [ %58, %true_block4 ], [ %59, %false_block5 ]
...
true_block1:                                      ; preds = %true_block
  %56 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 10
  br label %after_if

false_block2:                                     ; preds = %true_block
  %57 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 11
  br label %after_if

true_block4:                                      ; preds = %false_block
  %58 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 12
  br label %after_if

false_block5:                                     ; preds = %false_block
  %59 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 13
  br label %after_if

true_block10:                                     ; preds = %after_if, %after_if
  %60 = icmp eq i32 %.044, 1
  %61 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 0, i32 1
  %62 = load ptr, ptr %61, align 8
  %63 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 0, i32 0, i32 1
  %64 = load i32, ptr %63, align 4
  %65 = sub i32 %64, %28
  %66 = mul i32 %65, %37
  %67 = add i32 %.04583, %66
  %68 = sext i32 %67 to i64
  %69 = getelementptr float, ptr %62, i64 %68
  %70 = load float, ptr %69, align 4
  %71 = getelementptr inbounds i8, ptr %25, i64 8
  %72 = bitcast ptr %71 to ptr
  %73 = load float, ptr %72, align 4
  %74 = fsub reassoc ninf nsz float %70, %73
  %75 = getelementptr inbounds i8, ptr %25, i64 12
  ...
  %81 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 3
  %82 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 5
  %.040.in = select i1 %60, ptr %81, ptr %82
...
false_block11:                                    ; preds = %after_if
  ...
  %94 = getelementptr inbounds i8, ptr %25, i64 20
  %95 = bitcast ptr %94 to ptr
  %96 = load i32, ptr %95, align 4
  %97 = add i32 %96, -1
  %98 = add i32 %37, 1
  %99 = tail call i32 @llvm.smin.i32(i32 %97, i32 %98)
  %100 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 0, i32 1
  %101 = load ptr, ptr %100, align 8
  %102 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 0, i32 0, i32 1
  ...
  %111 = mul i32 %103, %93
  %112 = mul i32 %103, %99
  %113 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 10
  %114 = load i32, ptr %113, align 4
  %115 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 11
  %116 = load i32, ptr %115, align 4
  %117 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 12
  %118 = load i32, ptr %117, align 4
  %119 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 13
  %120 = load i32, ptr %119, align 4
  %121 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 3
  %122 = load float, ptr %121, align 4
  %123 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 5
  ...
  %151 = insertelement <4 x ptr> poison, ptr %101, i64 0
  %shuffle93 = shufflevector <4 x ptr> %151, <4 x ptr> poison, <4 x i32> zeroinitializer
  %152 = getelementptr float, <4 x ptr> %shuffle93, <4 x i64> %150
  %153 = call <4 x float> @llvm.masked.gather.v4f32.v4p0(<4 x ptr> %152, i32 4, <4 x i1> splat (i1 true), <4 x float> undef)
  ...
  %159 = call reassoc ninf nsz <4 x float> @llvm.minnum.v4f32(<4 x float> %158, <4 x float> splat (float 1.000000e+00))
  ...
  %173 = icmp eq <4 x i32> %172, splat (i32 1)
...
after_if12:                                       ; preds = %false_block11, %true_block10
  ...
  %180 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 1, i32 1
  %181 = load ptr, ptr %180, align 8
  %182 = getelementptr { { { i32, i32 }, ptr }, { { i32, i32 }, ptr }, float, float, float, float, float, float, i32, i32, i32, i32, i32, i32 }, ptr %55, i64 0, i32 1, i32 0, i32 1
  %183 = load i32, ptr %182, align 4
  %184 = sub i32 %183, %28
  %185 = mul i32 %184, %37
  %186 = add i32 %.04583, %185
  %187 = sext i32 %186 to i64
  %188 = getelementptr float, ptr %181, i64 %187
...
7:                                                ; preds = %6, %3
  ...
  %10 = getelementptr inbounds %struct.RuntimeContext.66, ptr %4, i64 0, i32 2
