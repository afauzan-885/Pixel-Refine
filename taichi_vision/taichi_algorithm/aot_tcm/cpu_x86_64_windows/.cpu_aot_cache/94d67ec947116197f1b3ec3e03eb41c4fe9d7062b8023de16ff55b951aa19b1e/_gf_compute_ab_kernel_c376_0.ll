...
define void @_gf_compute_ab_kernel_c376_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_gf_compute_ab_kernel_c376_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body.lr.ph:                              ; preds = %allocs
  ...
  %33 = getelementptr i8, ptr %19, i64 88
  %34 = getelementptr i8, ptr %19, i64 84
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %97, %for_loop_body ]
  ...
  %63 = fadd reassoc ninf nsz float %62, %21
  %64 = fdiv reassoc ninf nsz float %54, %63
  ...
  %78 = getelementptr float, ptr %72, i64 %77
  ...
  %88 = fmul reassoc ninf nsz float %87, %64
  %89 = fsub reassoc ninf nsz float %79, %88
