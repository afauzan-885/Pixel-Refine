...
define void @_real_to_complex_kernel_c278_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_real_to_complex_kernel_c278_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if3, %for_loop_body.preheader
  ...
  %.047 = phi i32 [ %72, %after_if3 ], [ %16, %for_loop_body.preheader ]
...
true_block:                                       ; preds = %for_loop_body
  %40 = getelementptr i8, ptr %.pre, i64 36
  %41 = load i32, ptr %40, align 4
  %42 = icmp slt i32 %38, %41
  br i1 %42, label %true_block1, label %after_if3

true_block1:                                      ; preds = %true_block
  %43 = getelementptr i8, ptr %.pre, i64 8
...
after_if3:                                        ; preds = %true_block1, %true_block, %for_loop_body
  %.sink13 = phi float [ %52, %true_block1 ], [ 0.000000e+00, %for_loop_body ], [ 0.000000e+00, %true_block ]
  %53 = getelementptr i8, ptr %.pre, i64 24
  %54 = load ptr, ptr %53, align 8
  %55 = getelementptr i8, ptr %.pre, i64 20
  ...
  store float %.sink13, ptr %62, align 4
  ...
  %71 = getelementptr float, ptr %63, i64 %70
