...
define void @_normalize_kernel_c276_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_normalize_kernel_c276_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %52, %for_loop_body ]
  ...
  %35 = icmp ne i32 %.06, %32
  %36 = and i1 %34, %35
  %.neg4 = sext i1 %36 to i32
  %37 = add i32 %31, %.neg4
  %38 = load ptr, ptr %23, align 8
  %39 = load i32, ptr %24, align 4
  %reass.add = sub i32 %39, %30
  %40 = shl i32 %reass.add, 1
  %41 = mul i32 %40, %37
  %42 = add i32 %lsr.iv, %41
  %43 = sext i32 %42 to i64
  %44 = getelementptr float, ptr %38, i64 %43
  %45 = load float, ptr %44, align 4
  %46 = add i32 %42, 1
  %47 = sext i32 %46 to i64
  %48 = getelementptr float, ptr %38, i64 %47
  %49 = load float, ptr %48, align 4
  %50 = fmul reassoc ninf nsz float %45, %21
  %51 = fmul reassoc ninf nsz float %49, %21
