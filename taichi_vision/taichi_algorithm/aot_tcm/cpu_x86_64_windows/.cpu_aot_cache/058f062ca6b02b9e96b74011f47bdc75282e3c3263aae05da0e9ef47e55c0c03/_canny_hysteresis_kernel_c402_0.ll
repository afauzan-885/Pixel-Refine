...
define void @_canny_hysteresis_kernel_c402_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_canny_hysteresis_kernel_c402_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.048 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %80, %after_if ]
  ...
  %32 = icmp ne i32 %.048, %29
  %33 = and i1 %31, %32
  %.neg5 = sext i1 %33 to i32
  %34 = add i32 %28, %.neg5
  %35 = mul i32 %27, -1
  %36 = mul i32 %35, %34
  %37 = add i32 %.048, %36
  ...
  %46 = fcmp reassoc ninf nsz oeq float %45, 1.280000e+02
  br i1 %46, label %true_block, label %after_if
...
true_block:                                       ; preds = %for_loop_body
  ...
  %64 = fcmp reassoc ninf nsz oeq float %63, 2.550000e+02
  %65 = tail call i32 @llvm.smax.i32(i32 %37, i32 0)
  %66 = tail call i32 @llvm.smin.i32(i32 %56, i32 %65)
  %67 = add i32 %59, %66
  %68 = sext i32 %67 to i64
  %69 = getelementptr float, ptr %38, i64 %68
  %70 = load float, ptr %69, align 4
  %71 = fcmp reassoc ninf nsz oeq float %70, 2.550000e+02
  %.1 = select i1 %71, i1 true, i1 %64
  %72 = add i32 %37, 1
  %73 = tail call i32 @llvm.smax.i32(i32 %72, i32 0)
  %74 = tail call i32 @llvm.smin.i32(i32 %56, i32 %73)
  %75 = add i32 %59, %74
  %76 = sext i32 %75 to i64
  %77 = getelementptr float, ptr %38, i64 %76
  %78 = load float, ptr %77, align 4
  %79 = fcmp reassoc ninf nsz oeq float %78, 2.550000e+02
  br i1 %79, label %true_block7, label %after_if9

after_if:                                         ; preds = %true_block25, %after_if21, %for_loop_body
  %80 = add nsw i32 %.048, 1
  %exitcond.not = icmp eq i32 %18, %80
...
after_if9:                                        ; preds = %true_block7, %true_block
  ...
  %81 = tail call i32 @llvm.smax.i32(i32 %34, i32 0)
  %82 = tail call i32 @llvm.smin.i32(i32 %50, i32 %81)
  %83 = mul i32 %82, %39
  %84 = add i32 %83, %58
  %85 = sext i32 %84 to i64
  %86 = getelementptr float, ptr %38, i64 %85
  %87 = load float, ptr %86, align 4
  %88 = fcmp reassoc ninf nsz oeq float %87, 2.550000e+02
  %.3 = select i1 %88, i1 true, i1 %.2
  %89 = add i32 %83, %74
  %90 = sext i32 %89 to i64
  %91 = getelementptr float, ptr %38, i64 %90
  %92 = load float, ptr %91, align 4
  %93 = fcmp reassoc ninf nsz oeq float %92, 2.550000e+02
  br i1 %93, label %true_block13, label %after_if15
...
after_if15:                                       ; preds = %true_block13, %after_if9
  ...
  %96 = tail call i32 @llvm.smin.i32(i32 %50, i32 %95)
  %97 = mul i32 %96, %39
  %98 = add i32 %97, %66
  %99 = sext i32 %98 to i64
  %100 = getelementptr float, ptr %38, i64 %99
  %101 = load float, ptr %100, align 4
  %102 = fcmp reassoc ninf nsz oeq float %101, 2.550000e+02
  br i1 %102, label %true_block25, label %after_if21

after_if21:                                       ; preds = %after_if15
  %103 = add i32 %97, %58
  %104 = sext i32 %103 to i64
  %105 = getelementptr float, ptr %38, i64 %104
  %106 = load float, ptr %105, align 4
  %107 = fcmp reassoc ninf nsz oeq float %106, 2.550000e+02
  %108 = add i32 %97, %74
  %109 = sext i32 %108 to i64
  %110 = getelementptr float, ptr %38, i64 %109
  %111 = load float, ptr %110, align 4
  %112 = fcmp reassoc ninf nsz oeq float %111, 2.550000e+02
  %113 = select i1 %112, i1 true, i1 %107
  %.7 = select i1 %113, i1 true, i1 %.4
  br i1 %.7, label %true_block25, label %after_if

true_block25:                                     ; preds = %after_if21, %after_if15
  store float 2.550000e+02, ptr %44, align 4
