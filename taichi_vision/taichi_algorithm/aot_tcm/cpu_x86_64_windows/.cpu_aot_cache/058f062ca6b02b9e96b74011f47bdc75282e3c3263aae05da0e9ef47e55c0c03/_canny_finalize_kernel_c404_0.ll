...
define void @_canny_finalize_kernel_c404_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_canny_finalize_kernel_c404_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %53, %for_loop_body ]
  ...
  %45 = fcmp reassoc ninf nsz oeq float %44, 2.550000e+02
  ...
  %. = select i1 %45, float 2.550000e+02, float 0.000000e+00
  store float %., ptr %52, align 4
  %53 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %18, %53
