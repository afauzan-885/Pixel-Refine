...
define void @_canny_threshold_kernel_c400_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_canny_threshold_kernel_c400_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %68, %after_if ]
  ...
  %45 = fcmp reassoc ninf nsz ult float %44, %21
  %46 = load ptr, ptr %0, align 8
  br i1 %45, label %false_block, label %true_block
...
false_block:                                      ; preds = %for_loop_body
  ...
  %58 = fcmp reassoc ninf nsz ult float %44, %57
  ...
  br i1 %58, label %false_block2, label %true_block1
...
true_block1:                                      ; preds = %false_block
  store float 1.280000e+02, ptr %67, align 4
  br label %after_if
