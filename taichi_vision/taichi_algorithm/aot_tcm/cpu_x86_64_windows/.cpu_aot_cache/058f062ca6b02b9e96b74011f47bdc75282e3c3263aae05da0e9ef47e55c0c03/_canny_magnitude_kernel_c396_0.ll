...
define void @_canny_magnitude_kernel_c396_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_canny_magnitude_kernel_c396_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %65, %for_loop_body ]
  ...
  %55 = tail call noundef float @llvm.fabs.f32(float %46)
  %56 = tail call noundef float @llvm.fabs.f32(float %54)
