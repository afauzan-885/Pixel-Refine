...
%struct.RuntimeContext.135 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_pad_reflect_kernel_3d_vector_c564_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_pad_reflect_kernel_3d_vector_c564_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %100, %for_loop_body ]
  ...
  %45 = xor i32 %.lobit, %39
  %.not.not = icmp slt i32 %45, %42
  %46 = shl i32 %42, 1
  %47 = xor i32 %45, -1
  %48 = add i32 %46, %47
  %49 = select i1 %.not.not, i32 %45, i32 %48
  %50 = add i32 %42, -1
  %51 = tail call i32 @llvm.smax.i32(i32 %49, i32 0)
  %52 = tail call i32 @llvm.smin.i32(i32 %50, i32 %51)
  %.lobit4 = ashr i32 %40, 31
  %53 = xor i32 %.lobit4, %40
  %.not.not5 = icmp slt i32 %53, %44
  %54 = shl i32 %44, 1
  %55 = xor i32 %53, -1
  %56 = add i32 %54, %55
  %57 = select i1 %.not.not5, i32 %53, i32 %56
  %58 = add i32 %44, -1
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.135, align 8
