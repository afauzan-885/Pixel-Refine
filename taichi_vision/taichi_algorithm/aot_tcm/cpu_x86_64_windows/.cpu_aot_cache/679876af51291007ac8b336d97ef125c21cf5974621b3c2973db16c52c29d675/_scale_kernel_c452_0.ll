...
define void @_scale_kernel_c452_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_scale_kernel_c452_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %44, %for_loop_body ]
  ...
  %reass.add = sub i32 %38, %29
  %reass.mul = mul i32 %reass.add, %36
  %39 = add i32 %.06, %reass.mul
  %40 = sext i32 %39 to i64
  %41 = getelementptr float, ptr %37, i64 %40
  %42 = load float, ptr %41, align 4
  %43 = fmul reassoc ninf nsz float %42, %21
  store float %43, ptr %41, align 4
  %44 = add nsw i32 %.06, 1
  %exitcond.not = icmp eq i32 %18, %44
