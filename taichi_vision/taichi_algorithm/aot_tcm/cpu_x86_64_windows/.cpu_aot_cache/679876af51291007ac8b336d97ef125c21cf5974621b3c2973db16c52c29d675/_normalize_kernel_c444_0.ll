...
define void @_normalize_kernel_c444_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_normalize_kernel_c444_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %75, %after_if ]
  ...
  %43 = fcmp reassoc ninf nsz ogt float %42, 0x3D71979980000000
...
true_block:                                       ; preds = %for_loop_body
  ...
  %55 = fdiv reassoc ninf nsz float %54, %42
  store float %55, ptr %53, align 4
  br label %after_if

false_block:                                      ; preds = %for_loop_body
  %56 = getelementptr i8, ptr %44, i64 40
  %57 = load ptr, ptr %56, align 8
  %58 = getelementptr i8, ptr %44, i64 36
  ...
  %66 = getelementptr i8, ptr %44, i64 8
  %67 = load ptr, ptr %66, align 8
  %68 = getelementptr i8, ptr %44, i64 4
