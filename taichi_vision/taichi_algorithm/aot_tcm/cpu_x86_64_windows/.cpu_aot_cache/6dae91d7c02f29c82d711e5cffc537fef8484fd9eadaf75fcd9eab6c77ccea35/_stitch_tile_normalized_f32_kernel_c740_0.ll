...
%struct.RuntimeContext.113 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_stitch_tile_normalized_f32_kernel_c740_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_stitch_tile_normalized_f32_kernel_c740_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if, %for_loop_body.lr.ph
  %.06 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %98, %after_if ]
  ...
  %40 = icmp ne i32 %.06, %37
  %41 = and i1 %39, %40
  %.neg5 = sext i1 %41 to i32
  %42 = add i32 %36, %.neg5
  %43 = mul i32 %42, %35
  %44 = add i32 %42, %21
  ...
  %61 = fmul reassoc ninf nsz float %60, %52
  ...
  %71 = fadd reassoc ninf nsz float %70, %61
  %72 = fcmp reassoc ninf nsz ogt float %71, 0x3EB0C6F7A0000000
  br i1 %72, label %true_block, label %after_if
...
true_block:                                       ; preds = %for_loop_body
  ...
  %76 = getelementptr i8, ptr %73, i64 52
  ...
  %84 = fmul reassoc ninf nsz float %83, %70
  ...
  %93 = getelementptr float, ptr %86, i64 %92
  %94 = load float, ptr %93, align 4
  %95 = fmul reassoc ninf nsz float %94, %61
  %96 = fadd reassoc ninf nsz float %95, %84
  %97 = fdiv reassoc ninf nsz float %96, %71
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.113, align 8
