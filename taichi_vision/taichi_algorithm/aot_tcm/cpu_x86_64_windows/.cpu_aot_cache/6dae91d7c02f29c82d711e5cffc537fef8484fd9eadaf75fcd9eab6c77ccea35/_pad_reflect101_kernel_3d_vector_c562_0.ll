...
%struct.RuntimeContext.133 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_pad_reflect101_kernel_3d_vector_c562_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_pad_reflect101_kernel_3d_vector_c562_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %100, %for_loop_body ]
  ...
  %45 = tail call i32 @llvm.abs.i32(i32 %39, i1 true)
  %46 = add i32 %42, -1
  %47 = sub i32 %45, %46
  %48 = tail call i32 @llvm.smax.i32(i32 %47, i32 0)
  %49 = shl nuw i32 %48, 1
  %50 = sub i32 %45, %49
  %51 = tail call i32 @llvm.abs.i32(i32 %40, i1 true)
  %52 = add i32 %44, -1
  %53 = sub i32 %51, %52
  ...
  %59 = tail call i32 @llvm.smax.i32(i32 %56, i32 0)
  %60 = tail call i32 @llvm.smin.i32(i32 %52, i32 %59)
  ...
  %75 = getelementptr float, ptr %61, i64 %74
  ...
  %91 = getelementptr float, ptr %84, i64 %90
  store float %72, ptr %91, align 4
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.133, align 8
