...
%struct.RuntimeContext.103 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_normalize_accum_vec3_kernel_c730_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_normalize_accum_vec3_kernel_c730_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %88, %for_loop_body ]
  ...
  %42 = getelementptr float, ptr %37, i64 %41
  %43 = load float, ptr %42, align 4
  %44 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %43, float 0x3EB0C6F7A0000000)
  %45 = fdiv reassoc ninf nsz float 1.000000e+00, %44
  ...
  %62 = fmul reassoc ninf nsz float %53, %45
  %63 = fmul reassoc ninf nsz float %57, %45
  %64 = fmul reassoc ninf nsz float %61, %45
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #3 {
  %4 = alloca %struct.RuntimeContext.103, align 8
