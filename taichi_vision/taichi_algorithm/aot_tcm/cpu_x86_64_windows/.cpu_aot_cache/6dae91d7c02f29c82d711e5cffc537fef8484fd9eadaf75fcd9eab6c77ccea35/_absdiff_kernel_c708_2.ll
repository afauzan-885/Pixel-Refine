...
%struct.RuntimeContext.93 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_absdiff_kernel_c708_2_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_absdiff_kernel_c708_2_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %98, %for_loop_body ]
  ...
  %47 = getelementptr float, ptr %37, i64 %46
  %48 = load float, ptr %47, align 4
  %49 = add i32 %41, 2
  %50 = sext i32 %49 to i64
  %51 = getelementptr float, ptr %37, i64 %50
  ...
  %69 = fsub reassoc ninf nsz float %44, %60
  %70 = fsub reassoc ninf nsz float %48, %64
  %71 = fsub reassoc ninf nsz float %52, %68
  %72 = tail call noundef float @llvm.fabs.f32(float %69)
  %73 = tail call noundef float @llvm.fabs.f32(float %70)
  %74 = tail call noundef float @llvm.fabs.f32(float %71)
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #3 {
  %4 = alloca %struct.RuntimeContext.93, align 8
