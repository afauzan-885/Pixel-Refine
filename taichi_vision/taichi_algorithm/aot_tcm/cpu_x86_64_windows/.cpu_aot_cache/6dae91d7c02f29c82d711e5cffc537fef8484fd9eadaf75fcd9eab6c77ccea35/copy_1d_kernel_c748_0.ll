...
define void @copy_1d_kernel_c748_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @copy_1d_kernel_c748_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body.prol.preheader:                     ; preds = %for_loop_body.lr.ph
  %24 = sub i32 0, %xtraiter
  br label %for_loop_body.prol

for_loop_body.prol:                               ; preds = %for_loop_body.prol, %for_loop_body.prol.preheader
  %lsr.iv = phi i32 [ %24, %for_loop_body.prol.preheader ], [ %lsr.iv.next, %for_loop_body.prol ]
  %.04.prol = phi i32 [ %33, %for_loop_body.prol ], [ %16, %for_loop_body.prol.preheader ]
  %25 = load i32, ptr %6, align 4
  %26 = srem i32 %.04.prol, %25
  %27 = load ptr, ptr %21, align 8
  %28 = sext i32 %26 to i64
  %29 = getelementptr float, ptr %27, i64 %28
  %30 = load float, ptr %29, align 4
  %31 = load ptr, ptr %22, align 8
  %32 = getelementptr float, ptr %31, i64 %28
  store float %30, ptr %32, align 4
  %33 = add i32 %.04.prol, 1
...
for_loop_body.prol.loopexit:                      ; preds = %for_loop_body.prol.loopexit.loopexit, %for_loop_body.lr.ph
  %.04.unr = phi i32 [ %16, %for_loop_body.lr.ph ], [ %33, %for_loop_body.prol.loopexit.loopexit ]
  %34 = sub i32 %16, %18
  %35 = icmp ugt i32 %34, -4
  br i1 %35, label %after_for, label %for_loop_body.preheader

for_loop_body.preheader:                          ; preds = %for_loop_body.prol.loopexit
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.preheader
  %.04 = phi i32 [ %71, %for_loop_body ], [ %.04.unr, %for_loop_body.preheader ]
  ...
  %43 = getelementptr float, ptr %42, i64 %39
  ...
  %52 = getelementptr float, ptr %51, i64 %48
  ...
  %70 = getelementptr float, ptr %69, i64 %66
  store float %68, ptr %70, align 4
  %71 = add i32 %63, 1
  %exitcond.not.3 = icmp eq i32 %71, %18
