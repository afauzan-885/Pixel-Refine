...
%struct.RuntimeContext.73 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @split_kernel_c770_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @split_kernel_c770_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body.lr.ph:                              ; preds = %allocs
  ...
  %28 = getelementptr i8, ptr %20, i64 52
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %83, %for_loop_body ]
  ...
  %45 = getelementptr half, ptr %39, i64 %44
  %46 = load half, ptr %45, align 2
  %47 = load ptr, ptr %23, align 8
  %48 = load i32, ptr %24, align 4
  %49 = mul i32 %48, %38
  %50 = add i32 %49, %34
  %51 = sext i32 %50 to i64
  %52 = getelementptr half, ptr %47, i64 %51
  store half %46, ptr %52, align 2
  ...
  %60 = getelementptr half, ptr %53, i64 %59
  %61 = load half, ptr %60, align 2
  %62 = load ptr, ptr %25, align 8
  %63 = load i32, ptr %26, align 4
  %64 = mul i32 %63, %38
  %65 = add i32 %64, %34
  %66 = sext i32 %65 to i64
  %67 = getelementptr half, ptr %62, i64 %66
  store half %61, ptr %67, align 2
  ...
  %75 = getelementptr half, ptr %68, i64 %74
  %76 = load half, ptr %75, align 2
  %77 = load ptr, ptr %27, align 8
  %78 = load i32, ptr %28, align 4
  %79 = mul i32 %78, %38
  %80 = add i32 %79, %34
  %81 = sext i32 %80 to i64
  %82 = getelementptr half, ptr %77, i64 %81
  store half %76, ptr %82, align 2
  %83 = add nsw i32 %.04, 1
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.73, align 8
