...
%struct.RuntimeContext.121 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_pad_constant_kernel_2d_c540_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_pad_constant_kernel_2d_c540_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if9, %for_loop_body.preheader
  %.0815 = phi i32 [ %60, %after_if9 ], [ %16, %for_loop_body.preheader ]
...
after_if9:                                        ; preds = %false_block8, %true_block7
  %.sink.in = phi ptr [ %51, %false_block8 ], [ %50, %true_block7 ]
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.121, align 8
