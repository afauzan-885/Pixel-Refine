...
%struct.RuntimeContext.79 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_cvt_color_rgb_to_gray_i32_kernel_c712_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_cvt_color_rgb_to_gray_i32_kernel_c712_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.04 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %63, %for_loop_body ]
  ...
  %45 = getelementptr i32, ptr %35, i64 %44
  %46 = load i32, ptr %45, align 4
  %47 = add i32 %39, 2
  %48 = sext i32 %47 to i64
  %49 = getelementptr i32, ptr %35, i64 %48
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.79, align 8
