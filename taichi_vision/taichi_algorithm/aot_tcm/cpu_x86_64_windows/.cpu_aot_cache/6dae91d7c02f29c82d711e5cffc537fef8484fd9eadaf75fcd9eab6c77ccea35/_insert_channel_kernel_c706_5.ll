...
%struct.RuntimeContext.71 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_insert_channel_kernel_c706_5_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_insert_channel_kernel_c706_5_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  ...
  %42 = getelementptr half, ptr %37, i64 %41
  %43 = load half, ptr %42, align 2
  ...
  %51 = getelementptr half, ptr %44, i64 %50
  store half %43, ptr %51, align 2
  %52 = add nsw i32 %.04, 1
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.71, align 8
