...
%struct.RuntimeContext.141 = type { ptr, ptr, i32, ptr }

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none)
define void @_pad_constant_kernel_2d_c540_1_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_pad_constant_kernel_2d_c540_1_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %after_if9, %for_loop_body.preheader
  %.0815 = phi i32 [ %71, %after_if9 ], [ %16, %for_loop_body.preheader ]
...
true_block7:                                      ; preds = %true_block1
  ...
  %54 = getelementptr i8, ptr %37, i64 20
...
false_block8:                                     ; preds = %true_block1, %true_block, %for_loop_body
  %60 = getelementptr i8, ptr %37, i64 40
  %61 = load float, ptr %60, align 4
  %62 = getelementptr i8, ptr %37, i64 24
  %63 = load ptr, ptr %62, align 8
  %64 = getelementptr i8, ptr %37, i64 20
...
define internal void @cpu_parallel_range_for_task(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2) #2 {
  %4 = alloca %struct.RuntimeContext.141, align 8
