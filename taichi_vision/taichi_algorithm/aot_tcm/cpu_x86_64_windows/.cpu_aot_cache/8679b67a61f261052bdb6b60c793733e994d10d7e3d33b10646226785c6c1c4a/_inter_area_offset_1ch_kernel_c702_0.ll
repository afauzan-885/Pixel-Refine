...
define void @_inter_area_offset_1ch_kernel_c682_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
  ...
  %17 = getelementptr inbounds %struct.LLVMRuntime.23, ptr %16, i64 0, i32 14
  ...
  %25 = getelementptr inbounds %struct.LLVMRuntime.23, ptr %24, i64 0, i32 14
  ...
  %36 = getelementptr inbounds %struct.LLVMRuntime.23, ptr %35, i64 0, i32 14
  ...
  %48 = getelementptr inbounds %struct.LLVMRuntime.23, ptr %47, i64 0, i32 14
  ...
  %54 = getelementptr inbounds %struct.LLVMRuntime.23, ptr %53, i64 0, i32 14
...
define void @_inter_area_offset_1ch_kernel_c682_0_kernel_1_range_for(ptr %context) local_unnamed_addr #1 {
entry:
  %0 = alloca %0, align 8
...
vector.body:                                      ; preds = %vector.body, %vector.body.preheader
  ...
  %98 = add nsw <8 x i32> %vec.ind, splat (i32 1)
  ...
  %110 = getelementptr float, ptr %.pre, <8 x i64> %109
  %wide.masked.gather = call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %110, i32 4, <8 x i1> splat (i1 true), <8 x float> undef)
  ...
  %114 = add <8 x i32> %vec.ind, splat (i32 9)
  ...
  %126 = getelementptr float, ptr %.pre, <8 x i64> %125
  %wide.masked.gather.1 = call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %126, i32 4, <8 x i1> splat (i1 true), <8 x float> undef)
...
vector.body.epil:                                 ; preds = %middle.block.unr-lcssa
  %130 = add nsw <8 x i32> %vec.ind.unr, splat (i32 1)
  ...
  %142 = getelementptr float, ptr %.pre, <8 x i64> %141
  %wide.masked.gather.epil = call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %142, i32 4, <8 x i1> splat (i1 true), <8 x float> undef)
...
for_loop_body5.us:                                ; preds = %for_loop_body5.us, %for_loop_body5.us.preheader
  ...
  %160 = getelementptr float, ptr %.pre, i64 %159
...
after_for3:                                       ; preds = %after_for3.loopexit, %for_loop_body
  ...
  %172 = getelementptr float, ptr %167, i64 %171
