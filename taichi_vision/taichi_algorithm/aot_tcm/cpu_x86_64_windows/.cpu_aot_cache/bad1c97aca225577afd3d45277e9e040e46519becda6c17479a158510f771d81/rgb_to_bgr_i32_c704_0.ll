...
define void @rgb_to_bgr_i32_c704_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @rgb_to_bgr_i32_c704_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %104, %for_loop_body ]
  ...
  %49 = fmul reassoc ninf nsz float %48, 6.553500e+04
  %50 = fadd reassoc ninf nsz float %49, 5.000000e-01
  %51 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %50, float 0.000000e+00)
  %52 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %51, float 6.553500e+04)
  %53 = add i32 %45, 1
  %54 = sext i32 %53 to i64
  %55 = getelementptr float, ptr %39, i64 %54
  %56 = load float, ptr %55, align 4
  %57 = fmul reassoc ninf nsz float %56, 6.553500e+04
  ...
  %60 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %59, float 6.553500e+04)
  %61 = add i32 %45, 2
  %62 = sext i32 %61 to i64
  %63 = getelementptr float, ptr %39, i64 %62
  %64 = load float, ptr %63, align 4
  %65 = fmul reassoc ninf nsz float %64, 6.553500e+04
  %66 = fadd reassoc ninf nsz float %65, 5.000000e-01
  %67 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %66, float 0.000000e+00)
  %68 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %67, float 6.553500e+04)
  %69 = tail call reassoc ninf nsz float @llvm.round.f32(float %68)
  ...
  %79 = getelementptr i32, ptr %71, i64 %78
  store i32 %70, ptr %79, align 4
  %80 = tail call reassoc ninf nsz float @llvm.round.f32(float %60)
  ...
  %91 = getelementptr i32, ptr %82, i64 %90
  store i32 %81, ptr %91, align 4
  %92 = tail call reassoc ninf nsz float @llvm.round.f32(float %52)
  ...
  %exitcond.not = icmp eq i32 %18, %104
