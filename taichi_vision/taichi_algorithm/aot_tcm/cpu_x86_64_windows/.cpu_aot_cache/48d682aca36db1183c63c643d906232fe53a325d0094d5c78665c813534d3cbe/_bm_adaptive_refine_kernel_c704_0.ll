...
vector.body304:                                   ; preds = %vector.body304, %vector.ph301
  ...
  br i1 %144, label %middle.block298, label %vector.body304, !llvm.loop !11
...
after_if11:                                       ; preds = %after_if11, %after_if11.preheader
  ...
  br i1 %.not79, label %while_loop_body7.false_block10_crit_edge.loopexit, label %after_if11, !llvm.loop !14
...
vector.body268:                                   ; preds = %vector.body268, %vector.ph265
  ...
  br i1 %189, label %middle.block262, label %vector.body268, !llvm.loop !15
...
after_if23:                                       ; preds = %after_if23, %after_if23.preheader
  ...
  br i1 %.not78, label %while_loop_body19.false_block22_crit_edge.loopexit, label %after_if23, !llvm.loop !16
...
vector.body232:                                   ; preds = %vector.body232, %vector.ph229
  ...
  br i1 %234, label %middle.block226, label %vector.body232, !llvm.loop !17
...
after_if35:                                       ; preds = %after_if35, %after_if35.preheader
  ...
  br i1 %.not77, label %while_loop_body31.false_block34_crit_edge.loopexit, label %after_if35, !llvm.loop !18
...
vector.body196:                                   ; preds = %vector.body196, %vector.ph193
  ...
  br i1 %279, label %middle.block190, label %vector.body196, !llvm.loop !19
...
after_if47:                                       ; preds = %after_if47, %after_if47.preheader
  ...
  br i1 %.not76, label %while_loop_body43.false_block46_crit_edge.loopexit, label %after_if47, !llvm.loop !20
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %323, label %middle.block, label %vector.body, !llvm.loop !21
...
after_if59:                                       ; preds = %after_if59, %after_if59.preheader
  ...
  br i1 %.not75, label %while_loop_body55.false_block58_crit_edge.loopexit, label %after_if59, !llvm.loop !22
...
.lr.ph41:                                         ; preds = %.lr.ph41, %.lr.ph41.preheader
  ...
  br i1 %15, label %.lr.ph41, label %.loopexit.loopexit, !llvm.loop !23
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader
  ...
  br i1 %.not24.not, label %.lr.ph, label %.loopexit.loopexit46, !llvm.loop !25
