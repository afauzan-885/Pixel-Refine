...
define void @_ha_srgb_tonemap_kernel_c710_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_ha_srgb_tonemap_kernel_c710_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
allocs:
  ...
  %22 = getelementptr i8, ptr %19, i64 28
  %23 = load i32, ptr %22, align 4
  %24 = getelementptr i8, ptr %21, i64 4
  %25 = getelementptr i8, ptr %21, i64 8
  %26 = sext i32 %23 to i64
  %27 = getelementptr float, ptr %21, i64 %26
  %28 = add i32 %23, 1
  %29 = sext i32 %28 to i64
  %30 = getelementptr float, ptr %21, i64 %29
  %31 = add i32 %23, 2
  %32 = sext i32 %31 to i64
  %33 = getelementptr float, ptr %21, i64 %32
  %34 = shl i32 %23, 1
  %35 = sext i32 %34 to i64
  %36 = getelementptr float, ptr %21, i64 %35
...
for_loop_body.lr.ph:                              ; preds = %allocs
  %42 = getelementptr i8, ptr %19, i64 16
  %43 = getelementptr i8, ptr %19, i64 4
  %44 = getelementptr i8, ptr %19, i64 8
  %45 = getelementptr i8, ptr %19, i64 56
  %46 = getelementptr i8, ptr %19, i64 44
  %47 = getelementptr i8, ptr %19, i64 48
  br label %for_loop_body

for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %140, %for_loop_body ]
  ...
  %68 = getelementptr float, ptr %60, i64 %67
  ...
  %76 = getelementptr float, ptr %60, i64 %75
  %77 = load float, ptr %76, align 4
  %78 = load float, ptr %21, align 4
  %79 = fmul reassoc ninf nsz float %78, %69
  %80 = load float, ptr %24, align 4
  %81 = fmul reassoc ninf nsz float %80, %73
  %82 = fadd reassoc ninf nsz float %81, %79
  %83 = load float, ptr %25, align 4
  %84 = fmul reassoc ninf nsz float %83, %77
  %85 = fadd reassoc ninf nsz float %82, %84
  %86 = load float, ptr %27, align 4
  %87 = fmul reassoc ninf nsz float %86, %69
  %88 = load float, ptr %30, align 4
  %89 = fmul reassoc ninf nsz float %88, %73
  %90 = fadd reassoc ninf nsz float %89, %87
  %91 = load float, ptr %33, align 4
  %92 = fmul reassoc ninf nsz float %91, %77
  %93 = fadd reassoc ninf nsz float %90, %92
  %94 = load float, ptr %36, align 4
  %95 = fmul reassoc ninf nsz float %94, %69
  %96 = load float, ptr %37, align 4
  %97 = fmul reassoc ninf nsz float %96, %73
  %98 = fadd reassoc ninf nsz float %97, %95
  %99 = load float, ptr %40, align 4
  %100 = fmul reassoc ninf nsz float %99, %77
  %101 = fadd reassoc ninf nsz float %98, %100
  %102 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %85, float 0.000000e+00)
  %103 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %102, float 1.000000e+00)
  %104 = tail call noundef float @powf(float noundef %103, float noundef 0x3FDCD42E20000000) #8
  ...
  %113 = getelementptr float, ptr %105, i64 %112
  store float %104, ptr %113, align 4
  %114 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %93, float 0.000000e+00)
  %115 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %114, float 1.000000e+00)
  %116 = tail call noundef float @powf(float noundef %115, float noundef 0x3FDCD42E20000000) #8
  ...
  %126 = getelementptr float, ptr %117, i64 %125
  store float %116, ptr %126, align 4
  %127 = tail call reassoc ninf nsz float @llvm.maxnum.f32(float %101, float 0.000000e+00)
  %128 = tail call reassoc ninf nsz float @llvm.minnum.f32(float %127, float 1.000000e+00)
  %129 = tail call noundef float @powf(float noundef %128, float noundef 0x3FDCD42E20000000) #8
