...
define void @_to_grayscale_c482_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_to_grayscale_c482_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %68, %for_loop_body ]
  ...
  %49 = fmul reassoc ninf nsz float %48, 0x3FD322D0E0000000
  %50 = add i32 %44, 1
  %51 = sext i32 %50 to i64
  %52 = getelementptr float, ptr %38, i64 %51
  %53 = load float, ptr %52, align 4
  %54 = fmul reassoc ninf nsz float %53, 0x3FE2C8B440000000
  %55 = fadd reassoc ninf nsz float %54, %49
  %56 = sext i32 %44 to i64
  %57 = getelementptr float, ptr %38, i64 %56
  %58 = load float, ptr %57, align 4
  %59 = fmul reassoc ninf nsz float %58, 0x3FBD2F1AA0000000
  %60 = fadd reassoc ninf nsz float %55, %59
  ...
  %68 = add nsw i32 %.05, 1
  %exitcond.not = icmp eq i32 %18, %68
