...
define void @_box_filter_3x3_1ch_f32_unrolled_kernel_c174_0_kernel_0_serial(ptr nocapture readonly %context) local_unnamed_addr #0 {
entry:
...
define void @_box_filter_3x3_1ch_f32_unrolled_kernel_c174_0_kernel_1_range_for(ptr %context) local_unnamed_addr {
...
for_loop_body:                                    ; preds = %for_loop_body, %for_loop_body.lr.ph
  %.05 = phi i32 [ %16, %for_loop_body.lr.ph ], [ %119, %for_loop_body ]
  ...
  %68 = tail call i32 @llvm.smin.i32(i32 %49, i32 %67)
  %69 = add i32 %68, %54
  %70 = sext i32 %69 to i64
  %71 = getelementptr float, ptr %52, i64 %70
  %72 = load float, ptr %71, align 4
  %73 = fadd reassoc ninf nsz float %65, %72
  %74 = tail call i32 @llvm.smax.i32(i32 %36, i32 0)
  %75 = tail call i32 @llvm.smin.i32(i32 %43, i32 %74)
  %76 = mul i32 %75, %53
  %77 = add i32 %51, %76
  %78 = sext i32 %77 to i64
  %79 = getelementptr float, ptr %52, i64 %78
  ...
  %86 = fadd reassoc ninf nsz float %81, %85
  %87 = add i32 %68, %76
  %88 = sext i32 %87 to i64
  %89 = getelementptr float, ptr %52, i64 %88
  %90 = load float, ptr %89, align 4
  %91 = fadd reassoc ninf nsz float %86, %90
  %92 = add i32 %36, 1
  %93 = tail call i32 @llvm.smax.i32(i32 %92, i32 0)
  %94 = tail call i32 @llvm.smin.i32(i32 %43, i32 %93)
  %95 = mul i32 %94, %53
  %96 = add i32 %51, %95
  %97 = sext i32 %96 to i64
  %98 = getelementptr float, ptr %52, i64 %97
  %99 = load float, ptr %98, align 4
  %100 = fadd reassoc ninf nsz float %91, %99
  %101 = add i32 %95, %60
  %102 = sext i32 %101 to i64
  %103 = getelementptr float, ptr %52, i64 %102
  %104 = load float, ptr %103, align 4
  %105 = fadd reassoc ninf nsz float %100, %104
  %106 = add i32 %68, %95
  %107 = sext i32 %106 to i64
  %108 = getelementptr float, ptr %52, i64 %107
  %109 = load float, ptr %108, align 4
  %110 = fadd reassoc ninf nsz float %105, %109
  %111 = fmul reassoc ninf nsz float %110, 0x3FBC71C720000000
